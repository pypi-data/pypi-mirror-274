...
@overload
def truncate_message(response: GetFileContentsRequest) -> GetFileContentsRequest: ...
@overload
def truncate_message(response: GetFileContentsResponse) -> GetFileContentsResponse: ...
@overload
...
def truncate_message(
    ...
    if isinstance(response, CodeExecutionResponse | GetFileContentsResponse):
