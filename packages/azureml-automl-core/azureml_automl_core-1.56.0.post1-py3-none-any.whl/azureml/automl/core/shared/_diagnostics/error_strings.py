...
class AutoMLErrorStrings:
    ...
    TIMESERIES_DF_PROPHET_RESTRICTED_COL = "The input table contains columns {columns}, which are not allowed "\
                                           "when the Prophet model is enabled. Please rename these columns or "\
                                           "disable Prophet by removing it from allowed_training_algorithms or "\
                                           "by adding it to blocked_training_algorithms in set_training "\
                                           "method of ForecastingJob and run the experiment again."
