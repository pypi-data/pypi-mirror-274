...
spacy_english_tokenizer_url = "https://aka.ms/automl-resources/packages/en_core_web_sm-3.4.1.tar.gz"
AutoMLDNNPipPackagesList = ["pytorch-transformers==1.0.0", "spacy==3.4.4", spacy_english_tokenizer_url]
