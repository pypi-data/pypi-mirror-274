...
**duffie2013** could always use more documentation, whether as
part of the official **duffie2013** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `duffie2013` for local
development.

1. Fork the `duffie2013` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/duffie2013.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd duffie2013
    (dvlpt) duffie2013$ flake8
    (dvlpt) duffie2013$ pytest
    
    (dvlpt) duffie2013$ tox
