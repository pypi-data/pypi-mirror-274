...
@helpers.accept_array_like_xarray_torch
def adaptive_histogram_equalization_image_filter(*args: itkt.ImageLike,  alpha: float=..., beta: float=..., use_lookup_table: bool=..., kernel=..., radius: Union[Sequence[int], int, int, Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
