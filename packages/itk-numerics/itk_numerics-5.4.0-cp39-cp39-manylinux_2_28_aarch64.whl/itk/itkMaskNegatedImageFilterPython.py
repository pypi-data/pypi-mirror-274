...
def mask_negated_image_filter(*args: itkt.ImageLike,  outside_value: Tuple[int, int, int, int]=..., masking_value: int=..., mask_image: itkt.Image=..., constant1: Tuple[int, int, int, int]=..., constant2: int=..., constant: int=...,**kwargs)-> itkt.ImageSourceReturn:
