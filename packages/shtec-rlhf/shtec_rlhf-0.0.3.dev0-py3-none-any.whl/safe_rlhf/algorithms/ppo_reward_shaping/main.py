# Copyright 2024 SHTEC. All Rights Reserved.
#
...
from shtec_rlhf.algorithms.ppo_reward_shaping.trainer import PPORewardShapingTrainer
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        prog='deepspeed --module safe_rlhf.algorithms.ppo_lag',
        description='Train language model using Safe-RLHF with PPO algorithm and reward shaping.',
    ...
    training_parser.add_argument(
        ...
        type=float,
        default=1.0,
        help='The initial value for the lambda.',
    )
    training_parser.add_argument(
...
def main() -> None:
    ...
    trainer = PPORewardShapingTrainer(args, ds_train_config, ds_eval_config)
    trainer.train()
    trainer.save()
