...
def alipan_file_save(baidupan_access_token: str, alipan_api: Aligo, alipan_path: str,
                     ...
                     alipan_file_filter_func: Callable[[str, BaseShareFile | BaseFile], bool] = lambda x, y: True,
    ...
    if alipan_file.file_id in exist_file_list:
        return
    if alipan_file.type != 'folder' and isinstance(alipan_file, BaseShareFile):
    ...
    if not alipan_file_filter_func(alipan_path, alipan_file):
        return
