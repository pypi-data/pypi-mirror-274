...
{Fore.light_steel_blue}{'|'.join(replace_unit)}{Style.reset}
{Style.reset}
                                    '''
                                    ...
                                    for r in replace_case:
                                        text=text.replace(r,f"*{multipliers.get('#')}")
...
{Fore.grey_50}InList - {color_2}{Style.bold}15{Style.reset}'''
                        ...
                        p=Prompt.__init2__(None,func=mkT,ptext="amount|+amount|-amount|a,+a,-a(advanced) (Enter==1)",helpText=self.helpText_barcodes,data=code)
                        if p in [None,]:
                            return
                        if p:
                            value,text,suffix=p
