...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _USERCREATEBRANCHREQUEST.fields_by_name['repository']._options = None
  _USERCREATEBRANCHREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERUPDATEBRANCHREQUEST.fields_by_name['repository']._options = None
  _USERUPDATEBRANCHREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERDELETEBRANCHREQUEST.fields_by_name['repository']._options = None
  _USERDELETEBRANCHREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERDELETETAGREQUEST.fields_by_name['repository']._options = None
  _USERDELETETAGREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERCREATETAGREQUEST.fields_by_name['repository']._options = None
  _USERCREATETAGREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERMERGEBRANCHREQUEST.fields_by_name['repository']._options = None
  _USERMERGEBRANCHREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERMERGETOREFREQUEST.fields_by_name['repository']._options = None
  _USERMERGETOREFREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERMERGETOREFREQUEST.fields_by_name['branch']._options = None
  _USERMERGETOREFREQUEST.fields_by_name['branch']._serialized_options = b'\030\001'
  _USERMERGETOREFREQUEST.fields_by_name['allow_conflicts']._options = None
  _USERMERGETOREFREQUEST.fields_by_name['allow_conflicts']._serialized_options = b'\030\001'
  _USERREBASETOREFREQUEST.fields_by_name['repository']._options = None
  _USERREBASETOREFREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERFFBRANCHREQUEST.fields_by_name['repository']._options = None
  _USERFFBRANCHREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERCHERRYPICKREQUEST.fields_by_name['repository']._options = None
  _USERCHERRYPICKREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERREVERTREQUEST.fields_by_name['repository']._options = None
  _USERREVERTREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERCOMMITFILESREQUESTHEADER.fields_by_name['repository']._options = None
  _USERCOMMITFILESREQUESTHEADER.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERREBASECONFIRMABLEREQUEST_HEADER.fields_by_name['repository']._options = None
  _USERREBASECONFIRMABLEREQUEST_HEADER.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERREBASECONFIRMABLEREQUEST_HEADER.fields_by_name['rebase_id']._options = None
  _USERREBASECONFIRMABLEREQUEST_HEADER.fields_by_name['rebase_id']._serialized_options = b'\030\001'
  _USERSQUASHREQUEST.fields_by_name['repository']._options = None
  _USERSQUASHREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERAPPLYPATCHREQUEST_HEADER.fields_by_name['repository']._options = None
  _USERAPPLYPATCHREQUEST_HEADER.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _USERUPDATESUBMODULEREQUEST.fields_by_name['repository']._options = None
  _USERUPDATESUBMODULEREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _OPERATIONSERVICE.methods_by_name['UserCreateBranch']._options = None
  _OPERATIONSERVICE.methods_by_name['UserCreateBranch']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserUpdateBranch']._options = None
  _OPERATIONSERVICE.methods_by_name['UserUpdateBranch']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserDeleteBranch']._options = None
  _OPERATIONSERVICE.methods_by_name['UserDeleteBranch']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserCreateTag']._options = None
  _OPERATIONSERVICE.methods_by_name['UserCreateTag']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserDeleteTag']._options = None
  _OPERATIONSERVICE.methods_by_name['UserDeleteTag']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserMergeToRef']._options = None
  _OPERATIONSERVICE.methods_by_name['UserMergeToRef']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserRebaseToRef']._options = None
  _OPERATIONSERVICE.methods_by_name['UserRebaseToRef']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserMergeBranch']._options = None
  _OPERATIONSERVICE.methods_by_name['UserMergeBranch']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserFFBranch']._options = None
  _OPERATIONSERVICE.methods_by_name['UserFFBranch']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserCherryPick']._options = None
  _OPERATIONSERVICE.methods_by_name['UserCherryPick']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserCommitFiles']._options = None
  _OPERATIONSERVICE.methods_by_name['UserCommitFiles']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserRebaseConfirmable']._options = None
  _OPERATIONSERVICE.methods_by_name['UserRebaseConfirmable']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserRevert']._options = None
  _OPERATIONSERVICE.methods_by_name['UserRevert']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserSquash']._options = None
  _OPERATIONSERVICE.methods_by_name['UserSquash']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserApplyPatch']._options = None
  _OPERATIONSERVICE.methods_by_name['UserApplyPatch']._serialized_options = b'\372\227(\002\010\001'
  _OPERATIONSERVICE.methods_by_name['UserUpdateSubmodule']._options = None
  _OPERATIONSERVICE.methods_by_name['UserUpdateSubmodule']._serialized_options = b'\372\227(\002\010\001'
  ...
  _globals['_USERMERGEBRANCHREQUEST']._serialized_end=1991
  _globals['_USERMERGEBRANCHRESPONSE']._serialized_start=1994
  _globals['_USERMERGEBRANCHRESPONSE']._serialized_end=2123
  _globals['_USERMERGEBRANCHERROR']._serialized_start=2126
  _globals['_USERMERGEBRANCHERROR']._serialized_end=2367
  _globals['_USERMERGETOREFREQUEST']._serialized_start=2370
  _globals['_USERMERGETOREFREQUEST']._serialized_end=2672
  _globals['_USERMERGETOREFRESPONSE']._serialized_start=2674
  _globals['_USERMERGETOREFRESPONSE']._serialized_end=2742
  _globals['_USERREBASETOREFREQUEST']._serialized_start=2745
  _globals['_USERREBASETOREFREQUEST']._serialized_end=2982
  _globals['_USERREBASETOREFRESPONSE']._serialized_start=2984
  _globals['_USERREBASETOREFRESPONSE']._serialized_end=3028
