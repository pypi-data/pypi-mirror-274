...
(function () {
  ...
  */
  ...
  var validateGeography = function (value, name, allowNull) {
    ...
    switch (true) {
      case typeof value === 'string':
        if (!/^cfran-[A-Z0-9]{2,3}$/.test(value)) { api.inspector.warn(("value '" + value + "' set at analytics." + name + " with wrong format. Geographic location should be a String following ISO 3166-2:FR format")); }
        return value;
  ...
  var ComponentActionee = /*@__PURE__*/(function (Actionee) {
    function ComponentActionee (priority) {
      ...
      Actionee.call(this, priority, 'cfran_component');
    }
  ...
  var ConnectActionee = /*@__PURE__*/(function (ComponentActionee) {
    ...
    prototypeAccessors.label.get = function () {
      if (this.node.classList.contains('cfran-connect--plus')) { return 'FranceConnect+'; }
