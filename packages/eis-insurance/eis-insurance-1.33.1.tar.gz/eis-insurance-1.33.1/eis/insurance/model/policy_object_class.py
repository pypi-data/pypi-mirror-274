...
class PolicyObjectClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, insured_object_id, code, insured_object_name, data, summary, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """PolicyObjectClass - a model defined in OpenAPI

        Args:
            insured_object_id (float): Unique identifier referencing the insured object.
            code (str): Unique identifier for the object.
            insured_object_name (str): Insured object name.
            data ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Insured object data.
            summary (str): Insured object summary.
        ...
        self.code = code
        self.insured_object_name = insured_object_name
        self.data = data
    ...
    @convert_js_args_to_python_args
    def __init__(self, insured_object_id, code, insured_object_name, data, summary, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """PolicyObjectClass - a model defined in OpenAPI
