...
import tarfile
import json
from getLagacyFile import decompress_file_to_file
...
class ModelOrganizer:
    ...
    def copy_files(self, fileName):
        ...
        decompress_file_to_file(os.path.join("./lagacy/train",fileName), os.path.join(self.bin_directory, "train.py"))
        decompress_file_to_file(os.path.join("./lagacy","dockerfile"), "dockerfile")
