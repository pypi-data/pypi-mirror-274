...
class FilesApi(object):
    ...
    @validate_arguments
    def upload_file(self, type : StrictStr, x_gradient_workspace_id : constr(strict=True, min_length=1), file : Union[StrictBytes, StrictStr], **kwargs) -> UploadFileSuccess:  # noqa: E501
        """File upload  # noqa: E501

        Stores uploaded file.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.upload_file(type, x_gradient_workspace_id, file, async_req=True)
        >>> result = thread.get()
        ...
        return self.upload_file_with_http_info(type, x_gradient_workspace_id, file, **kwargs)  # noqa: E501

    @validate_arguments
    def upload_file_with_http_info(self, type : StrictStr, x_gradient_workspace_id : constr(strict=True, min_length=1), file : Union[StrictBytes, StrictStr], **kwargs) -> ApiResponse:  # noqa: E501
        """File upload  # noqa: E501
        ...
        >>> thread = api.upload_file_with_http_info(type, x_gradient_workspace_id, file, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(UploadFileSuccess, status_code(int), headers(HTTPHeaderDict))
        """
