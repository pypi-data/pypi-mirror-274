...
class RAGApi(object):
    ...
    @validate_arguments
    def delete_rag_collection(self, id : constr(strict=True, min_length=1), x_gradient_workspace_id : constr(strict=True, min_length=1), **kwargs) -> object:  # noqa: E501
        """Delete RAG collection  # noqa: E501

        Deletes the RAG collection.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_rag_collection(id, x_gradient_workspace_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the delete_rag_collection_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.delete_rag_collection_with_http_info(id, x_gradient_workspace_id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_rag_collection_with_http_info(self, id : constr(strict=True, min_length=1), x_gradient_workspace_id : constr(strict=True, min_length=1), **kwargs) -> ApiResponse:  # noqa: E501
        """Delete RAG collection  # noqa: E501
        ...
        >>> thread = api.delete_rag_collection_with_http_info(id, x_gradient_workspace_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_rag_collection" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "object",
            '4XX': "DeleteRagCollectionError",
        }

        return self.api_client.call_api(
            '/rag-collections/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
