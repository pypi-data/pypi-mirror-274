...
from lorax import Client as LoraxClient, AsyncClient as AsyncLoraxClient
...
class Deployments:
    ...
    def client(self, deployment_ref: str | Deployment, force_bare_client: bool = False) -> LoraxClient:
        ...
        c = LoraxClient(
            ...
            timeout=self._session.timeout_in_seconds,
        )
    ...
    def async_client(self, deployment_ref: str) -> AsyncLoraxClient:
        if isinstance(deployment_ref, Deployment):
            deployment_ref = deployment_ref.name
    ...
    def list(self):
        resp = self._client.http_get("/v2/deployments")
