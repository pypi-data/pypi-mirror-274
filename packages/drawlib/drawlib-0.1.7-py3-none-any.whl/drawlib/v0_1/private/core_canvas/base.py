...
from drawlib.v0_1.private.core.dimage import Dimage, DimageCache
...
class CanvasBase:
    ...
    def clear(
        self,
        initialize_theme: bool = False,
        initialize_dimage_cache: bool = False,
    ) -> None:
        ...
        if initialize_dimage_cache:
            Dimage.cache = DimageCache()
