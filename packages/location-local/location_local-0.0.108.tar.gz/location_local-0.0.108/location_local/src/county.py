...
class County(GenericCRUD):
    ...
    def insert(
            self, county: str, state_id: int, lang_code: LangCode = LocationLocalConstants.DEFAULT_LANG_CODE,
        ...
        county_id = GenericCRUD.insert(self, data_dict=county_dict)
    ...
    # TODO read or get? - What is our standard?
    ...
    def get_county_id_by_county_name_state_id(self, county_name: str, state_id: int = None,
