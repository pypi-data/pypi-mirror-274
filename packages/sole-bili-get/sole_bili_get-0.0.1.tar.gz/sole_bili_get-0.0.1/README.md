...
<a alt="null">![](https://img.shields.io/badge/python-3.6+-green)<img src="https://img.shields.io/github/v/release/muggledy/bili-get"/></a>

## 下载

```console
pip install bili-get -i https://www.pypi.org/simple/
```
