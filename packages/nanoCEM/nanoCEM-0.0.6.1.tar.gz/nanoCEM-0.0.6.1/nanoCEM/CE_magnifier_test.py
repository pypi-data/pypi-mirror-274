...
def init_parser():
    ...
    add_public_argument(parser_f5c)
    # parser.set_defaults(function='tombo', chrom="NR_103073.1", pos=2524, len=10, strand='+', cpu=8,norm=True,
    #                     input_fast5='/hdd_data/download/23s_rRNA_A2030/wt/single/', \
    #                     control_fast5='/hdd_data/download/23s_rRNA_A2030/ivt/single/', output='tombo_result_rna',
    #                     subsample_ratio=1, \
    #                     ref="../example/data/23S_rRNA.fasta", \
    #                     basecall_group="RawGenomeCorrected_000", basecall_subgroup="BaseCalled_template", rna=True)
    # parser.set_defaults(function='tombo', chrom="NR_103073.1", pos=2030, len=10, strand='+', cpu=8,norm=True,kmer_size=5,
    #                         input_fast5 = '../example/data/reverse/wt/single/', \
    #                         control_fast5='../example/data/reverse/ivt/single/', output='tombo_result_rna_2030',
    #                         subsample_ratio=1, \
    #                         ref="../example/data/23S_rRNA.fasta", \
    #                          basecall_group="RawGenomeCorrected_000", basecall_subgroup="BaseCalled_template", rna=True)
    # parser.set_defaults(function='tombo', chrom="17", pos=43281378, len=10, strand='+', cpu=8,norm=True,
    #                     input_fast5='../example/dna/hg38_chr17_43281378/WGS_r941/single/', \
    #                     control_fast5='../example/dna/hg38_chr17_43281378/scWGA_941/single/', output='tombo_result_dna',
    #                     subsample_ratio=1, \
    #                     ref="../example/dna/hg38_17.fa", \
    #                     basecall_group="RawGenomeCorrected_000", basecall_subgroup="BaseCalled_template", rna=False)

    # parser.set_defaults(function='move_table', chrom="NR_103073.1", pos=2251, len=5, strand='+', cpu=8,norm=True,
    #                     input='../example/data/wt/basecall',sig_move_offset=0,kmer_length=1,
    #                     control='../example/data/ivt/basecall', output='move_result_rna_2251',
    #                     subsample_ratio=1,
