...
from pypykatz.commons.common import WindowsBuild, WindowsMinBuild, KatzSystemArchitecture, GenericReader, \
...
class MsvDec(PackageDecryptor):
    ...
    def parse_credman_credentials(self, logon_session):
        ...
        credman_set_list_entry = logon_session.CredentialManager.read(self.reader,
    ...
    def add_credman_credential(self, credman_credential_entry):
        ...
        if credman_credential_entry.cbEncPassword and credman_credential_entry.cbEncPassword != 0:
            enc_data = credman_credential_entry.encPassword.read_raw(self.reader,
