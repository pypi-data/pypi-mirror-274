...
from pypykatz.commons.win_datatypes import LUID, POINTER, DWORD, PVOID, PSID, GUID, DWORD64
...
class KIWI_CLOUDAP_CACHE_LIST_ENTRY:
	def __init__(self, reader):
		...
		self.unkLogin0 = PVOID(reader) 
		self.unkLogin1 = PVOID(reader) 
		self.toname = reader.read(130)  
		reader.align()
