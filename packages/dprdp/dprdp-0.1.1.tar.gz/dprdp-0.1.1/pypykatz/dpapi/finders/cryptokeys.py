...
from winacl.dtyp.wcee.cryptoapikey import CryptoAPIKeyFile
...
class CryptoKeysFinder:
    ...
    @staticmethod
    def from_windir(win_dir, raise_error: bool = True):
    ...
    @staticmethod
    def from_dir(cryptokeys_dir, raise_error: bool = True):
