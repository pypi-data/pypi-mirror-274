...
class CloudapCredential:
    ...
    def to_dict(self):
        t = {'credtype': self.credtype, 'cachedir': self.cachedir, 'PRT': self.PRT, 'key_guid': self.key_guid,
             'dpapi_key': self.dpapi_key, 'dpapi_key_sha1': self.dpapi_key_sha1}
        return t
...
class CloudapDec(PackageDecryptor):
