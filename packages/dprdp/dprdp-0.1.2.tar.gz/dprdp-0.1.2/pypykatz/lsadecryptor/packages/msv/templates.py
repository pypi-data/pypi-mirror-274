...
from pypykatz.commons.win_datatypes import USHORT, ULONG, LSA_UNICODE_STRING, BYTE, PVOID, WORD, DWORD, POINTER, LUID, \
    PSID, ANSI_STRING
...
class MSV1_0_PRIMARY_CREDENTIAL_STRANGE_DEC:
    ...
    def __init__(self, reader):
        ...
        self.unk_tag = reader.read(4)
        self.unk_remaining_size = ULONG(reader).value
        reader.read(40)
...
class KIWI_MSV1_0_LIST_51:
    def __init__(self, reader):
        ...
        reader.align(8)
        self.LogonTime = int.from_bytes(reader.read(8), byteorder='little')
        reader.align()
...
class KIWI_MSV1_0_LIST_60:
    def __init__(self, reader):
        ...
        reader.align()
        self.LocallyUniqueIdentifier = int.from_bytes(reader.read(8), byteorder='little')
        self.SecondaryLocallyUniqueIdentifier = int.from_bytes(reader.read(8), byteorder='little')
        reader.align()
        self.UserName = LSA_UNICODE_STRING(reader)
        self.Domaine = LSA_UNICODE_STRING(reader)
