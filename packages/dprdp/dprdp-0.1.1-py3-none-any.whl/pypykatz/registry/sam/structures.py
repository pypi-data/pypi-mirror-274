...
class DOMAIN_ACCOUNT_F:
    ...
    def from_buffer(buff):
        df = DOMAIN_ACCOUNT_F()
        df.revision = int.from_bytes(buff.read(4), 'little')
        df.unk1 = int.from_bytes(buff.read(4), 'little')
        df.creation_time = int.from_bytes(buff.read(8), 'little')
        df.domain_modified_count = int.from_bytes(buff.read(8), 'little')
        df.max_pw_age = int.from_bytes(buff.read(8), 'little')
        df.min_pw_age = int.from_bytes(buff.read(8), 'little')
        df.force_logoff = int.from_bytes(buff.read(8), 'little')
        df.lockout_duration = int.from_bytes(buff.read(8), 'little')
        df.lockout_observation_window = int.from_bytes(buff.read(8), 'little')
        df.unk2 = int.from_bytes(buff.read(8), 'little')
        df.next_rid = int.from_bytes(buff.read(4), 'little')
        df.pw_properties = int.from_bytes(buff.read(4), 'little')
        df.min_pw_length = int.from_bytes(buff.read(2), 'little')
        df.pw_history_length = int.from_bytes(buff.read(2), 'little')
        df.lockout_treshold = int.from_bytes(buff.read(2), 'little')
        df.unk3 = int.from_bytes(buff.read(2), 'little')
        df.server_state = int.from_bytes(buff.read(4), 'little')
        df.server_role = int.from_bytes(buff.read(2), 'little')
        df.uas_compatibility_req = int.from_bytes(buff.read(2), 'little')
        df.unk4 = int.from_bytes(buff.read(8), 'little')
...
class SAM_KEY_DATA:
    ...
    def from_buffer(buff):
        sk = SAM_KEY_DATA()
        sk.revision = int.from_bytes(buff.read(4), 'little')
        sk.length = int.from_bytes(buff.read(4), 'little')
        sk.salt = buff.read(16)
        sk.key = buff.read(16)
        sk.checksum = buff.read(16)
        sk.reserved = int.from_bytes(buff.read(8), 'little')
        return sk
...
class SAM_KEY_DATA_AES:
    ...
    def from_buffer(buff):
        ...
        sk.revision = int.from_bytes(buff.read(4), 'little')
        sk.length = int.from_bytes(buff.read(4), 'little')
        sk.checksum_length = int.from_bytes(buff.read(4), 'little')
        sk.data_length = int.from_bytes(buff.read(4), 'little')
        sk.salt = buff.read(16)
...
class USER_ACCOUNT_V:
    ...
    def from_buffer(buff):
        ...
        uac.NameOffset = int.from_bytes(buff.read(4), 'little')
        uac.NameLength = int.from_bytes(buff.read(4), 'little')
        uac.Unknown2 = int.from_bytes(buff.read(4), 'little')
        uac.FullNameOffset = int.from_bytes(buff.read(4), 'little')
        uac.FullNameLength = int.from_bytes(buff.read(4), 'little')
        uac.Unknown3 = int.from_bytes(buff.read(4), 'little')
        uac.CommentOffset = int.from_bytes(buff.read(4), 'little')
        uac.CommentLength = int.from_bytes(buff.read(4), 'little')
        uac.Unknown31 = int.from_bytes(buff.read(4), 'little')
        uac.UserCommentOffset = int.from_bytes(buff.read(4), 'little')
        uac.UserCommentLength = int.from_bytes(buff.read(4), 'little')
        uac.Unknown4 = int.from_bytes(buff.read(4), 'little')
        uac.Unknown5 = buff.read(12)
        uac.HomeDirOffset = int.from_bytes(buff.read(4), 'little')
        uac.HomeDirLength = int.from_bytes(buff.read(4), 'little')
        uac.Unknown6 = int.from_bytes(buff.read(4), 'little')
        uac.HomeDirConnectOffset = int.from_bytes(buff.read(4), 'little')
        uac.HomeDirConnectLength = int.from_bytes(buff.read(4), 'little')
        uac.Unknown7 = int.from_bytes(buff.read(4), 'little')
        uac.ScriptPathOffset = int.from_bytes(buff.read(4), 'little')
        uac.ScriptPathLength = int.from_bytes(buff.read(4), 'little')
        uac.Unknown8 = int.from_bytes(buff.read(4), 'little')
        uac.ProfilePathOffset = int.from_bytes(buff.read(4), 'little')
        uac.ProfilePathLength = int.from_bytes(buff.read(4), 'little')
        uac.Unknown9 = int.from_bytes(buff.read(4), 'little')
        uac.WorkstationsOffset = int.from_bytes(buff.read(4), 'little')
        uac.WorkstationsLength = int.from_bytes(buff.read(4), 'little')
        uac.Unknown10 = int.from_bytes(buff.read(4), 'little')
        uac.HoursAllowedOffset = int.from_bytes(buff.read(4), 'little')
        uac.HoursAllowedLength = int.from_bytes(buff.read(4), 'little')
        uac.Unknown11 = int.from_bytes(buff.read(4), 'little')
        uac.Unknown12 = buff.read(12)
        uac.LMHashOffset = int.from_bytes(buff.read(4), 'little')
        uac.LMHashLength = int.from_bytes(buff.read(4), 'little')
        uac.Unknown13 = int.from_bytes(buff.read(4), 'little')
        uac.NTHashOffset = int.from_bytes(buff.read(4), 'little')
        uac.NTHashLength = int.from_bytes(buff.read(4), 'little')
        uac.Unknown14 = int.from_bytes(buff.read(4), 'little')
...
class SAM_HASH:
    ...
    def from_buffer(buff):
        sk = SAM_HASH()
        sk.pekID = int.from_bytes(buff.read(2), 'little')
        sk.revision = int.from_bytes(buff.read(2), 'little')
...
class SAM_HASH_AES:
    ...
    def from_buffer(buff):
        ...
        sk.pekID = int.from_bytes(buff.read(2), 'little')
        sk.revision = int.from_bytes(buff.read(2), 'little')
        sk.data_offset = int.from_bytes(buff.read(4), 'little')
        sk.salt = buff.read(16)
        sk.data = buff.read()
        return sk
