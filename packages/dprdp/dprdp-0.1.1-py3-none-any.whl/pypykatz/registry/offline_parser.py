...
class OffineRegistry:
    ...
    def from_bytes(system_data, sam_data=None, security_data=None, software_data=None):
        ...
        return OffineRegistry.from_buffer(system_buff, sam_buff=sam_buff, security_buff=security_buff,
                                          software_buff=software_buff)

    @staticmethod
    def from_buffer(system_buff, sam_buff=None, security_buff=None, software_buff=None):
        return OffineRegistry.from_files(system_buff, sam_path=sam_buff, security_path=security_buff,
                                         software_path=software_buff, notfile=True)
    ...
    def from_live_system():
        ...
        if 'SYSTEM' in dumped_names:
            try:
                po = OffineRegistry.from_files(system_name, sam_name if 'SAM' in dumped_names else None,
