...
class LsaTemplate_NT6(PackageTemplate):
    ...
    def get_template(sysinfo):
        ...
        if sysinfo.architecture == KatzSystemArchitecture.X86:
            ...
            # (22000,22621)
            elif sysinfo.buildnumber < WindowsBuild.WIN_11_22H2.value:
            ...
            raise Exception('Missing LSA decrpytor template for Architecture: %s , Build number %s' % (
...
class LSADecyptorKeyPattern:
    def __init__(self):
        ...
        self.IV_length = None
        self.offset_to_AES_key_ptr = None
        self.offset_to_DES_key_ptr = None
