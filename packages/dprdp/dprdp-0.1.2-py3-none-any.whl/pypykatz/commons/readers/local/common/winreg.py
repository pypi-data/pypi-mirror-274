...
def RegQueryInfoKey(key_handle):
    ...
    _RegQueryInfoKey.argtypes = [HKEY, LPSTR, LPDWORD, LPDWORD, LPDWORD, LPDWORD, LPDWORD, LPDWORD, LPDWORD, LPDWORD,
                                 LPDWORD, PVOID]
    ...
    res = _RegQueryInfoKey(key_handle, lpClass, lpcchClass, None, lpcSubKeys, lpcbMaxSubKeyLen, lpcbMaxClassLen,
