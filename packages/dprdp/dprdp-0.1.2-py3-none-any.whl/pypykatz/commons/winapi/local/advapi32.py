...
class ADVAPI32:
    ...
    def DuplicateTokenEx(hExistingToken, dwDesiredAccess=TOKEN_ALL_ACCESS, lpTokenAttributes=None,
        ...
        return DuplicateTokenEx(hExistingToken, dwDesiredAccess=dwDesiredAccess, lpTokenAttributes=lpTokenAttributes,
                                ImpersonationLevel=ImpersonationLevel, TokenType=TokenType)
    ...
    @staticmethod
    def EnumServicesStatusEx(hSCManager, InfoLevel=SC_ENUM_PROCESS_INFO, dwServiceType=SERVICE_DRIVER | SERVICE_WIN32,
                             dwServiceState=SERVICE_STATE_ALL, pszGroupName=None):
        return EnumServicesStatusExW(hSCManager, InfoLevel=InfoLevel, dwServiceType=dwServiceType,
                                     dwServiceState=dwServiceState, pszGroupName=pszGroupName)
