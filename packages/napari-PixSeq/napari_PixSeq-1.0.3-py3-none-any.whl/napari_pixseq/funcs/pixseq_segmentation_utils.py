    ...
    def initialise_cellpose(self, mode = "active"):
        ...
        try:
            ...
            if self.dataset_dict != {}:
                ...
                if mode == "active":
                    images = [self.dataset_dict[dataset][channel.lower()]["data"][current_frame]]
                else:
                    images = self.dataset_dict[dataset][channel.lower()]["data"].copy()
                ...
                if len(images) > 0:
                    ...
                    self.worker.signals.progress.connect(partial(self.pixseq_progress, progress_bar=self.gui.cellpose_progress))
