...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   VariableInspectionHandler: () => (/* reexport safe */ _handler__WEBPACK_IMPORTED_MODULE_5__.VariableInspectionHandler),
...
/* harmony import */ var _metadatapanel__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./metadatapanel */ "./lib/metadatapanel.js");
...
const metadatapanel = {
    ...
    provides: _tokens__WEBPACK_IMPORTED_MODULE_6__.IMetadataPanelManager,
    autoStart: true,
    activate: (app, palette, restorer, labShell) => {
        const manager = new _manager__WEBPACK_IMPORTED_MODULE_7__.MetadataPanelManager();
         ...
         */
        function newPanel() {
            const panel = new _metadatapanel__WEBPACK_IMPORTED_MODULE_8__.MetadataPanelPanel(app);
...
const consoles = {
    ...
    requires: [_tokens__WEBPACK_IMPORTED_MODULE_6__.IMetadataPanelManager, _jupyterlab_console__WEBPACK_IMPORTED_MODULE_2__.IConsoleTracker, _jupyterlab_application__WEBPACK_IMPORTED_MODULE_1__.ILabShell],
    autoStart: true,
            ...
            if (manager.hasHandler(consolePanel.sessionContext.path)) {
                ...
                handlers[consolePanel.id] = new Promise((resolve, reject) => {
                    ...
                    scripts.then((result) => {
                        ...
                        const handler = new _handler__WEBPACK_IMPORTED_MODULE_5__.VariableInspectionHandler(options);
                    ...
                    scripts.catch((result) => {
                        const handler = new _handler__WEBPACK_IMPORTED_MODULE_5__.DummyHandler(connector);
                        consolePanel.disposed.connect(() => {
                            delete handlers[consolePanel.id];
                            handler.dispose();
                        });
...
const pipelines = {
    ...
    requires: [_tokens__WEBPACK_IMPORTED_MODULE_6__.IMetadataPanelManager, _amphi_pipeline_editor__WEBPACK_IMPORTED_MODULE_4__.IPipelineTracker, _jupyterlab_application__WEBPACK_IMPORTED_MODULE_1__.ILabShell],
    autoStart: true,
...
//# sourceMappingURL=lib_index_js.8e6980268a05cb569b43.js.map