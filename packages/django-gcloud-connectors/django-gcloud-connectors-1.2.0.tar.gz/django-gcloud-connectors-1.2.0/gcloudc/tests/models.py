...
class ModelDatabaseB(models.Model):
    test_database = "non_default_connection"
...
class ManyFields(models.Model):
    ...
    field3 = models.TextField(blank=True, default="")
    field4 = models.TextField(blank=True, default="")
    field5 = models.TextField(blank=True, default="")
    field6 = models.TextField(blank=True, default="")
    field7 = models.TextField(blank=True, default="")
    field8 = models.TextField(blank=True, default="")
    field9 = models.TextField(blank=True, default="")
    field10 = models.TextField(blank=True, default="")
...
class IndexSelectedFieldsModel(models.Model):
    field1 = models.IntegerField(null=True)
...
class IndexPrimaryKeyModel(models.Model):
    field1 = models.CharField(max_length=32, primary_key=True)
    field2 = models.CharField(max_length=32)

    class Meta:
        indexes = [models.Index(fields=["field2"])]


class EmptyIndexesModel(models.Model):
    field1 = models.IntegerField(null=True)
    field2 = models.CharField(max_length=32)
...
class IndexAllFieldsModel(models.Model):
    field1 = models.IntegerField(null=True)
    field2 = models.CharField(max_length=32)
    field3 = models.TextField()
    ...
    class Meta:
        indexes = [
            ...
            models.Index(fields=["field4"]),
        ]


class KeysOnlyModel(models.Model):
    name = models.CharField(max_length=32)
