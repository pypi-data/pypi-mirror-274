...
from corvic.system import InMemoryExecutor, StorageManager
...
class Client:
    ...
    def __init__(
        ...
        *,
        ...
        self._executor = InMemoryExecutor(self._staging_db, self._storage_manager)
    ...
    @property
    def executor(self) -> InMemoryExecutor:
