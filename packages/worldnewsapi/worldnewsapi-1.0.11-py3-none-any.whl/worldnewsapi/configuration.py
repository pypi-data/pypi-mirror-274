...
conf = worldnewsapi.Configuration(
    ...
    def __init__(
        ...
        """Constructor
        """
        self._base_path = "https://api.worldnewsapi.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("worldnewsapi")
    ...
    def auth_settings(self):
        ...
        if 'headerApiKey' in self.api_key:
            auth['headerApiKey'] = {
                ...
                'in': 'header',
                'key': 'x-api-key',
                'value': self.get_api_key_with_prefix('headerApiKey', ),
            }
        return auth
