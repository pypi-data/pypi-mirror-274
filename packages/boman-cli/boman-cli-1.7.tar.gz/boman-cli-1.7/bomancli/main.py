        ...
        try:
            ...
            if tool_name == 'Codeql':
                ...
                if Config.jenkins == 'yes':
                    ...
                    logging.info('Preparing %s scan for jenkins env with %s user ', tool_name , userid)    
                    ...
                    logging.info('Preparing %s scan for non jenkins env with %s user ', tool_name ,userid)
