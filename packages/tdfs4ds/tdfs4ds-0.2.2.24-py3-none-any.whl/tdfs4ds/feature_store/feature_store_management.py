...
def feature_store_table_creation(entity_id, feature_type, if_exists='fail', primary_index = None, partitioning = ''):
    ...
    query_feature_value = {
        ...
        'VARCHAR_LATIN': 'FEATURE_VALUE VARCHAR(2048) CHARACTER SET LATIN',
        'VARCHAR_UNICODE': 'FEATURE_VALUE VARCHAR(2048) CHARACTER SET UNICODE',
        'TIMESTAMP0' : 'TIMESTAMP(0)',
        'TIMESTAMP0TZ' : 'TIMESTAMP(0) WITH TIME ZONE',
        'PERIODTS0' : 'PERIOD(TIMESTAMP(0))',
        'PERIODTS0TZ': 'PERIOD(TIMESTAMP(0) WITH TIME ZONE)',
    }
    ...
    if tdfs4ds.FEATURE_STORE_TIME == None:
        query_merge = f"""
         ...
         USING (
            ...
            LEFT JOIN {tdfs4ds.SCHEMA}.{tdfs4ds.FEATURE_CATALOG_NAME} B
        ...
        query_merge = f"""
         ...
         ON  UPDATED_FEATURES.FEATURE_NAME = EXISTING_FEATURES.FEATURE_NAME
         AND UPDATED_FEATURES.DATA_DOMAIN = EXISTING_FEATURES.DATA_DOMAIN
         WHEN MATCHED THEN
             UPDATE
             SET
