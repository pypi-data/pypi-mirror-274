...
def cross():
    ...
    if request.method == 'POST':
        ...
        if cross_on:
            ...
            print("D... (web) true xzoom_is_set=", xzoom_is_set)
            if request.form.get('down') == 'DOWN':
                print("xzoom v")
            ...
            print("D... (web) false xzoom_is_set=", xzoom_is_set)
            if request.form.get('down') == 'DOWN':
                print("NO v")
            if request.form.get('up') == 'UP':
                print("NO ^")
...
def ptz_windowsxp():
    ...
    if ptz_ok:
        ...
        print(f"i... {fg.orange} experimental remote cont.: dx=-1= laps 0s, 15s {fg.default}")
        timelaps = 0
        try:
