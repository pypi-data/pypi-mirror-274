...
from cli.v0 import cli_pb2 as cli_dot_v0_dot_cli__pb2
...
class CLIStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAgentInformation = channel.unary_unary(
                ...
                request_serializer=cli_dot_v0_dot_cli__pb2.GetAgentInformationRequest.SerializeToString,
        ...
        self.GetWorkspaceInventory = channel.unary_unary(
                '/observability.v0.CLI/GetWorkspaceInventory',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=base_dot_v0_dot_workspace__pb2.Workspace.FromString,
                _registered_method=True)
        self.GetWorkspaceServiceDependencyGraph = channel.unary_unary(
                '/observability.v0.CLI/GetWorkspaceServiceDependencyGraph',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=observability_dot_v0_dot_dependencies__pb2.GraphResponse.FromString,
                _registered_method=True)
        self.GetWorkspacePublicModulesDependencyGraph = channel.unary_unary(
                '/observability.v0.CLI/GetWorkspacePublicModulesDependencyGraph',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=cli_dot_v0_dot_cli__pb2.MultiGraphResponse.FromString,
                _registered_method=True)
        self.GetActive = channel.unary_unary(
                '/observability.v0.CLI/GetActive',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=cli_dot_v0_dot_cli__pb2.ActiveResponse.FromString,
                _registered_method=True)
        ...
        self.Logs = channel.unary_stream(
                ...
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=observability_dot_v0_dot_logs__pb2.Log.FromString,
                _registered_method=True)
        self.ActiveLogHistory = channel.unary_unary(
                '/observability.v0.CLI/ActiveLogHistory',
                request_serializer=observability_dot_v0_dot_logs__pb2.LogRequest.SerializeToString,
                response_deserializer=observability_dot_v0_dot_logs__pb2.LogResponse.FromString,
                _registered_method=True)
        self.GetFlowStatus = channel.unary_unary(
                '/observability.v0.CLI/GetFlowStatus',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=cli_dot_v0_dot_cli__pb2.FlowStatus.FromString,
                _registered_method=True)
...
def add_CLIServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetAgentInformation': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=cli_dot_v0_dot_cli__pb2.GetAgentInformationRequest.FromString,
            ...
            'GetWorkspaceInventory': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=base_dot_v0_dot_workspace__pb2.Workspace.SerializeToString,
            ),
            'GetWorkspaceServiceDependencyGraph': grpc.unary_unary_rpc_method_handler(
                    servicer.GetWorkspaceServiceDependencyGraph,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=observability_dot_v0_dot_dependencies__pb2.GraphResponse.SerializeToString,
            ),
            'GetWorkspacePublicModulesDependencyGraph': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=cli_dot_v0_dot_cli__pb2.MultiGraphResponse.SerializeToString,
            ),
            'GetActive': grpc.unary_unary_rpc_method_handler(
                    servicer.GetActive,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=cli_dot_v0_dot_cli__pb2.ActiveResponse.SerializeToString,
            ),
            ...
            'Logs': grpc.unary_stream_rpc_method_handler(
                    servicer.Logs,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=observability_dot_v0_dot_logs__pb2.Log.SerializeToString,
            ),
            'ActiveLogHistory': grpc.unary_unary_rpc_method_handler(
                    servicer.ActiveLogHistory,
                    request_deserializer=observability_dot_v0_dot_logs__pb2.LogRequest.FromString,
                    response_serializer=observability_dot_v0_dot_logs__pb2.LogResponse.SerializeToString,
            ),
            'GetFlowStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.GetFlowStatus,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=cli_dot_v0_dot_cli__pb2.FlowStatus.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'observability.v0.CLI', rpc_method_handlers)
...
class CLI(object):
    ...
    def GetAgentInformation(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/observability.v0.CLI/GetAgentInformation',
            cli_dot_v0_dot_cli__pb2.GetAgentInformationRequest.SerializeToString,
    ...
    def GetWorkspaceInventory(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/observability.v0.CLI/GetWorkspaceInventory',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            base_dot_v0_dot_workspace__pb2.Workspace.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetWorkspaceServiceDependencyGraph(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/observability.v0.CLI/GetWorkspaceServiceDependencyGraph',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            observability_dot_v0_dot_dependencies__pb2.GraphResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetWorkspacePublicModulesDependencyGraph(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/observability.v0.CLI/GetWorkspacePublicModulesDependencyGraph',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            cli_dot_v0_dot_cli__pb2.MultiGraphResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetActive(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/observability.v0.CLI/GetActive',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            cli_dot_v0_dot_cli__pb2.ActiveResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetAddresses(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/observability.v0.CLI/GetAddresses',
            cli_dot_v0_dot_cli__pb2.GetAddressRequest.SerializeToString,
            cli_dot_v0_dot_cli__pb2.GetAddressResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Logs(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            '/observability.v0.CLI/Logs',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            observability_dot_v0_dot_logs__pb2.Log.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ActiveLogHistory(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/observability.v0.CLI/ActiveLogHistory',
            observability_dot_v0_dot_logs__pb2.LogRequest.SerializeToString,
            observability_dot_v0_dot_logs__pb2.LogResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetFlowStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/observability.v0.CLI/GetFlowStatus',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            cli_dot_v0_dot_cli__pb2.FlowStatus.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
