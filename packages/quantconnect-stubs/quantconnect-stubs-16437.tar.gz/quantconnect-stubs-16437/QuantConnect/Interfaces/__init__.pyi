...
class IApi(System.IDisposable, metaclass=abc.ABCMeta):
    ...
    def create_live_algorithm(self, project_id: int, compile_id: str, server_type: str, base_live_algorithm_settings: System.Collections.Generic.Dictionary[str, System.Object], version_id: str = "-1", data_providers: System.Collections.Generic.Dictionary[str, System.Object] = None) -> QuantConnect.Api.CreateLiveAlgorithmResponse:
        """
        ...
        :param server_type: Type of server instance that will run the algorithm
        :param base_live_algorithm_settings: Dictionary with Brokerage specific settings
    ...
    def update_backtest(self, project_id: int, backtest_id: str, backtest_name: str = ..., backtest_note: str = ...) -> QuantConnect.Api.RestResponse:
        """
        Update the backtest name
        
        :param project_id: Project id to update
        :param backtest_id: Backtest id to update
        :param backtest_name: New backtest name to set
        :param backtest_note: Note attached to the backtest
...
class IAlgorithm(QuantConnect.Interfaces.ISecurityInitializerProvider, QuantConnect.Interfaces.IAccountCurrencyProvider, metaclass=abc.ABCMeta):
    ...
    def liquidate(self, symbol_to_liquidate: typing.Union[QuantConnect.Symbol, str] = None, tag: str = "Liquidated") -> System.Collections.Generic.List[int]:
        """
