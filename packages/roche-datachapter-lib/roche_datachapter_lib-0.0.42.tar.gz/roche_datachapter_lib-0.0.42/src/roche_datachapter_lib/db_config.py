...
class DbConfig():
    ...
    SQLALCHEMY_BINDS = {
        ...
        'redshift': f"postgresql+psycopg2://{RDI_LATAM_AR_USER}:{RDI_LATAM_AR_PASSWORD}@{RDI_LATAM_AR_HOST}:{RDI_LATAM_AR_PORT}/{RDI_LATAM_AR_DB}"  # pylint:disable=undefined-variable
    }
