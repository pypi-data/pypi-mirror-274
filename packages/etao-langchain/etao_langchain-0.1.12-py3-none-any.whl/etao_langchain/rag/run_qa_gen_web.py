...
import tempfile
import gradio as gr
from etao_langchain.rag.qa_corpus.qa_generator import RagQAGenerator
...
unstructured_api_url = "https://etao.dataelem.com/api/v1/etl4llm/predict"
...
with tempfile.TemporaryDirectory(dir=tmpdir) as tmpdir:
    with gr.Blocks(css='#margin-top {margin-top: 15px} #center {text-align: center;} #description {text-align: center}') as demo:
        with gr.Row(elem_id='center'):
            gr.Markdown('# etao qa auto generation Demo')
