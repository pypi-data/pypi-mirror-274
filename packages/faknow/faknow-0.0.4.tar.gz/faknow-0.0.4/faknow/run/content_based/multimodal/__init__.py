...
from faknow.run.content_based.multimodal.run_mcan import run_mcan, run_mcan_from_yaml, transform_mcan, \
...
from faknow.run.content_based.multimodal.run_spotfake import run_spotfake, run_spotfake_from_yaml, \
    text_preprocessing, transform_spotfake
from faknow.run.content_based.multimodal.run_hmcan import run_hmcan, run_hmcan_from_yaml, transform_hmcan
