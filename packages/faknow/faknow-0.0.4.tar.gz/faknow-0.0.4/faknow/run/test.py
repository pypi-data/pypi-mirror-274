...
from faknow.run.content_based import transform_eann
import torch.nn as nn
from torch.utils.data.dataset import TensorDataset
import torch
import torch.nn.functional as F
from faknow.run import *
...
def run_safe(
    ...
    model = SAFE(embedding_size, conv_in_size, filter_num, cnn_out_size, dropout, [0.4, 0.6])
...
if __name__ == '__main__':
    # run_eann_from_yaml(r'F:\code\python\FaKnow\faknow\properties\eann.yaml')
    run_safe(train_path=r'F:\code\python\FaKnow\dataset\example\SAFE')
