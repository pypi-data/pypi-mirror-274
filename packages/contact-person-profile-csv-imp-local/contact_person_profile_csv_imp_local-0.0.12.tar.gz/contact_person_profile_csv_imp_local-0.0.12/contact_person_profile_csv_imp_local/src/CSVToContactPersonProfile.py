...
class CSVToContactPersonProfile(GenericCRUD, metaclass=MetaLogger,
    ...
    def __init__(self, is_test_data: bool = False) -> None:
        ...
        self.organization_profile = OrganizationProfileLocal(is_test_data=is_test_data)
        ...
        self.contact_group = ContactGroups(is_test_data=is_test_data)
    ...
    def insert_update_contact_from_csv(
            self, *, data_source_type_id: int, file_name: str, user_external_username: str,
    ...
    def __insert_organization_profile(self, organization_id: int, profile_id: int) -> int or None:
        ...
        organization_profile_id = self.organization_profile.insert_mapping_if_not_exists(
            organization_id=organization_id, profile_id=profile_id)
    ...
    def __insert_link_contact_groups(self, contact_dict: dict, contact_id: int) -> list:
        ...
        if len(groups) > 0:
            groups_linked = self.contact_group.insert_link_contact_group_with_group_local(
