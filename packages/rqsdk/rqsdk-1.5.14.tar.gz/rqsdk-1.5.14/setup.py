...
version_map["rqalpha_plus"] = version_map["rqfactor"] | {
    "rqalpha==5.4.0",
    "rqalpha-mod-option==1.2.3",
    "rqalpha-mod-optimizer2==1.0.9",
    "rqalpha-mod-convertible==1.2.18",
    "rqalpha-mod-ricequant-data==2.4.7",
    "rqalpha-mod-rqfactor==1.0.11",
    "rqalpha-mod-spot==1.0.11",
    "rqalpha-mod-fund==0.0.16",
    "rqalpha-mod-incremental==0.0.9",
    "rqalpha-mod-ams >= 1.3.3",
    "rqalpha-plus==4.2.9",
    "rqrisk==1.0.9",
    "h5py>=3.0.0",
    "hdf5plugin",
