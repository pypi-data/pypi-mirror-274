...
# TODO: Change the PACKAGE_NAME to the name of the package - Either xxx-local or xxx-remote (without the -python-package suffix). Only lowercase, no underlines.
...
# PACKAGE_NAME should be singular
PACKAGE_NAME = "job-local"  # e.g.: queue-local, without python-package suffix
...
setuptools.setup(
    name=PACKAGE_NAME,
    version='0.0.1',  # increase this number every time you make a change you want to publish. After 0.0.9 switch to 0.0.10 and not 0.1.0
    author="Circles",
