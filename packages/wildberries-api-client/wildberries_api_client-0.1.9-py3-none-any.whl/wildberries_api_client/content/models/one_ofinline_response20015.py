...
class OneOfinlineResponse20015(object):
    ...
    def __init__(self):  # noqa: E501
        """OneOfinlineResponse20015 - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OneOfinlineResponse20015, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfinlineResponse20015):
            return False
