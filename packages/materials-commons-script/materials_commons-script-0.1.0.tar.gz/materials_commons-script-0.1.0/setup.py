...
from materials_commons.script import __version__


setup(
    name='materials_commons-script',
    version=__version__,
    description='Utilities for scripts running on Materials Commons',
    long_description="""This package contains the materials_commons.script module. This module is an interface
    ...
    packages=['materials_commons.script'],
    zip_safe=False,
    classifiers=[
