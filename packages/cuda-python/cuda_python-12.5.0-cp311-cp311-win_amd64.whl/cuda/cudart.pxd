...
cdef class cudaGraphDeviceNode_t:
    ...
    """
    cdef ccudart.cudaGraphDeviceNode_t  __val
    cdef ccudart.cudaGraphDeviceNode_t* _ptr
...
cdef class cudaAsyncCallbackHandle_t:
    ...
    """
    cdef ccudart.cudaAsyncCallbackHandle_t  __val
    cdef ccudart.cudaAsyncCallbackHandle_t* _ptr
...
cdef class cudaAsyncCallback:
    ...
    """
    cdef ccudart.cudaAsyncCallback  __val
    cdef ccudart.cudaAsyncCallback* _ptr
...
cdef class cudaResourceDesc:
    ...
    """
    cdef ccudart.cudaResourceDesc* _val_ptr
    cdef ccudart.cudaResourceDesc* _ptr
...
cdef class cudaMemFabricHandle_st:
    ...
    """
    cdef ccudart.cudaMemFabricHandle_st __val
    cdef ccudart.cudaMemFabricHandle_st* _ptr
...
cdef class cudaExternalMemoryHandleDesc:
    ...
    """
    cdef ccudart.cudaExternalMemoryHandleDesc* _val_ptr
    cdef ccudart.cudaExternalMemoryHandleDesc* _ptr
...
cdef class cudaExternalSemaphoreHandleDesc:
    ...
    """
    cdef ccudart.cudaExternalSemaphoreHandleDesc* _val_ptr
    cdef ccudart.cudaExternalSemaphoreHandleDesc* _ptr
...
cdef class cudaConditionalNodeParams:
    ...
    """
    cdef ccudart.cudaConditionalNodeParams __val
    cdef ccudart.cudaConditionalNodeParams* _ptr
    cdef cudaGraphConditionalHandle _handle
    cdef size_t _phGraph_out_length
    cdef ccudart.cudaGraph_t* _phGraph_out
...
cdef class cudaGraphEdgeData_st:
    ...
    """
    cdef ccudart.cudaGraphEdgeData_st __val
    cdef ccudart.cudaGraphEdgeData_st* _ptr
...
cdef class anon_struct19:
    ...
    """
    cdef ccudart.cudaGraphKernelNodeUpdate* _ptr
...
cdef class cudaGraphKernelNodeUpdate:
    ...
    """
    cdef ccudart.cudaGraphKernelNodeUpdate* _val_ptr
    cdef ccudart.cudaGraphKernelNodeUpdate* _ptr
...
cdef class anon_struct24:
    ...
    """
    cdef ccudart.cudaAsyncNotificationInfo* _ptr
...
cdef class cudaAsyncNotificationInfo:
    ...
    """
    cdef ccudart.cudaAsyncNotificationInfo* _val_ptr
    cdef ccudart.cudaAsyncNotificationInfo* _ptr
...
cdef class cudaEglFrame_st:
    ...
    """
    cdef ccudart.cudaEglFrame_st* _val_ptr
    cdef ccudart.cudaEglFrame_st* _ptr
...
cdef class cudaGraphConditionalHandle:
    ...
    """
    cdef ccudart.cudaGraphConditionalHandle  __val
    cdef ccudart.cudaGraphConditionalHandle* _ptr
