...
class TasksApi:
    ...
    @overload
    async def create_task(self, create_task_request : Annotated[CreateTaskRequest, Field(..., description="Request to create Task")], trigger : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(description="The name of the Trigger to invoke")] = None, **kwargs) -> Task:  # noqa: E501
        ...

    @overload
    def create_task(self, create_task_request : Annotated[CreateTaskRequest, Field(..., description="Request to create Task")], trigger : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(description="The name of the Trigger to invoke")] = None, async_req: Optional[bool]=True, **kwargs) -> Task:  # noqa: E501
        ...

    @validate_arguments
    def create_task(self, create_task_request : Annotated[CreateTaskRequest, Field(..., description="Request to create Task")], trigger : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(description="The name of the Trigger to invoke")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[Task, Awaitable[Task]]:  # noqa: E501
    ...
    @validate_arguments
    def create_task_with_http_info(self, create_task_request : Annotated[CreateTaskRequest, Field(..., description="Request to create Task")], trigger : Annotated[Optional[constr(strict=True, max_length=1024, min_length=1)], Field(description="The name of the Trigger to invoke")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] CreateTask: Create a new Task  # noqa: E501
    ...
    @overload
    async def delete_task(self, id : Annotated[constr(strict=True, max_length=40, min_length=30), Field(..., description="The identifier for the Task to be deleted.")], **kwargs) -> DeletedEntityResponse:  # noqa: E501
        ...

    @overload
    def delete_task(self, id : Annotated[constr(strict=True, max_length=40, min_length=30), Field(..., description="The identifier for the Task to be deleted.")], async_req: Optional[bool]=True, **kwargs) -> DeletedEntityResponse:  # noqa: E501
        ...

    @validate_arguments
    def delete_task(self, id : Annotated[constr(strict=True, max_length=40, min_length=30), Field(..., description="The identifier for the Task to be deleted.")], async_req: Optional[bool]=None, **kwargs) -> Union[DeletedEntityResponse, Awaitable[DeletedEntityResponse]]:  # noqa: E501
    ...
    @validate_arguments
    def delete_task_with_http_info(self, id : Annotated[constr(strict=True, max_length=40, min_length=30), Field(..., description="The identifier for the Task to be deleted.")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] DeleteTask: Delete a Task  # noqa: E501
    ...
    @validate_arguments
    def get_task_with_http_info(self, id : Annotated[constr(strict=True, max_length=40, min_length=30), Field(..., description="Id of the Task to retrieve")], as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to retrieve the Task. Defaults to returning the latest version of the Task if not specified.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] GetTask: Get a Task  # noqa: E501
    ...
    def list_tasks(self, as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to list the Tasks. Defaults to return the latest version of each Task if not specified.")] = None, filter : Annotated[Optional[constr(strict=True, max_length=16384, min_length=0)], Field(description="Expression to filter the result set. Read more about filtering results from LUSID here: https://support.lusid.com/filtering-results-from-lusid.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many.")] = None, page : Annotated[Optional[constr(strict=True, max_length=500, min_length=1)], Field(description="The pagination token to use to continue listing tasks from a previous call to list tasks. This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields must not have changed since the original request.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[PagedResourceListOfTask, Awaitable[PagedResourceListOfTask]]:  # noqa: E501
        ...
        >>> thread = api.list_tasks(as_at, filter, limit, page, async_req=True)
        >>> result = thread.get()
        ...
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.list_tasks_with_http_info(as_at, filter, limit, page, **kwargs)  # noqa: E501
    ...
    def list_tasks_with_http_info(self, as_at : Annotated[Optional[datetime], Field(description="The asAt datetime at which to list the Tasks. Defaults to return the latest version of each Task if not specified.")] = None, filter : Annotated[Optional[constr(strict=True, max_length=16384, min_length=0)], Field(description="Expression to filter the result set. Read more about filtering results from LUSID here: https://support.lusid.com/filtering-results-from-lusid.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many.")] = None, page : Annotated[Optional[constr(strict=True, max_length=500, min_length=1)], Field(description="The pagination token to use to continue listing tasks from a previous call to list tasks. This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields must not have changed since the original request.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.list_tasks_with_http_info(as_at, filter, limit, page, async_req=True)
        >>> result = thread.get()
    ...
    @overload
    async def update_task(self, id : Annotated[constr(strict=True, max_length=40, min_length=30), Field(..., description="Id of the Task to act upon")], trigger : Optional[constr(strict=True, max_length=1024, min_length=1)] = None, update_task_request : Annotated[Optional[UpdateTaskRequest], Field(description="The details of the request")] = None, **kwargs) -> Task:  # noqa: E501
        ...

    @overload
    def update_task(self, id : Annotated[constr(strict=True, max_length=40, min_length=30), Field(..., description="Id of the Task to act upon")], trigger : Optional[constr(strict=True, max_length=1024, min_length=1)] = None, update_task_request : Annotated[Optional[UpdateTaskRequest], Field(description="The details of the request")] = None, async_req: Optional[bool]=True, **kwargs) -> Task:  # noqa: E501
        ...
    ...
    @validate_arguments
    def update_task_with_http_info(self, id : Annotated[constr(strict=True, max_length=40, min_length=30), Field(..., description="Id of the Task to act upon")], trigger : Optional[constr(strict=True, max_length=1024, min_length=1)] = None, update_task_request : Annotated[Optional[UpdateTaskRequest], Field(description="The details of the request")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] UpdateTask: Update a Task  # noqa: E501
