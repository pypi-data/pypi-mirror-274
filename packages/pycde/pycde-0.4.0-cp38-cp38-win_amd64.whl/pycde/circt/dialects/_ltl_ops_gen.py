...
def disable(input, condition, *, loc=None, ip=None) -> _ods_ir.Value:
...
def repeat(input, base, *, more=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(RepeatOp(input=input, base=base, more=more, loc=loc, ip=ip))
...
def until(input, condition, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(UntilOp(input=input, condition=condition, loc=loc, ip=ip))
