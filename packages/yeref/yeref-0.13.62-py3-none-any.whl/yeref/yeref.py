...
<body>
    <div class="container">
        ...
        <div class="jetton">
            ...
            <div id="hint-field-image" class="hint">&lt; 5 Mb .jpg,&nbsp;
                ...
                <a href="https://ipfs.io/ipfs/Qmcd7PGHxEYSfmSBvL3jVkWVoS78yvZ7oPVDxfi3R6sypX" id="link-svg"
                    class="hint">.svg</a>&nbsp;256х256
            </div>
            ...
            <div class="block-transfer">
                <div class="block-outer">
                    <div class="block-inner">
                        ...
                        <input list="amount-dt-list" id="symbol-dt-id" placeholder="JTN: жетон" value="TON">
                        <datalist id="amount-dt-list">
                            <option value="TON">TON</option>
                        </datalist>
                    </div>
                ...
                <input type="text" id="input-comment" class="input-field-second" placeholder="TXT: комментарий"
                    maxlength="256">
                <div id="isContinueBlocks">
                    <input id="chkContinueBlocks" type="checkbox">
                    <label for="chkContinueBlocks" class="label">Зашифровать комментарий</label>
                </div>
                <div id="ft-transfer">Отправить</div>
                <div id="hint-transfer" class="hint">отправить несколько монет другому пользователю</div>
            </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", async () => {{
            ...
            document.getElementById("link-svg").addEventListener("click", async () => {{ tg.openLink(document.getElementById("link-svg").href, {{ try_instant_view: true }}) }})
