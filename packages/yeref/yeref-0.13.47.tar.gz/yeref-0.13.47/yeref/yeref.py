...
<body>
    ...
    <script>
        ...
        document.getElementById('subscribe-datalist-id').addEventListener('change', async () => {{
            ...
            document.getElementById("total-title").addEventListener("click", async () => {{ console.log('rrttttttttt'); tg.openLink(`https://tonviewer.com/${{activeMaster}}`, {{ try_instant_view: true }}) }})
            ...
            console.log("document.getElementById("balance-text").textContent", document.getElementById("balance-text").textContent)
