...
<head>
    ...
    <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/tgs-player.js"></script>
    <script src="https://unpkg.com/@tonconnect/ui@latest/dist/tonconnect-ui.min.js"></script>
    <script src="https://tonest.bsdhfgerbtyhryjrhs5ghdsfgk6.store/tonweb.js"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Web3</title>
...
<body>
    <div class="container">
        ...
        <div class="choose-address">
            <div class="subscribe-datalist">
                <input list="subscribe-datalist-list" id="subscribe-datalist-id" placeholder="EQ: адрес жетона">
                <datalist id="subscribe-datalist-list">
            ...
            <div class="block-transfer">
                <div class="block-outer">
                    <div class="block-inner">
                        <input type="number" id="input-amount" class="input-field" placeholder="1: количество JTN"
                            maxlength="256" value="1">
                        <input list="subscribe-dt-list" id="subscribe-dt-id" value="TON">
                        <datalist id="subscribe-dt-list">
                            <option value="TON">TON</option>
                        </datalist>
                    </div>
                    <input type="text" id="input-transfer" class="input-field" placeholder="EQ: адрес кошелька"
                        maxlength="256">
                </div>
                <input type="text" id="input-comment" class="input-field" placeholder="TXT: комментарий"
                    maxlength="256">
    ...
    <script>
        ...
        tonConnectUI.onStatusChange(async () => {{
            ...
            if (tonConnectUI.connected) {{
                ...
                document.getElementById('subscribe-datalist-list').innerHTML = ''
                const createOption = document.createElement('option')
                createOption.value = "+"
                createOption.text = "создать новый жетон"
                document.getElementById('subscribe-datalist-list').appendChild(createOption);
                ...
                for (const key in jettons) {{
                    ...
                    document.getElementById('subscribe-datalist-list').appendChild(option)
                }}
            }}
        }})
        document.addEventListener("DOMContentLoaded", async () => {{
            document.getElementById("subscribe-datalist-id").placeholder = "EQ: адрес жетона"
        ...
        // ----------------------------------------------------
        document.getElementById('subscribe-datalist-id').addEventListener('change', async () => {{
            dlAddress = document.getElementById('subscribe-datalist-id').value.trim()
            ...
            let options = document.getElementById("subscribe-datalist-list").getElementsByTagName("option")
            ...
            document.getElementById("subscribe-datalist-list").appendChild(newOption)
            console.log('end')
        ...
        document.getElementById('gen-rand').addEventListener('click', async () => {{
            if (isEdit) {{
                ...
                document.getElementById("subscribe-datalist-id").value = params['master']
        ...
        document.getElementById('ft-transfer').addEventListener('click', async (event) => {{
            ...
            // if (isSuccess === 0) {{ tg.showAlert("Необходимо создать жетон или выбрать существующий"); return }}
            let inputTransfer = document.getElementById('input-transfer').value.trim()
            if (inputTransfer === "") {{ tg.showAlert("Введи количество монет для сжигания1"); return }}
            ...
            body = {{
                ...
                'wallet': jettons[activeMaster]['wallet'],
                'coins': '1',
                'recipient': 'UQDSYiyzfwyB-ElGJPJnd_AtXdKjdxeqqCHzNFYII-qRcdbi',
                'decimals': jettons[activeMaster]['decimals'],
