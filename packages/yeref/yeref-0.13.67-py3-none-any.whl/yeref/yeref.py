...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", async () => {{
            ...
            document.getElementById("link-svg").addEventListener("click", async (event) => {{ event.preventDefault(); tg.openLink(document.getElementById("link-svg").href, {{ try_instant_view: true }}) }})
