...
<body>
    <div class="container">
        ...
        <div class="jetton">
            ...
            <div id="hint-field-image" class="hint">&lt; 5 Mb .jpg,&nbsp;
                ...
                <a href="https://cache.tonapi.io/imgproxy/cOMlJuViiVXDCkAghnyNj7plX8pAZ9pv3WhklvebpTY/rs:fill:200:200:1/g:no/aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3RvbmtlZXBlci9vcGVudG9uYXBpL21hc3Rlci9wa2cvcmVmZXJlbmNlcy9tZWRpYS90b2tlbl9wbGFjZWhvbGRlci5wbmc.webp" id="link-webp" class="hint">.webp,</a>&nbsp;
                <a href="https://ipfs.io/ipfs/Qmcd7PGHxEYSfmSBvL3jVkWVoS78yvZ7oPVDxfi3R6sypX" id="link-svg" class="hint">.svg</a>&nbsp;256х256</div>
                    
            <input type="text" id="input-field-name" class="input-field" placeholder="Jetton: название жетона" maxlength="128">
            <div id="hint-field-name" class="hint">1-3 слова с заглавной буквы</div>

            <input type="text" id="input-field-symbol" class="input-field" placeholder="JTN: обозначение жетона" maxlength="64">
            <div id="hint-field-symbol" class="hint">3-5 заглавных букв</div>

            <input type="number" id="input-field-decimals" class="input-field" placeholder="9: десятичная точность" maxlength="3">
            <div id="hint-field-decimals" class="hint">9 - точность по умолчанию для TON</div>

            <input type="number" id="input-field-total" class="input-field" placeholder="1000000: количество JTN" maxlength="64">
            <div id="hint-field-total" class="hint">начальное количество на кошельке</div>

            <input type="text" id="input-field-description" class="input-field" placeholder="DESC: описание жетона" maxlength="512">
            <div id="hint-field-description" class="hint">история в 1 предложении</div>

            <input type="text" id="input-field-social" class="input-field" placeholder="https: информационные ресурсы" maxlength="512">
        ...
        <div class="edit">
            ...
            <div class="block">
                <input type="number" id="input-mint" class="input-field" placeholder="100: количество JTN" maxlength="256">
                <div id="ft-mint">Отчеканить</div>
            </div>
            <div id="hint-mint" class="hint">создать еще больше монет</div>
            
            <div class="block">
                <input type="text" id="input-owner" class="input-field" placeholder="EQ: адрес нового админа" maxlength="256">
                <div id="ft-owner">Передать права</div>
            </div>
            <div id="hint-owner" class="hint">передать права на редактирование новому админу</div>
            
            <div class="block">
                <input type="number" id="input-burn" class="input-field" placeholder="1000: количество JTN" maxlength="256">
                <div id="ft-burn">Сжечь</div>
            </div>
            <div id="hint-burn" class="hint">удалить несколько монет из оборота</div>
            
            <div class="block">
                <input type="text" id="input-transfer" class="input-field" placeholder="EQ: адрес кошелька" maxlength="256">
    ...
    <script>
        ...
        document.getElementById('subscribe-datalist-id').addEventListener('change', async () => {{
            ...
            if (dlAddress === "") {{ return }}
            if (!(tonConnectUI.connected)) {{ tg.showAlert("{1}"); return }}
            console.log('next')
            ...
            document.getElementById("total-title").addEventListener("click", async (event) => {{ event.preventDefault(); console.log('rrttttttttt'); tg.openLink(`https://tonviewer.com/${{activeMaster}}`, {{ try_instant_view: true }}) }})
            ...
            if (jettons[dlAddress]['admin'] === jettons[dlAddress]['owner'] && jettons[dlAddress]['admin'] !== nullAddress) {{
                ...
                document.getElementById('ft-owner').style.backgroundColor = 'var(--tg-theme-button-color)'
            }}
            else {{
                document.getElementById('ft-send').style.display = 'flex'
                document.getElementById('ft-edit').style.display = 'none'
                ...
                document.getElementById('ft-owner').style.backgroundColor = 'var(--tg-theme-subtitle-text-color)'
            }}
        ...
        document.getElementById('ft-owner').addEventListener('click', async (event) => {{
            console.log(event.target.id)
            if (!(tonConnectUI.connected)) {{ tg.showAlert("{1}"); return }}
