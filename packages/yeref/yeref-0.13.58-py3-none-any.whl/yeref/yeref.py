            ...
            <div class="block-transfer">
                <div class="block-outer">
                    <div class="block-inner">
                        ...
                        <input list="subscribe-dt-list" id="subscribe-dt-id" placeholder="JTN: жетон" value="TON">
                        <datalist id="subscribe-dt-list">
                            <option value="TON">TON</option>
                        </datalist>
                    </div>
                    <input type="text" id="input-transfer" class="input-field-second" placeholder="EQ: адрес кошелька"
                        maxlength="256">
                </div>
