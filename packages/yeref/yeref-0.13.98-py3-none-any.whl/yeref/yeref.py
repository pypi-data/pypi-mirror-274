...
<body>
    ...
    <script>
        ...
        document.getElementById('ft-mint').addEventListener('click', async (event) => {{
            ...
            console.log(parseInt(jettons[activeMaster]['total'], 10) + parseInt(inputMint, 10))
            console.log(parseInt(jettons[activeMaster]['balance'], 10) + parseInt(inputMint, 10))
            
            jettons[activeMaster]['balance'] = parseInt(jettons[activeMaster]['balance'], 10) + parseInt(inputMint, 10)
            document.getElementById("balance-text").textContent = `${{jettons[activeMaster]['balance']}} ${{jettons[activeMaster]['symbol']}}`
            
            jettons[activeMaster]['total'] = parseInt(jettons[activeMaster]['total'], 10) + parseInt(inputMint, 10)
            document.getElementById("total-text").textContent = `${{jettons[activeMaster]['total']}} ${{jettons[activeMaster]['symbol']}}`
        }})
