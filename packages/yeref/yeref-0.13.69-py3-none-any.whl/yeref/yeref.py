...
<body>
    <div class="container">
        ...
        <div class="jetton">
            ...
            <div id="hint-field-image" class="hint">&lt; 5 Mb .jpg,&nbsp;
                <div id="link-png" class="hint">.png,</div>&nbsp;
                <div id="link-webp" class="hint">.webp,</div>&nbsp;
                <div id="link-svg" class="hint">.svg</div>&nbsp;256х256
            </div>
        ...
        <div class="edit">
            <div class="both">
                <div id="total-title" class="hint">Общий баланс:</div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", async () => {{
            ...
            document.getElementById("link-png").addEventListener("click", async () => {{ tg.openLink('https://tether.to/images/logoCircle.png', {{ try_instant_view: true }}) }})
            document.getElementById("link-webp").addEventListener("click", async () => {{ tg.openLink('https://cache.tonapi.io/imgproxy/cOMlJuViiVXDCkAghnyNj7plX8pAZ9pv3WhklvebpTY/rs:fill:200:200:1/g:no/aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3RvbmtlZXBlci9vcGVudG9uYXBpL21hc3Rlci9wa2cvcmVmZXJlbmNlcy9tZWRpYS90b2tlbl9wbGFjZWhvbGRlci5wbmc.webp', {{ try_instant_view: true }}) }})
        ...
        document.getElementById('address-datalist-id').addEventListener('change', async () => {{
            ...
            document.getElementById("total-title").addEventListener("click", async () => {{ tg.openLink(`https://tonviewer.com/${{activeMaster}}`, {{ try_instant_view: true }}) }})
