from setuptools import setup, find_packages;setup(name='latex_papersize',version='1.64',entry_points={'console_scripts':['latex-papersize=latex_papersize.__main__:placebo']},license='Apache 2',platforms='all',url='http://ssb22.user.srcf.net/notes/#latex',author='Silas S. Brown',author_email='ssb22@cam.ac.uk',description='Change LaTeX paper size and margins to simulate any magnification',long_description=r'''Calculate LaTeX paper and margin settings for arbitrary magnification
