...
import cv2
from pms_inference_engine import SleepAndPassProcessor, register
@register
class RzSleepAndPassProcessor(SleepAndPassProcessor):
    def __init__(self, concurrency: int, index: int, sleep_time: float = 0.1, scale:float) -> None:
