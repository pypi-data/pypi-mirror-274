...
class Valley(Node):
    """
    A class used to represent a valley terrain (Node)

    A valley terrain is a Node that inherits the following attributes a ``Position(x,y)`` that is a position on a
