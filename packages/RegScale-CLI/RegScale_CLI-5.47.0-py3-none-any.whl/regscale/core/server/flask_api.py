...
from regscale.core.app.public.fedramp.fedramp_common import process_fedramp_docx_by_profile_id
...
from regscale.integrations.commercial.stig import cci_control_mapping, STIG
...
async def process_stig_file():
    ...
    if ckl_file:
        ...
        return redirect(url_for("create_stig_upload_form"))
    STIG(
        folder_path="stig_artifacts",
        regscale_ssp_id=int(ssp_id),
        cci_mapping=cci_control_mapping(),
        regscale_dod_catalog_id=int(catalogue_id),
    )
