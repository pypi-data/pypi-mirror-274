from typing import Literal, Any, Dict, Tuple, List, Union, TypedDict
...
class _StartUnmergeHierarchicalMessage2(TypedDict, total=False):
    project_id: Required[int]
    """
    minimum: 0
