...
Please refer to the [Airlock Gateway REST API](https://docs.airlock.com/gateway/latest/rest-api/config-rest-api.html#ssl-certificate) documentation to understand how
...
class Certificate( element.ConfigElement ):
    """
