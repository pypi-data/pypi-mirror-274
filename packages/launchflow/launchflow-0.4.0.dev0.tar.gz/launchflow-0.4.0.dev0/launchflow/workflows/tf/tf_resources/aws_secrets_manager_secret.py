...
from launch_app.schemas.resource_schemas import CreateAwsSecretsManagerSecret


@dataclasses.dataclass
class AWSSecretsManagerSecretTF(AWSTF[CreateAwsSecretsManagerSecret]):
    @classmethod
    ...
    def tf_cwd(self) -> str:
        return "tf/resources/aws_secrets_manager"
