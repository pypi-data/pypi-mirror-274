...
class DockerResource(Resource[T]):
    ...
    async def create_async(
        ...
        *,
        ...
        """
        del environment_manager, resource_manager

        # This returns an op rather than executing immediately, so it won't actually create till
        # the other resources are switched back to using ops
        raise NotImplementedError
        # TODO: Make this async
        return docker_ctx.create_resource_operation_sync(resource=self, replace=replace)
