...
class NxOnyxApi:
    ...
    def createShellScript(self, name, oProjectId, type, script, documentation, packages, id=None):
    ...
    def createWorkflowStep(self, oWorkflowId, objectId, stepOrder, stopWorkflowOnError, isActive, jobType):
