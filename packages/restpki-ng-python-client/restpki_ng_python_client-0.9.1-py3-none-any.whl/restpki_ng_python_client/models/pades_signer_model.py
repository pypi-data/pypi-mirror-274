...
class PadesSignerModel(BaseModel):
    """
    PadesSignerModel
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["isDocumentTimestamp", "signatureFieldName", "hasLtv", "messageDigest", "signature", "signaturePolicy", "certificate", "signingTime", "certifiedDateReference", "timestamps", "validationResults", "commitmentType", "bStamp"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PadesSignerModel from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PadesSignerModel from a dict"""
        if obj is None:
            return None
