...
class SignatureResultModel(BaseModel):
    """
    SignatureResultModel
    """ # noqa: E501
    signature_file: Optional[FileModel] = Field(default=None, alias="signatureFile")
    callback_argument: Optional[StrictStr] = Field(default=None, alias="callbackArgument")
    certificate: Optional[CertificateModel] = None
    __properties: ClassVar[List[str]] = ["signatureFile", "callbackArgument", "certificate"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SignatureResultModel from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of signature_file
        if self.signature_file:
            _dict['signatureFile'] = self.signature_file.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SignatureResultModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "signatureFile": FileModel.from_dict(obj.get("signatureFile")) if obj.get("signatureFile") is not None else None,
