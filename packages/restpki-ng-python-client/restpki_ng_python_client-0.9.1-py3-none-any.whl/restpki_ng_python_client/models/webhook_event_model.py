...
class WebhookEventModel(BaseModel):
    ...
    WebhookEventModel
    """ # noqa: E501
    type: Optional[WebhookEventTypes] = None
    document: Optional[DocumentModel] = None
    __properties: ClassVar[List[str]] = ["type", "document"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebhookEventModel from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebhookEventModel from a dict"""
        if obj is None:
            return None
