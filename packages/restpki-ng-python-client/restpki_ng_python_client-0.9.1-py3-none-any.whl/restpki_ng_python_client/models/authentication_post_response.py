...
class AuthenticationPostResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["certificate", "validationResults"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AuthenticationPostResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AuthenticationPostResponse from a dict"""
        if obj is None:
            return None
