...
class CreateSignatureSessionResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["sessionId", "redirectUrl"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CreateSignatureSessionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CreateSignatureSessionResponse from a dict"""
        if obj is None:
            return None
