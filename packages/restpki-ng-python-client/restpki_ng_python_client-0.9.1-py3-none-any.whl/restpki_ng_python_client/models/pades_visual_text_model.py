...
class PadesVisualTextModel(BaseModel):
    """
    PadesVisualTextModel
    """ # noqa: E501
    font_size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="fontSize")
    text: Optional[StrictStr] = None
    include_signing_time: Optional[StrictBool] = Field(default=None, alias="includeSigningTime")
    horizontal_align: Optional[PadesTextHorizontalAlign] = Field(default=None, alias="horizontalAlign")
    container: Optional[PadesVisualRectangleModel] = None
    __properties: ClassVar[List[str]] = ["fontSize", "text", "includeSigningTime", "horizontalAlign", "container"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PadesVisualTextModel from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PadesVisualTextModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "text": obj.get("text"),
            "includeSigningTime": obj.get("includeSigningTime"),
