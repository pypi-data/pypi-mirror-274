...
class SignerSummary(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["certificate", "date"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SignerSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SignerSummary from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "certificate": CertificateSummary.from_dict(obj.get("certificate")) if obj.get("certificate") is not None else None,
            "date": obj.get("date")
        })
        return _obj
