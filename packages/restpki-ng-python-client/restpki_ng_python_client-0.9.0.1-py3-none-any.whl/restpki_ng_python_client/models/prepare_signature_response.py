...
class PrepareSignatureResponse(BaseModel):
    ...
    failure: Optional[PrepareSignatureFailures] = None
    state: Optional[StrictStr] = None
    to_sign_hash: Optional[DigestAlgorithmAndValueModel] = Field(default=None, alias="toSignHash")
    ...
    __properties: ClassVar[List[str]] = ["success", "failure", "state", "toSignHash", "validationResults", "certificate"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PrepareSignatureResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of to_sign_hash
        if self.to_sign_hash:
            _dict['toSignHash'] = self.to_sign_hash.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PrepareSignatureResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "toSignHash": DigestAlgorithmAndValueModel.from_dict(obj.get("toSignHash")) if obj.get("toSignHash") is not None else None,
