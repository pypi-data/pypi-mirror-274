...
class NameModel(BaseModel):
    ...
    organization_unit: Optional[StrictStr] = Field(default=None, alias="organizationUnit")
    dn_qualifier: Optional[StrictStr] = Field(default=None, alias="dnQualifier")
    ...
    generation_qualifier: Optional[StrictStr] = Field(default=None, alias="generationQualifier")
    email_address: Optional[StrictStr] = Field(default=None, alias="emailAddress")
    all_values: Optional[Dict[str, List[StrictStr]]] = Field(default=None, alias="allValues")
    dn_string: Optional[StrictStr] = Field(default=None, alias="dnString")
    __properties: ClassVar[List[str]] = ["country", "organization", "organizationUnit", "dnQualifier", "stateName", "commonName", "serialNumber", "locality", "title", "surname", "givenName", "initials", "pseudonym", "generationQualifier", "emailAddress", "allValues", "dnString"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NameModel from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if dn_qualifier (nullable) is None
        # and model_fields_set contains the field
        if self.dn_qualifier is None and "dn_qualifier" in self.model_fields_set:
            _dict['dnQualifier'] = None

        # set to None if state_name (nullable) is None
        # and model_fields_set contains the field
        if self.state_name is None and "state_name" in self.model_fields_set:
            _dict['stateName'] = None
        ...
        # set to None if pseudonym (nullable) is None
        # and model_fields_set contains the field
        if self.pseudonym is None and "pseudonym" in self.model_fields_set:
            _dict['pseudonym'] = None

        # set to None if generation_qualifier (nullable) is None
        # and model_fields_set contains the field
        if self.generation_qualifier is None and "generation_qualifier" in self.model_fields_set:
            _dict['generationQualifier'] = None
        ...
        # set to None if all_values (nullable) is None
        # and model_fields_set contains the field
        if self.all_values is None and "all_values" in self.model_fields_set:
            _dict['allValues'] = None

        # set to None if dn_string (nullable) is None
        # and model_fields_set contains the field
        if self.dn_string is None and "dn_string" in self.model_fields_set:
            _dict['dnString'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of NameModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "dnQualifier": obj.get("dnQualifier"),
            ...
            "generationQualifier": obj.get("generationQualifier"),
            "emailAddress": obj.get("emailAddress"),
            "allValues": obj.get("allValues"),
            "dnString": obj.get("dnString")
        })
        return _obj
