...
class CompleteAuthenticationResponse(BaseModel):
    ...
    failure: Optional[AuthenticationFailures] = None
    ...
    __properties: ClassVar[List[str]] = ["success", "failure", "certificate", "validationResults"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CompleteAuthenticationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CompleteAuthenticationResponse from a dict"""
        if obj is None:
            return None
