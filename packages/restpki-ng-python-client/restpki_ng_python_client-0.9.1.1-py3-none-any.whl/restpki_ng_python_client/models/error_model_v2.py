...
class ErrorModelV2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["validationResults", "detail", "code", "message", "details"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ErrorModelV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ErrorModelV2 from a dict"""
        if obj is None:
            return None
