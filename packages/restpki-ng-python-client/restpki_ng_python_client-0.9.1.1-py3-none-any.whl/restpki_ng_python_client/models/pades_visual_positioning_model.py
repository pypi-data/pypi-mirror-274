...
class PadesVisualPositioningModel(BaseModel):
    """
    ...
    auto: Optional[PadesVisualAutoPositioningModel] = None
    manual: Optional[PadesVisualRectangleModel] = None
    __properties: ClassVar[List[str]] = ["pageNumber", "measurementUnits", "pageOptimization", "auto", "manual"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PadesVisualPositioningModel from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PadesVisualPositioningModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "auto": PadesVisualAutoPositioningModel.from_dict(obj.get("auto")) if obj.get("auto") is not None else None,
            "manual": PadesVisualRectangleModel.from_dict(obj.get("manual")) if obj.get("manual") is not None else None
        })
        return _obj
