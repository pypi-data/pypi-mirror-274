...
class PdfSignatureOptions(BaseModel):
    """
    PdfSignatureOptions
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["visualRepresentation", "measurementUnits", "pageOptimization"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PdfSignatureOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PdfSignatureOptions from a dict"""
        if obj is None:
            return None
