...
class PadesSignaturePostRequestV2(BaseModel):
    """
    PadesSignaturePostRequestV2
    """ # noqa: E501
    pdf_to_sign: FileModel = Field(alias="pdfToSign")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PadesSignaturePostRequestV2 from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of pdf_to_sign
        if self.pdf_to_sign:
            _dict['pdfToSign'] = self.pdf_to_sign.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PadesSignaturePostRequestV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "pdfToSign": FileModel.from_dict(obj.get("pdfToSign")) if obj.get("pdfToSign") is not None else None,
