...
class XmlSignaturePostSignedBytesResponse(BaseModel):
    """
    XmlSignaturePostSignedBytesResponse
    """ # noqa: E501
    signed_xml: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, alias="signedXml")
    callback_argument: Optional[StrictStr] = Field(default=None, alias="callbackArgument")
    certificate: Optional[CertificateModel] = None
    __properties: ClassVar[List[str]] = ["signedXml", "callbackArgument", "certificate"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of XmlSignaturePostSignedBytesResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if signed_xml (nullable) is None
        # and model_fields_set contains the field
        if self.signed_xml is None and "signed_xml" in self.model_fields_set:
            _dict['signedXml'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of XmlSignaturePostSignedBytesResponse from a dict"""
        if obj is None:
            return None
