...
class PdfAddMarksRequest(BaseModel):
    """
    PdfAddMarksRequest
    """ # noqa: E501
    file: FileModel
    marks: List[PdfMarkModel]
    abort_if_signed: Optional[StrictBool] = Field(default=None, alias="abortIfSigned")
    ...
    preserve_signatures_visual_representation: Optional[StrictBool] = Field(default=None, alias="preserveSignaturesVisualRepresentation")
    __properties: ClassVar[List[str]] = ["file", "marks", "abortIfSigned", "measurementUnits", "pageOptimization", "forceBlobResult", "preserveSignaturesVisualRepresentation"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PdfAddMarksRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PdfAddMarksRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "marks": [PdfMarkModel.from_dict(_item) for _item in obj.get("marks")] if obj.get("marks") is not None else None,
            "abortIfSigned": obj.get("abortIfSigned"),
            ...
            "preserveSignaturesVisualRepresentation": obj.get("preserveSignaturesVisualRepresentation")
        })
        return _obj
