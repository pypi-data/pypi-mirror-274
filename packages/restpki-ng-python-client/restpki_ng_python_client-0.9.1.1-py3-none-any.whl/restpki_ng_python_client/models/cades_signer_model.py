...
class CadesSignerModel(BaseModel):
    """
    CadesSignerModel
    """ # noqa: E501
    ...
    commitment_type: Optional[CommitmentTypeModel] = Field(default=None, alias="commitmentType")
    b_stamp: Optional[SignerBStampModel] = Field(default=None, alias="bStamp")
    __properties: ClassVar[List[str]] = ["messageDigest", "signature", "signaturePolicy", "certificate", "signingTime", "certifiedDateReference", "timestamps", "validationResults", "commitmentType", "bStamp"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CadesSignerModel from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of commitment_type
        if self.commitment_type:
            _dict['commitmentType'] = self.commitment_type.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CadesSignerModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "commitmentType": CommitmentTypeModel.from_dict(obj.get("commitmentType")) if obj.get("commitmentType") is not None else None,
            "bStamp": SignerBStampModel.from_dict(obj.get("bStamp")) if obj.get("bStamp") is not None else None
        })
        return _obj

from restpki_ng_python_client.models.cades_timestamp_model import CadesTimestampModel
# TODO: Rewrite to not use raise_errors
CadesSignerModel.model_rebuild(raise_errors=False)
