...
class XmlSignatureModel(BaseModel):
    """
    XmlSignatureModel
    """ # noqa: E501
    type: Optional[XmlSignedEntityTypes] = None
    signed_element: Optional[XmlElementModel] = Field(default=None, alias="signedElement")
    ...
    __properties: ClassVar[List[str]] = ["type", "signedElement", "signature", "signaturePolicy", "certificate", "signingTime", "certifiedDateReference", "timestamps", "validationResults", "bStamp"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of XmlSignatureModel from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of signed_element
        if self.signed_element:
            _dict['signedElement'] = self.signed_element.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of XmlSignatureModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "signedElement": XmlElementModel.from_dict(obj.get("signedElement")) if obj.get("signedElement") is not None else None,
