...
class CadesSignaturePostSignedBytesResponse(BaseModel):
    """
    CadesSignaturePostSignedBytesResponse
    """ # noqa: E501
    cms: Optional[Union[StrictBytes, StrictStr]] = None
    callback_argument: Optional[StrictStr] = Field(default=None, alias="callbackArgument")
    certificate: Optional[CertificateModel] = None
    __properties: ClassVar[List[str]] = ["cms", "callbackArgument", "certificate"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CadesSignaturePostSignedBytesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CadesSignaturePostSignedBytesResponse from a dict"""
        if obj is None:
            return None
