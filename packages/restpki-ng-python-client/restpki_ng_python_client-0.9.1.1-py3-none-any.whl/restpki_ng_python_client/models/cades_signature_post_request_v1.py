...
class CadesSignaturePostRequestV1(BaseModel):
    """
    CadesSignaturePostRequestV1
    """ # noqa: E501
    content_to_sign: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, alias="contentToSign")
    cms_to_co_sign: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, alias="cmsToCoSign")
    encapsulate_content: Optional[StrictBool] = Field(default=None, alias="encapsulateContent")
    ...
    __properties: ClassVar[List[str]] = ["contentToSign", "cmsToCoSign", "encapsulateContent", "certificate", "signaturePolicyId", "securityContextId", "callbackArgument", "ignoreRevocationStatusUnknown"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CadesSignaturePostRequestV1 from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if content_to_sign (nullable) is None
        # and model_fields_set contains the field
        if self.content_to_sign is None and "content_to_sign" in self.model_fields_set:
            _dict['contentToSign'] = None

        # set to None if cms_to_co_sign (nullable) is None
        # and model_fields_set contains the field
        if self.cms_to_co_sign is None and "cms_to_co_sign" in self.model_fields_set:
            _dict['cmsToCoSign'] = None

        # set to None if encapsulate_content (nullable) is None
        # and model_fields_set contains the field
        if self.encapsulate_content is None and "encapsulate_content" in self.model_fields_set:
            _dict['encapsulateContent'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CadesSignaturePostRequestV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "contentToSign": obj.get("contentToSign"),
            "cmsToCoSign": obj.get("cmsToCoSign"),
            "encapsulateContent": obj.get("encapsulateContent"),
