...
class FullXmlSignaturePostRequest(BaseModel):
    """
    FullXmlSignaturePostRequest
    """ # noqa: E501
    xml: Optional[Union[StrictBytes, StrictStr]] = None
    signature_element_id: Optional[StrictStr] = Field(default=None, alias="signatureElementId")
    signature_element_location: Optional[XmlElementLocationModel] = Field(default=None, alias="signatureElementLocation")
    ...
    __properties: ClassVar[List[str]] = ["xml", "signatureElementId", "signatureElementLocation", "certificate", "signaturePolicyId", "securityContextId", "callbackArgument", "ignoreRevocationStatusUnknown"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FullXmlSignaturePostRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of signature_element_location
        if self.signature_element_location:
            _dict['signatureElementLocation'] = self.signature_element_location.to_dict()
        # set to None if xml (nullable) is None
        # and model_fields_set contains the field
        if self.xml is None and "xml" in self.model_fields_set:
            _dict['xml'] = None

        # set to None if signature_element_id (nullable) is None
        # and model_fields_set contains the field
        if self.signature_element_id is None and "signature_element_id" in self.model_fields_set:
            _dict['signatureElementId'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FullXmlSignaturePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "xml": obj.get("xml"),
            "signatureElementId": obj.get("signatureElementId"),
            "signatureElementLocation": XmlElementLocationModel.from_dict(obj.get("signatureElementLocation")) if obj.get("signatureElementLocation") is not None else None,
