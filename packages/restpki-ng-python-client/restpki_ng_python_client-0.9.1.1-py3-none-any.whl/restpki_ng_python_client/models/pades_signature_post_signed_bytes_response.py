...
class PadesSignaturePostSignedBytesResponse(BaseModel):
    """
    PadesSignaturePostSignedBytesResponse
    """ # noqa: E501
    signed_pdf: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, alias="signedPdf")
    callback_argument: Optional[StrictStr] = Field(default=None, alias="callbackArgument")
    certificate: Optional[CertificateModel] = None
    __properties: ClassVar[List[str]] = ["signedPdf", "callbackArgument", "certificate"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PadesSignaturePostSignedBytesResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if signed_pdf (nullable) is None
        # and model_fields_set contains the field
        if self.signed_pdf is None and "signed_pdf" in self.model_fields_set:
            _dict['signedPdf'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PadesSignaturePostSignedBytesResponse from a dict"""
        if obj is None:
            return None
