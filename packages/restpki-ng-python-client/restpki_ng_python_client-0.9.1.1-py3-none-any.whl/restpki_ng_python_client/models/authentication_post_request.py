...
class AuthenticationPostRequest(BaseModel):
    """
    AuthenticationPostRequest
    """ # noqa: E501
    certificate: Optional[Union[StrictBytes, StrictStr]] = None
    nonce: Optional[Union[StrictBytes, StrictStr]] = None
    ...
    __properties: ClassVar[List[str]] = ["certificate", "nonce", "signature", "securityContextId", "ignoreRevocationStatusUnknown"]
