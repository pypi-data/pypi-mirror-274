...
class AuthenticationsPostSignedBytesResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["validationResults", "certificate"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AuthenticationsPostSignedBytesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AuthenticationsPostSignedBytesResponse from a dict"""
        if obj is None:
            return None
