...
class PadesVisualRectangleModel(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["left", "top", "right", "bottom", "width", "height"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PadesVisualRectangleModel from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PadesVisualRectangleModel from a dict"""
        if obj is None:
            return None
