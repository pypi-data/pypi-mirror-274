...
class SessionCompletionStatus(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["completed", "progress"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SessionCompletionStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SessionCompletionStatus from a dict"""
        if obj is None:
            return None
