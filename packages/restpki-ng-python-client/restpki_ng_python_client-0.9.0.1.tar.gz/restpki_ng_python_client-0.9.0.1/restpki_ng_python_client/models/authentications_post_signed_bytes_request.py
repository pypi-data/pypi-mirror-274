...
class AuthenticationsPostSignedBytesRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["signature", "certificate"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AuthenticationsPostSignedBytesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AuthenticationsPostSignedBytesRequest from a dict"""
        if obj is None:
            return None
