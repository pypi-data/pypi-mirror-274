...
class CertificateSummary(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["thumbprint", "thumbprintSHA256", "subjectCommonName", "subjectDisplayName", "subjectIdentifier", "emailAddress", "organization", "organizationIdentifier"]
