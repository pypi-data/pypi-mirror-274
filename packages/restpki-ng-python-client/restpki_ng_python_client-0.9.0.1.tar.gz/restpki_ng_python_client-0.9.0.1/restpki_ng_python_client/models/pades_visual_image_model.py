...
class PadesVisualImageModel(BaseModel):
    """
    PadesVisualImageModel
    """ # noqa: E501
    resource: Optional[ResourceContentOrReference] = None
    opacity: Optional[StrictInt] = None
    horizontal_align: Optional[PadesHorizontalAlign] = Field(default=None, alias="horizontalAlign")
    vertical_align: Optional[PadesVerticalAlign] = Field(default=None, alias="verticalAlign")
    __properties: ClassVar[List[str]] = ["resource", "opacity", "horizontalAlign", "verticalAlign"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PadesVisualImageModel from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PadesVisualImageModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "resource": ResourceContentOrReference.from_dict(obj.get("resource")) if obj.get("resource") is not None else None,
