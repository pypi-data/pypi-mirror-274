...
class AuthenticationsPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["securityContextId", "ignoreRevocationStatusUnknown"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AuthenticationsPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AuthenticationsPostRequest from a dict"""
        if obj is None:
            return None
