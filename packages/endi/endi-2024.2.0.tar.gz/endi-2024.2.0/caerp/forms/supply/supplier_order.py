...
from caerp.forms.third_party.supplier import supplier_choice_node_factory
...
class SupplierOrderAddSchema(colander.MappingSchema):
    supplier_id = supplier_choice_node_factory(
        description=(
            "Vous pouvez gérer la liste des fournisseurs dans le menu "
            + "Tiers : Fournisseurs. Il vous faut au moins un fournisseur pour pouvoir créer une commande."
        )
    )
