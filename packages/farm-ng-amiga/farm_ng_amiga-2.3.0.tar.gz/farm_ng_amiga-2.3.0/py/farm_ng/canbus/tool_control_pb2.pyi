...
class ActuatorCommands(_message.Message):
    ...
    def __init__(self, hbridges: _Optional[_Iterable[_Union[HBridgeCommand, _Mapping]]] = ..., ptos: _Optional[_Iterable[_Union[PtoCommand, _Mapping]]] = ...) -> None: ...
...
class ToolStatuses(_message.Message):
    ...
    def __init__(self, hbridges: _Optional[_Iterable[_Union[HBridgeStatus, _Mapping]]] = ..., ptos: _Optional[_Iterable[_Union[PtoStatus, _Mapping]]] = ...) -> None: ...
