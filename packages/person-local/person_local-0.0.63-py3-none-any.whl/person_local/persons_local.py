...
class PersonsLocal(PeopleLocal, GenericCRUD):
    ...
    def get_person_id_by_person_number(self, person_number: int) -> int or None:
        ...
        person_id = None
        result = self.select_multi_dict_by_column_and_value(column_name='number',
    ...
    def insert_if_not_exists(self, person: Person,
        ...
        person_id = GenericCRUD.select_one_value_by_column_and_value(
            self,
            view_table_name='person_view',
            select_clause_value='person_id',
            column_value=person.main_email_address,
            column_name='main_email_person'
        )
        if person_id:
            ml_person_id = GenericCRUD.select_one_value_by_column_and_value(
                self,
        ...
        person_id = GenericCRUD.insert(self, data_dict=data_dict, ignore_duplicate=True)
        ...
        person_ml_id = GenericCRUD.insert(self, table_name="person_ml_table", data_dict=data_dict_ml,
    ...
    def get_test_person_id(self) -> int:
        fetched_result = self.select_one_dict_by_column_and_value(column_name='is_test_data',
                                                                  select_clause_value='person_id',
                                                                  column_value='1')
        if fetched_result:
