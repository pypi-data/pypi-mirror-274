...
class Dashboard:
    ...
    def from_dict(obj: Any) -> 'Dashboard':
        ...
        return Dashboard(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, dashboard_created_at, dashboard_info, deleted_at, display_name, entity_type, entity_upstream, force_shown, dashboard_id, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, overall_data_quality, parsed_upstream, source_info, structure, system_contacts, system_description, system_tags, system_tag_values, dashboard_versioned_id)
...
class UnityCatalogTableType(Enum):
    """Should remove this field after crawler is using 0.14+ model"""
    EXTERNAL = "EXTERNAL"
    MANAGED = "MANAGED"
    MATERIALIZED_VIEW = "MATERIALIZED_VIEW"
...
class UnityCatalog:
    ...
    def from_dict(obj: Any) -> 'UnityCatalog':
        ...
        return UnityCatalog(created_at, aspect_type, unity_catalog_created_at, dataset_type, data_source_format, entity_id, id, owner, properties, storage_location, table_info, table_type, volume_entity_id, volume_info)
...
class Hierarchy:
    ...
    def from_dict(obj: Any) -> 'Hierarchy':
        ...
        return Hierarchy(created_at, id, level, segments, versioned_id, asset_contacts, asset_followers, asset_governed_tags, browse_paths, hierarchy_created_at, deleted_at, display_name, display_name_without_fallback, entity_type, hierarchy_info, hierarchy_id, is_deleted, last_ingested_at, last_modified_at, logical_id, system_description, system_tags, hierarchy_versioned_id)
...
class Pipeline:
    ...
    def from_dict(obj: Any) -> 'Pipeline':
        ...
        return Pipeline(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, azure_data_factory_pipeline, pipeline_created_at, deleted_at, display_name, entity_type, entity_upstream, fivetran, force_shown, pipeline_id, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, parsed_upstream, power_bi_dataflow, spark, system_contacts, system_description, system_tags, system_tag_values, pipeline_versioned_id)
