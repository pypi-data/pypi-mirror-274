...
class Utils(base.Utils):
    ...
    def call_soon(
            ...
            loop: asyncio.AbstractEventLoop = ..., context: Context = ...
    ) -> asyncio.Handle:
        """延时调用(能隔离上下文)
        """
    ...
    @staticmethod
    def create_task(obj: typing.Union[typing.Generator, typing.Awaitable]) -> typing.Optional[asyncio.Task]:
    ...
    @staticmethod
    def run_until_complete(future: typing.Union[typing.Coroutine, typing.Generator]) -> typing.Any:
        """运行事件循环直到future结束
        """
