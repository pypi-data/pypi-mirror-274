...
_RoundRobinMT = typing.TypeVar('_RoundRobinMT')

class RoundRobin(typing.Generic[_RoundRobinMT]):

    def __init__(self, data: typing.List[_RoundRobinMT]):
        self._data: typing.List[_RoundRobinMT] = data
        self._iterator: typing.Iterator = itertools.cycle(data)

    def __len__(self) -> int:
        return len(self._data)

    @property
    def data(self) -> typing.List[_RoundRobinMT]:
        return self._data

    def get(self) -> _RoundRobinMT:
