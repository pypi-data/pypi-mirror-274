...
def display_html(html_content, notebook=False, width: int | str = '100%', height: int | str = 600):
    ...
    server_thread.start()
    if notebook:
        return IFrame(src=f"http://{conf.LOCALHOST}:{server.server_port}", width=width, height=height)
    else:
...
<html lang="en">
    <head>
        ...
        <script src="https://cdn.jsdelivr.net/npm/@arction/lcjs-themes@3.2.0/dist/iife/lcjs-themes.iife.js"></script>
