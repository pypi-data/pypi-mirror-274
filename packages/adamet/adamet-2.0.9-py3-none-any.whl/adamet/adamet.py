...
MODIFICATION HISTORY:
    ...
    V2.0.8: Use new np.random.default_rng. MC, Oxford, 6 August 2022
...
def adamet(lnprob_fun, pars, sigpars, bounds, nstep,
    ...
    lnprob_fun: callable
        ...
        to be normalized as only relative probabilities matter. For this reason,
        inclusion of an arbitrary additive constant in  lnprob_fun`` leaves the
        output of ``AdaMet`` unaffected::
    ...
    prng = np.random.default_rng(seed)  # Random stream independent of global one
