...
class RefundQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["page_number", "page_size", "sort_key", "sort_descending", "created_at", "expand", "charge_id", "payment_intent_id", "customer_id", "reason", "status", "amount_atom"]
