...
def detect_id_card(client, image_data, id_text, part=None):
    ...
    if id_text:
        ...
        # Crop the compressed image (assuming left, top, right, bottom are correct coordinates)
...
def extract_numeric_fields_from_raw(ar_front_data):
    ...
    arabic_keywords_to_remove = [
        "الرقم الشخصي", "تاريخ الميلاد", "الصلاحية", "الجنسية", "دولة قطر", "رخصة إقامة", "المهنة", "الإسم", "اداره", 'در'
    ] 
