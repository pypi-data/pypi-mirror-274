...
class RollingWindow:
    ...
    Attributes:
        ...
        timestamp_rounding_interval (Optional[timedelta]): Specifies the interval to which timestamps should be rounded. This helps ensure data alignment when timestamps may arrive out of sync.
        asset_dfs (Dict[str, pd.DataFrame]): A dictionary mapping assets to their corresponding DataFrames.
    """
    ...
    def append(self, message: Message) -> None:
        ...
        # Update the asset DataFrame in the dictionary
