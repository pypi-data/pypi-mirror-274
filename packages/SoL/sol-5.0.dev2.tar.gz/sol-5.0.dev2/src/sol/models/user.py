...
class User(Base):
    ...
    owned_clubs: Mapped[list[Club]] = relationship(
        'Club', back_populates='owner'
    )
    """List of owned :py:class:`clubs <.Club>`."""

    owned_players: Mapped[list[Player]] = relationship(
        'Player', back_populates='owner'
    )
    """List of owned :py:class:`players <.Player>`."""

    owned_ratings: Mapped[list[Rating]] = relationship(
        'Rating', back_populates='owner'
    )
