...
def test_participants(guest_user, tourney_rated, tourney_simple):
    ...
    app.get_route('test_create_random_finals',
                  _query={'idtourney': tourney_rated.idtourney})
...
def test_ranking(admin_user, guest_user, tourney_rated, tourney_apr24, tourney_asis,
                 tourney_double, tourney_simple, tourney_knockout_bot):
    app = guest_user
    ...
    app.get_route('pdf_tourneyranking', id=tourney_knockout_bot.idtourney, _query={'turn': 1})
    app.get_route('pdf_tourneyranking', id=tourney_knockout_bot.idtourney)
    admin_user.get_route('assign_prizes', _query={'idtourney': tourney_knockout_bot.idtourney})
    app.get_route('pdf_tourneyranking', id=tourney_knockout_bot.idtourney)
...
def test_under_ranking(guest_user, tourney_rated, tourney_apr24, tourney_asis):
    app = guest_user

    app.get_route('test_create_random_finals',
                  _query={'idtourney': tourney_rated.idtourney})
    app.get_route('pdf_tourneyunderranking', id=tourney_rated.idtourney,
                  _query={'age': 69})
    app.get_route('pdf_tourneyunderranking', id=tourney_rated.guid,
                  _query={'age': 69})
...
def test_women_ranking(guest_user, tourney_rated, tourney_apr24, tourney_asis):
    ...
    app.get_route('test_create_random_finals',
                  _query={'idtourney': tourney_rated.idtourney})
    app.get_route('pdf_tourneywomenranking', id=tourney_rated.idtourney,
                  _query={'age': 69})
    app.get_route('pdf_tourneywomenranking', id=tourney_rated.guid,
                  _query={'age': 69})
...
def test_nationalranking(guest_user, tourney_first, tourney_double, tourney_rated,
...
def test_results(guest_user, tourney_rated, tourney_simple):
    app = guest_user
...
def test_results_knockout(admin_user, guest_user, tourney_knockout):
    ...
    app.get_route('test_create_random_scores',
                  _query={'idtourney': tourney_knockout.idtourney})
    admin_user.get_route('update_ranking', _query={'idtourney': tourney_knockout.idtourney})
    admin_user.get_route('assign_prizes', _query={'idtourney': tourney_knockout.idtourney})

    app.get_route('pdf_results', id=tourney_knockout.idtourney,
                  _query={'turn': 'all'})
...
def test_scorecards(guest_user, tourney_rated):
    ...
    app.get_route('pdf_scorecards', id=tourney_rated.guid,
...
def test_badges(admin_user, guest_user, tourney_rated, tourney_apr24, tourney_asis,
                tourney_closed, tourney_simple):
    app = guest_user

    admin_user.get_route('update_ranking', _query={'idtourney': tourney_asis.idtourney})
    admin_user.get_route('assign_prizes', _query={'idtourney': tourney_asis.idtourney})
    admin_user.get_route('test_create_random_finals',
                         _query={'idtourney': tourney_rated.idtourney})
...
def test_badges_centesimal_prized(admin_user, guest_user, tourney_closed):
    ...
    app.get_route('test_create_random_scores',
                  _query={'idtourney': tourney_closed.idtourney})
    admin_user.get_route('update_ranking', _query={'idtourney': tourney_closed.idtourney})
    admin_user.get_route('assign_prizes', _query={'idtourney': tourney_closed.idtourney})
    app.get_route('pdf_badges', id=tourney_closed.idtourney)
...
def test_badges_emblem(admin_user, tourney_closed):
    ...
    modified = [('idclub', dict(idclub=tourney_closed.championship.club.idclub,
                                image=img,
                                emblem='foo.png'))]
    deleted = []
...
def test_championshipranking(session, admin_user, guest_user, tourney_closed, tourney_double,
                             tourney_rated, tourney_skipworstprize,
                             tourney_second, tourney_second_replica):
    app = guest_user

    admin_user.get_route('update_ranking',
                         _query={'idtourney': tourney_skipworstprize.idtourney})
    admin_user.get_route('assign_prizes',
                         _query={'idtourney': tourney_skipworstprize.idtourney})
    app.get_route('test_create_random_finals',
                  _query={'idtourney': tourney_rated.idtourney})
    ...
    app.get_route('pdf_championshipranking', id=tourney_rated.championship.idchampionship)
    app.get_route('pdf_championshipranking', id=tourney_rated.championship.guid)
    app.get_route('pdf_championshipranking',
                  id=tourney_skipworstprize.championship.guid)
