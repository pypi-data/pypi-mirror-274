...
class POLIBASE:
    ...
    BONUS_PROGRAM_TEXT: str = """*Предлагаем вам стать участником нашей бонусной программы Пасифик Хоспитал! Получайте кэшбэк бонусами на ваш личный счет.*
*Краткие условия бонусной программы:*
 • Кэшбэк 3% от стоимости прима специалистов зачисляется в виде бонусов на ваш личный бонусный счет
 • 1 бонус = 1 рубль
