...
class SessionAbstract:
    ...
    def hello(
        self, greeting: bool = True, fill_groups: bool = False
    ) -> None:
        raise NotImplemented()
    ...
    def authenticate(self, exit_on_fail: bool = True, once: bool = True) -> bool:
        try:
            ...
            if PIH.SERVICE.check_on_accessibility(ServiceRoles.AD):
                ...
                self.output.head1(
                    j((FullNameTool.to_given_name(PIH.RESULT.USER.by_login(login, cached=False).data.name), " пожалуйста, пройдите аутентификацию..."))
                )
                self.output.new_line()
    ...
    class CHECK:
        ...
        class ACCESS:
            ...
            def action_for_all_groups(
                ...
                for group in AD.Groups:
                    PIH.CHECK.ACCESS.action_for_group(group, session, exit_on_access_denied, notify_on_fail, notify_on_success, cached)
        ...
        class USER:
            ...
            def by_group(user: User, value: AD.Groups) -> bool:
                return ne(
                    ResultTool.filter(
                        lambda check_user: check_user.login
                        == user.login,
            ...
            def template(value: User) -> bool:
                ...
                return (
                    login[0] == CONST.NAME_SPLITTER
                    and login[-1] == CONST.NAME_SPLITTER
                )
            ...
            class WAPPI:
                class QUEUE:
                    ...
                    def add_message(
                        ...
                        message.message = PIH.DATA.FORMAT.whatsapp_message(
                            message.message
                        )
                        return DataTool.rpc_decode(
                            PIH.SERVICE.call_command(
    ...
    class ACTION:
        ...
        class MOBILE_INPUT_OUTPUT:
            ...
            def write(
                ...
                return PIH.MESSAGE.WHATSAPP.WAPPI.send(
                    telephone_number, PIH.DATA.FORMAT.whatsapp_message(message), profile
                )
...
def isolate(
    ...
    return PIH.SERVICE.ADMIN.isolate(service_role_or_description)