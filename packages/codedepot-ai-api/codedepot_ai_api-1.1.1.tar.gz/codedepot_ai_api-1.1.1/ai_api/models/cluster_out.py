...
class ClusterOut(BaseModel):
    ...
    status: Optional[StrictStr] = 'REACHABLE'
    __properties: ClassVar[List[str]] = ["name", "provider", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": obj.get("status") if obj.get("status") is not None else 'REACHABLE'
        })
        return _obj
