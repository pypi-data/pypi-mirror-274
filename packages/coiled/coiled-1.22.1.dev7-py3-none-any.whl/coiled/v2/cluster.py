    ...
    def __init__(
        ...
        *,
        ...
        if n_workers is None:
            ...
            logger.warning("Using adaptive scaling. To manually control the size of your cluster, use n_workers=.\n")
...
If that does not solve your issue, please contact support@coiled.io.""")
    ...
    @track_context
    async def scale_down(self, workers: Iterable[str], reason: Optional[str] = None) -> None:
        if not self.cluster_id:
            raise ValueError("No cluster available to scale!")
