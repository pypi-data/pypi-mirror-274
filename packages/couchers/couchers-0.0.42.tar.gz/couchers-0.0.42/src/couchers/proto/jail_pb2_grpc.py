...
class JailStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetPassword = channel.unary_unary(
                '/org.couchers.jail.Jail/SetPassword',
                request_serializer=jail__pb2.SetPasswordReq.SerializeToString,
                response_deserializer=jail__pb2.JailInfoRes.FromString,
                )
...
def add_JailServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SetPassword': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=jail__pb2.SetPasswordReq.FromString,
                    response_serializer=jail__pb2.JailInfoRes.SerializeToString,
            ),
    }
...
class Jail(object):
    ...
    def SetPassword(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/org.couchers.jail.Jail/SetPassword',
            jail__pb2.SetPasswordReq.SerializeToString,
            jail__pb2.JailInfoRes.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
