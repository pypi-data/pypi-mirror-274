...
class LitModel3D(Component):
    ...
    def __init__(
        ...
        *,
        env_map: str | None = None,
        tonemapping: Literal["standard", "aces"] | None = None,
        exposure: float = 1.0,
        contrast: float = 1.0,
        ...
        Parameters:
            ...
            env_map: path to environment map file to show in model3D viewer. If callable, the function will be called whenever the app loads to set the initial value of the environment map.
            tonemapping: tonemapping algorithm to use for rendering the scene. Should be one of "standard" or "aces". If not provided, defaults to "standard".
            exposure: exposure value to use for rendering the scene. Should be a float, increase this value to make the scene brighter, decrease to make it darker. Affects the exposure property of the camera.
            contrast: contrast value to use for rendering the scene. Should be a float, increase this value to make the scene more contrasted, decrease to make it less contrasted. Affects the contrast property of the camera.
