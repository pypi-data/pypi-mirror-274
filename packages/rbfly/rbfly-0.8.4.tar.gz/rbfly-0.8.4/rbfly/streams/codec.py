...
from .types import PublishErrorInfo
...
def sasl_authenticatation_data(username: str, password: str) -> bytes:
    """
    ...
    return encode_string('PLAIN') + data
...
__all__ = [
    'FrameDecoder', 'FrameEncoder', 'decode_publish_confirm',
    'decode_messages',
]
