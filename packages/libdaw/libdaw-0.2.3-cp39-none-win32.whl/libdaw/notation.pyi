...
class Pitch:
    def __new__(cls: type, pitch_class: PitchClass, octave: int | None = None, octave_shift: int = 0): ...
...
class Chord:
    def __new__(cls: type, pitches: abc.Sequence[_NotePitch], length: Beat | None = None, duration: Beat | None = None): ...
    @staticmethod
    ...
    @duration.setter
    def duration(self, value: Beat | None): ...
...
class Note:
    def __new__(cls: type, pitch: _NotePitch, length: Beat | None = None, duration: Beat | None = None): ...
...
class Overlapped:
    def __new__(cls: type, sections: abc.Sequence[_Item] | None = None): ...
    @staticmethod
