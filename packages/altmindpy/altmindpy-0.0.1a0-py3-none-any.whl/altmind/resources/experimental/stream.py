...
from ...types.experimental import stream_retrieve_params
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"content": content}, stream_retrieve_params.StreamRetrieveParams),
            ),
            cast_to=object,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"content": content}, stream_retrieve_params.StreamRetrieveParams),
            ),
            cast_to=object,
        )
