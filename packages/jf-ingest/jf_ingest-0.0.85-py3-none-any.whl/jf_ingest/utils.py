...
DEFAULT_HTTP_CODES_TO_RETRY_ON = [429, 502, 503, 504]
    ...
    **kwargs,
    ...
    for retry in range(max_retries + 1):
        try:
            ...
            if hasattr(e, "status_code") and e.status_code in statuses_to_retry:
                if retry < max_retries:
                    ...
                    logging_helper.log_standard_error(
                        ...
                        # better than nothing
                        msg_args=[e.status_code, f.__name__, retry + 1, max_retries, wait_time],
                        error_code=3071,
                    )
