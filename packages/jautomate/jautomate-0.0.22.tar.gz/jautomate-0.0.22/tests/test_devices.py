...
SAMPLE_COMP = {
    'serial_number': os.getenv('COMPUTER_SERIAL_NUMBER'),
    'asset_tag': os.getenv('COMPUTER_ASSET_TAG'), }
SAMPLE_MOBILE = {
    'serial_number': os.getenv('MOBILE_SERIAL_NUMBER'),
    'asset_tag': os.getenv('MOBILE_ASSET_TAG'),
}
