...
# ]
MOUNTPOINTS = [("~", "HOME")]
# Don't allow soft links in MountPoint directory trees...
ALLOW_LINKS = False
...
dpi = 96
FIGSIZE = (642.0 / dpi, 3 * 400.0 / dpi)
LANDSCAPE = (3 * 642.0 / dpi, 400.0 / dpi)
...
# add iso_peaks_nr_<n> columns if necessary....
FIXSQLITE = True
