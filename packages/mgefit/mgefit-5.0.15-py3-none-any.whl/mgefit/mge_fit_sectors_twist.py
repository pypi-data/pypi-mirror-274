...
######################################################################
 ...
 OPTIONAL OUTPUT KEYWORDS:
         SOL - Output keyword containing a (4, Ngauss) array with the
               best-fitting MGE solution. If the PSF parameters are given in
               input, this model is deconvolved for the PSF and pixels effects:
