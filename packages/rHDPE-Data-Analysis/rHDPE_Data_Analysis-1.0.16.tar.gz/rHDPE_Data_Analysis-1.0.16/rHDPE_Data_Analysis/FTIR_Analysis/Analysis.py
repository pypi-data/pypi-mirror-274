...
def FTIR_Analysis_Main( ip ):
    ...
    if len( data[1] ) != 557:
        ...
        print( "Warning: 557 files have not been read." )
    ...
    if ip.plot_data:
        ...
        FTIR_plotting.plot_data( ip.directory, ip.output_directory, file_data, data, first_derivative_data, second_derivative_data, third_derivative_data, m_peaks, m_peaks_array, y_peaks, y_peaks_array, ip.shiny, ip.shiny_samples_to_plot, ip.shiny_split )
