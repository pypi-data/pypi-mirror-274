...
def fixall(directory: str, force: bool, echo: bool):
...
def _fixsqlite(filename: str, force: bool, echo: bool):
...
def drop(filename: str, column: tuple[str, ...], echo: bool, regex: bool):
...
@click.argument("column", nargs=-1)
def dropall(directory: str, column: tuple[str, ...], echo: bool, regex: bool):
