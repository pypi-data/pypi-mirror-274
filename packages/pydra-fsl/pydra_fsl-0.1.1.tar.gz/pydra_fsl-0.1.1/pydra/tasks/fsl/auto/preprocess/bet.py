...
input_fields = [
    ...
    (
        ...
        Path,
        {
            ...
            "argstr": "{out_file}",
            "position": 1,
            "output_file_template": '"brain_anat.nii"',
        },
    ),
    ...
    (
        "frac",
        float,
        {"help_string": "fractional intensity threshold", "argstr": "-f {frac:.2}"},
    ),
    (
        "vertical_gradient",
        float,
...
output_fields = [
    ...
    ("outline_file", File, {"help_string": "path/name of outline file (if generated)"}),
    ("meshfile", File, {"help_string": "path/name of vtk mesh file (if generated)"}),
    (
        "inskull_mask_file",
        File,
    ...
    ("skull_file", File, {"help_string": "path/name of skull file (if generated)"}),
]
