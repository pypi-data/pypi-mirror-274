...
input_fields = [
    ...
    (
        ...
        Path,
        {
            ...
            "output_file_template": "warped_file",
        },
    ),
    (
        "field_file",
    ...
    (
        ...
        list,
        {
            "help_string": "Weight of regularisation, default depending on --ssqlambda and --regmod switches. See user documentation.",
...
output_fields = [
    ("fieldcoeff_file", File, {"help_string": "file with field coefficients"}),
    ("field_file", File, {"help_string": "file with warp field"}),
    ("jacobian_file", File, {"help_string": "file containing Jacobian of the field"}),
    (
        "modulatedref_file",
        File,
    ...
    (
        "out_intensitymap_file",
        ty.List[File],
        {"help_string": "files containing info pertaining to intensity mapping"},
    ),
]
...
class FNIRT(ShellCommandTask):
    ...
    >>> task.inputs.inmask_file = File.mock()
    >>> task.inputs.subsampling_scheme = [4, 2, 1, 1]    Specify the resolution of the warps    >>> fnirt_mprage.inputs.warp_resolution = (6, 6, 6)
