...
class FLIRT(ShellCommandTask):
    ...
    >>> task.inputs.schedule = File.mock()
    >>> task.inputs.ref_weight = File.mock()
    >>> task.inputs.in_weight = File.mock()
    >>> task.inputs.wm_seg = File.mock()
    >>> task.inputs.wmcoords = File.mock()
    >>> task.inputs.wmnorms = File.mock()
    >>> task.inputs.fieldmap = File.mock()
    >>> task.inputs.fieldmapmask = File.mock()
    >>> task.cmdline
