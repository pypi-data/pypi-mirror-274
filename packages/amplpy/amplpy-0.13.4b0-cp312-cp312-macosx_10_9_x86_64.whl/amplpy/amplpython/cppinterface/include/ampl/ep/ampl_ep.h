...
extern "C" {
AMPLAPI char *AMPL_Impl_snapshot(AMPL *ampl, const char *fileName, int model,
                                 int data, int options,
                                 ErrorInformation *errorInfo);
AMPLAPI char *AMPL_Impl_exportModel(AMPL *ampl, const char *fileName,
                                    ErrorInformation *errorInfo);
AMPLAPI char *AMPL_Impl_exportData(AMPL *ampl, const char *fileName,
                                   ErrorInformation *errorInfo);
...
AMPLAPI void AMPL_Impl_solve(AMPL *ampl, const char *problem,
                             const char *solver, ErrorInformation *errorInfo);
