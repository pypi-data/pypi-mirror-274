...
class ContactGroups(GenericMapping):
    ...
    def link_existing_groups(self, groups_to_link: list, contact_id: int, title: str, title_lang_code: str,
        ...
        for group in groups_to_link:
            response = self.group_remote.get_group_by_group_name(group_name=group)
    ...
    def add_update_group_and_link_to_contact(
            self, *, entity_name: str, contact_id: int, title: str = None,
        ...
        try:
            ...
            response = self.group_remote.get_group_by_group_name(
            ...
            if len(groups_to_link) == 0:
                groups_linked = self.create_and_link_new_group(
                    normalized_entity_name, contact_id, title_lang_code, is_interest)
            else:
                groups_linked = self.link_existing_groups(
                    groups_to_link, contact_id, title, title_lang_code,
