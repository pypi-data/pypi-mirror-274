...
class NetworkSimulator:
    def __init__(self, from_date, to_date, symbol, batch_size, timezone, volume_analyser_min, volume_analyser_percentile,
                 ...
                 onetick_dir,working_dir,show_metrics=True, otq_file_path=None, save_to_pickle=False, pickle_path=None):
        """
        ...
        self.query_runner = OneTickQueryRunner(self.username, self.password, self.onetick_dir, self.working_dir)
...
if __name__ == '__main__':
    simulator = NetworkSimulator(
        ...
        username='user',
        password='pass',
        onetick_dir="your path to onetick",
        working_dir="your path to your working directory",
        show_metrics=True
    )
