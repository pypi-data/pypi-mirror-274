...
async def test_get_faultlog_fake(fake_evofw3: Gateway) -> None:
    ...
    # tx_rate = fake_evofw3._transport.get_extra_info("tx_rate")
    # pass
...
async def test_get_faultlog_mqtt(mqtt_evofw3: Gateway) -> None:
    ...
    # _ = await mqtt_evofw3.tcs.get_faultlog(limit=64)
    # tx_rate = mqtt_evofw3._transport.get_extra_info("tx_rate")
    # pass
...
async def test_get_faultlog_real(real_evofw3: Gateway) -> None:
    ...
    # _ = await real_evofw3.tcs.get_faultlog(limit=64)
    # tx_rate = real_evofw3._transport.get_extra_info("tx_rate")
    # pass
