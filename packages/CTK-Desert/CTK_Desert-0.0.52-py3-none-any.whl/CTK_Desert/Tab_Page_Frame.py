...
class Frame(ctk.CTkFrame):
    ...
    def Subpage_init(self, Main_page_name: str, Sub_page_name: str): 
        ...
        if "." in Main_page_name:
            self.subpages_dict[Main_page_name] = self.pages_dict[MN_split]
        else:
            self.page_saver_dict[MN_split] = self.pages_dict[MN_split]
    ...
    def Subpage_return(self, Main_page_name: str, Sub_page_name: str): 
        ...
        if self.pages_dict[MN_split].Leaving("local"):
            ...
            self.subpages_dict[f"{Main_page_name}.{Sub_page_name}"] = self.pages_dict[MN_split]

            if "." in Main_page_name:
                self.pages_dict[MN_split] = self.subpages_dict[Main_page_name]
            else:
                self.pages_dict[MN_split] = self.page_saver_dict[MN_split]
                del self.page_saver_dict[MN_split]                              
