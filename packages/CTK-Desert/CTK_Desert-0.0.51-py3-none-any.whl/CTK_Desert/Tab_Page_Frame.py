...
class Frame(ctk.CTkFrame):
    ...
    def Subpage_Construction(self, Main_page: str, Sub_page): 
        ...
        """
        subpage_inited = Sub_page(self.window, self, self.page_frame)
    ...
    def Subpage_init(self, Main_page_name: str, Sub_page_name: str): 
        ...
        self.pages_dict[Main_page_name].pack_forget()
        self.pages_dict[Main_page_name].tools_f.place_forget()

        self.page_saver_dict[Main_page_name] = self.pages_dict[Main_page_name]
        self.pages_dict[Main_page_name] = self.subpages_dict[f"{Main_page_name}.{Sub_page_name}"]
        
        self.pages_dict[Main_page_name].pack(expand=True, fill="both")
        self.pages_dict[Main_page_name].called_when_opened(k=1)

        if self.pages_dict[Main_page_name].pickable == 1:
            self.pages_dict[Main_page_name].Picking()
    ...
    def Subpage_return(self, Main_page_name: str, Sub_page_name: str): 
        ...
        if self.pages_dict[Main_page_name].Leaving("local"):
            self.pages_dict[Main_page_name].pack_forget()
            self.pages_dict[Main_page_name].tools_f.place_forget()

            self.subpages_dict[f"{Main_page_name}.{Sub_page_name}"] = self.pages_dict[Main_page_name]
            self.pages_dict[Main_page_name] = self.page_saver_dict[Main_page_name]
            del self.page_saver_dict[Main_page_name]
