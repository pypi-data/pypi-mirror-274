...
def render_template(slug: str, data = {}):
    try:
        ...
        logging.exception(f"[Lunary] Error rendering template {e}")
...
def get_dataset(slug: str, app_id: str | None = None, api_url: str | None = None):
    ...
    try:
        ...
        response = requests.get(url, headers=headers, verify=config.disable_ssl_verify)
        if response.ok:
        ...
        logger.exception(f"[Lunary]: Error fetching dataset {e}")
...
def evaluate(checklist, input, output, ideal_output=None, context=None, model=None, duration=None, tags=None, app_id=None, api_url=None):
    ...
    try:
        ...
        response = requests.post(url, headers=headers, json=data, verify=config.disable_ssl_verify)
