...
class Config:
  def __init__(self, app_id: str | None = None, verbose: bool | None = False, api_url: str | None = None, disable_ssl_verify: bool | None = None):
      ...
      self.disable_ssl_verify = disable_ssl_verify if disable_ssl_verify is not None else (os.environ.get("DISABLE_SSL_VERIFY") == "True")
