...
**evers2010** could always use more documentation, whether as
part of the official **evers2010** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `evers2010` for local
development.

1. Fork the `evers2010` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/evers2010.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd evers2010
    (dvlpt) evers2010$ flake8
    (dvlpt) evers2010$ pytest
...
Before you submit a pull request, check that it meets these guidelines:
  ...
  3. The pull request should work for Python 3.9, 3.8, 3.7.
...
.. _issues: https://gitlab.com/b326/evers2010/issues
