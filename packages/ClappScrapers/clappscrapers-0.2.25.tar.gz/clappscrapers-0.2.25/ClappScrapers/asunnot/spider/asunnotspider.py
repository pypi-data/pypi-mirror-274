...
class AsunnotspiderSpider(scrapy.Spider):
    name = "asunnotspider"
    ...
    def get_urls(self,response):
        ...
        # Declare the namespace prefix and namespace URI
        ns = {'xmlns': 'http://www.sitemaps.org/schemas/sitemap/0.9'}
        
        # Use XPath with the declared namespace to extract URLs between <loc> tags
        urls = response.xpath('//xmlns:url[contains(xmlns:loc, "vuokra-asunnot")]/xmlns:loc/text()', namespaces=ns).getall()
