...
class CapsulesApi:
    ...
    def domain_query_access_log(
        ...
        :param redacted_or_tokenized_tag: the redacted or tokenized tag key you would like to filter on. This accepts a tag key only and will return all redacted and tokenized tag key results matching the provided tag key. If not specified, this field is ignored. 
