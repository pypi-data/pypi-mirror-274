...
from personal_interfaces.graphql.models_builder import (
    models, enums,
...
class MutationBuilder:  # pylint: disable=R0903
    ...
    def __init__(self, connector: DatabaseConnector) -> None:
        ...
        self.__build_mutation(_methods=_methods)
    ...
    def __build_update_func(self, model: str) -> Callable:
        ...
        def _mutation_function(element: Type, find_by: FindBy) -> None:  # pylint: disable=W0622
            """Function to perform the given mutation"""
    ...
    def __build_delete_func(self, model: str) -> Callable:
        ...
        def _mutation_function(find_by: FindBy) -> Response:
            """Function to perform the given mutation"""
