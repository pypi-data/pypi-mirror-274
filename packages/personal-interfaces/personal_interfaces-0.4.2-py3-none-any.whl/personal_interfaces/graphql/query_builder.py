...
import strawberry
# Local imports
from personal_interfaces.graphql._utils import (
    FindBy, Filter,
    capitalize, is_optional, is_list
)
from personal_interfaces.graphql.connectors.template import DatabaseConnector
from personal_interfaces.graphql.models_builder import models, enums, find_by_models



class Error(Exception):
    """Object to return errors messages for the users."""
...
class QueryBuilder:
    ...
    def __init__(self, connector: DatabaseConnector) -> None:
        ...
        self.__build_query(_methods=_methods)
    ...
    def __build_ind_func(self, model: str) -> Callable:
        ...
        """
        def _n_function(id: Optional[strawberry.ID] = strawberry.UNSET,  # pylint: disable=W0622
                        find_by: Optional[FindBy] = strawberry.UNSET) -> None:
    ...
    def __build_plural_func(self, model: str) -> Callable:
        ...
        ----------------------------------------------------------------
            - Function to access the local data.
        """
        def _n_function(exclude: Optional[str] = strawberry.UNSET,
                        ...
                        order_by_similarity: Optional[str] = strawberry.UNSET,
            ...
            return self._query_utils.plural_search(obj_type=model, exclude=exclude, # type: ignore
                                                   ...
                                                   orderBy=order_by,
                                                   orderBySimilarity=order_by_similarity,
                                                   page=page)
        # --------------------------------------------------------------
        # Now, change some parameters of this function
