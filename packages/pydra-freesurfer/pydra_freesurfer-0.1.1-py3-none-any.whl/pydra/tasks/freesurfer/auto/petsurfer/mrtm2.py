...
MRTM2_input_spec = specs.SpecInfo(
...
MRTM2_output_spec = specs.SpecInfo(
    name="Output", fields=output_fields, bases=(specs.ShellOutSpec,)
)


class MRTM2(ShellCommandTask):
    """
    Examples
    -------
    ...
    input_spec = MRTM2_input_spec
    output_spec = MRTM2_output_spec
