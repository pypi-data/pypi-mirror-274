...
SegStats_input_spec = specs.SpecInfo(
...
SegStats_output_spec = specs.SpecInfo(
    name="Output", fields=output_fields, bases=(specs.ShellOutSpec,)
)


class SegStats(ShellCommandTask):
    """
    Examples
    -------
    ...
    input_spec = SegStats_input_spec
    output_spec = SegStats_output_spec
