...
GLMFit_input_spec = specs.SpecInfo(
...
GLMFit_output_spec = specs.SpecInfo(
    name="Output", fields=output_fields, bases=(specs.ShellOutSpec,)
)


class GLMFit(ShellCommandTask):
    """
    Examples
    -------
    ...
    input_spec = GLMFit_input_spec
    output_spec = GLMFit_output_spec
