...
OneSampleTTest_input_spec = specs.SpecInfo(
...
OneSampleTTest_output_spec = specs.SpecInfo(
    name="Output", fields=output_fields, bases=(specs.ShellOutSpec,)
)


class OneSampleTTest(ShellCommandTask):
    """
    Examples
    -------
    ...
    input_spec = OneSampleTTest_input_spec
    output_spec = OneSampleTTest_output_spec
