...
def updateBin(rootDir):
    ...
    if sys.platform == "win32":
        getOssResource(rootDir, "https://m.mecordai.com/res/skymedia_win_20240519.zip", "92b7a19e2053c6258482bd1e61502947", "skymedia.zip.py") == True
        ...
        getOssResource(rootDir, "https://m.mecordai.com/res/skymedia_darwin_20240519.zip", "6b906eca2916fde9eee0c000d4be9d9b", "skymedia.zip.py")
