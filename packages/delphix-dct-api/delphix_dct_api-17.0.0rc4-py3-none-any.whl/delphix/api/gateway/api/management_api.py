...
class ManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_phonehome_events(
            self,
            **kwargs
        ):
            """Returns previous bundle upload events  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_phonehome_events(async_req=True)
            >>> result = thread.get()
        ...
        self.get_phonehome_events = _Endpoint(
            settings={
                'response_type': ([BundleUploadEvent],),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/management/phonehome/events',
                'operation_id': 'get_phonehome_events',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_phonehome_events
        )
