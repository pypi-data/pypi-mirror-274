...
class CreateReplicationProfileParameters(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, engine_id, target_engine_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            replication_mode (str): The ReplicationProfile mode.. defaults to "ENGINE_DATA_REPLICATION", must be one of ["ENGINE_DATA_REPLICATION", "MASKED_DATA_DISTRIBUTION", ]  # noqa: E501
        ...
        replication_mode = kwargs.get('replication_mode', "ENGINE_DATA_REPLICATION")
    ...
    @convert_js_args_to_python_args
    def __init__(self, engine_id, target_engine_id, *args, **kwargs):  # noqa: E501
        """CreateReplicationProfileParameters - a model defined in OpenAPI
