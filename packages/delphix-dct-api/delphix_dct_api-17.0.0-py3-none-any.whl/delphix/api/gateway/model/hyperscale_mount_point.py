...
class HyperscaleMountPoint(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, hyperscale_instance_id, name, hostname, mount_path, mount_type, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            name (str): Name of the mount, unique for a hyperscale instance. This name will be used as a directory name by the Hyperscale instance.
            hostname (str): The host name of the server.
            mount_path (str): The path to the directory on the filesystem to mount.
            mount_type (str): The type of filesystem. Enum having values- CIFS, NFS3, NFS4.
    ...
    @convert_js_args_to_python_args
    def __init__(self, hyperscale_instance_id, name, hostname, mount_path, mount_type, *args, **kwargs):  # noqa: E501
        """HyperscaleMountPoint - a model defined in OpenAPI
