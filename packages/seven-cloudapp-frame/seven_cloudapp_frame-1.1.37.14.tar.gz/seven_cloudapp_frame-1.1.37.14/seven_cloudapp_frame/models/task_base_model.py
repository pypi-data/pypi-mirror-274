...
@LastEditTime: 2024-05-22 14:17:08
...
class TaskBaseModel(FrameBaseModel):
    ...
    def get_task_info_dict_list(self, app_id, act_id, module_id, is_release, is_cache=True, source_object_id='', is_del=-1, order_by="sort_index desc,id asc"):
        ...
        if is_cache:
            dict_list = task_info_model.get_cache_dict_list(condition_where.to_string(), group_by="", order_by=order_by, params=params,dependency_key=DependencyKey.task_info_list(act_id))
        else:
            dict_list = task_info_model.get_dict_list(condition_where.to_string(), group_by="", order_by=order_by, params=params)
    ...
    def get_client_task_list(self, app_id, act_id, module_id, user_id, task_types="", app_key="", app_secret="", is_log=False, daily_repeat_browse=False, mix_nick="", order_by="sort_index desc,id asc"):
        """
        :description: 获取任务列表
        :param app_id:应用标识
        :param act_id:活动标识
    ...
    def get_client_task_list_v2(self, app_id, act_id, module_id, user_id, task_types="", daily_repeat_browse=False, order_by="sort_index desc,id asc"):
        """
        :description: 获取任务列表
        :param app_id:应用标识
        :param act_id:活动标识
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                if invite_help_dict:
                    ...
                    if from_user_info_dict["user_nick_encrypt"]:
                        error_message = f"您已帮【{SafeHelper.desensitize_word_v2(CryptographyHelper.base64_decrypt(from_user_info_dict["user_nick_encrypt"]))}】助力过了~请勿重复助力"
                    invoke_result_data.success = False
                    invoke_result_data.error_code = "error"
