...
@LastEditTime: 2024-03-26 19:25:41
...
class TaskInfoListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        if ver_no == "1":
            result_list,task_info_list,task_count_list = task_base_model.get_client_task_list(app_id, act_id, module_id, user_id, task_types, app_key, app_secret, is_log, daily_repeat_browse, mix_nick, order_by)
        else:
            result_list,task_info_list,task_count_list = task_base_model.get_client_task_list_v2(app_id, act_id, module_id, user_id, task_types, daily_repeat_browse, order_by)
        ref_params = {}
