...
from EVMVerifier.certoraContractFuncs import Func, InternalFunc, STATEMUT, SourceBytes
...
class CertoraBuildGenerator:
    ...
    def _handle_optimize(self, contract_file_path: str, settings_dict: Dict[str, Any],
        ...
        if self.context.solc_optimize_map:
            ...
            if not self.context.strict_solc_optimizer and (
...
def build_from_scratch(certora_build_generator: CertoraBuildGenerator,
    ...
    absolute_sources_dir = Util.get_certora_sources_dir().resolve()
    ...
    try:
        ...
        if Cv.mode_has_spec_file(context) and not context.build_only and not ignore_spec_syntax_check:
            ...
            if attr:
                ...
                typechecker_arguments = Ctx.get_typechecker_arguments(context)
                spec_check_exit_code = Util.run_local_spec_check(False, typechecker_arguments)
