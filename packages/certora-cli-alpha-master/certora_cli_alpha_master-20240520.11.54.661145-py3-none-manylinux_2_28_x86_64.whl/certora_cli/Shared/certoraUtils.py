...
def run_typechecker(typechecker_name: str, with_typechecking: bool, args: str) -> int:
    """
    ...
    @param args: A string of additional arguments to the typechecker jar.
...
def run_local_spec_check(with_typechecking: bool, args: str) -> int:
    """
    ...
    exit_code = run_typechecker("Typechecker.jar", with_typechecking, args)
    return exit_code
