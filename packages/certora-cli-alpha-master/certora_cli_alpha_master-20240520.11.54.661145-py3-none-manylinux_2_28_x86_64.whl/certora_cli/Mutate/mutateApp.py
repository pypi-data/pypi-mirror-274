...
class MutateApp:
    ...
    def run_gambit(self) -> List[Mutant]:
        ...
        gambit_args = [gambit_exec, "mutate", "--json", str(Constants.TMP_GAMBIT_PATH), "-o", str(self.outdir)]
    ...
    def read_conf_file(self) -> None:
        ...
        with open(self.conf, 'r') as conf_file:
            try:
                ...
                raise Util.CertoraUserInputError(f"Parsing error in JSON file {self.conf}", e)
