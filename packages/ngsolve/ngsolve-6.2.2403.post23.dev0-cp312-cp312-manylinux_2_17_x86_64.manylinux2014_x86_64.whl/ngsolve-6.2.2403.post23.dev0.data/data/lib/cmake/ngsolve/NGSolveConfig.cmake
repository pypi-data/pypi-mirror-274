set(PACKAGE_VERSION "6.2.2403-23-gc873c9dd9")
...
set(NGSOLVE_PYTHON_INCLUDE_DIRS "/opt/_internal/cpython-3.12.3/include/python3.12")
...
set(NGSOLVE_ZLIB_LIBRARIES "/builds/ngsolve/netgen/_skbuild/linux-x86_64-3.12/cmake-build/dependencies/zlib/lib/libz.so")
...
set(NGSOLVE_COMPILE_FLAGS " -DHAVE_NETGEN_SOURCES -DHAVE_DLFCN_H -DHAVE_CXA_DEMANGLE -DUSE_TIMEOFDAY -DTCL -DLAPACK -DUSE_PARDISO -DNGS_PYTHON -D_GLIBCXX_USE_CXX11_ABI=0 -DNETGEN_PYTHON -DNG_PYTHON -DPYBIND11_SIMPLE_GIL_MANAGEMENT -DPARALLEL -DNG_MPI_WRAPPER" CACHE STRING "Preprocessor definitions of ngscxx")
...
set(NGSOLVE_INCLUDE_DIRS /opt/_internal/cpython-3.12.3/include;/opt/_internal/cpython-3.12.3/include/python3.12 CACHE STRING "Include dirs set in ngscxx")
