...
class CoefficientFunction:
    ...
    def TensorTranspose(self, arg0: tuple) -> CoefficientFunction:
        ...
    def _BuildFieldLines(self, mesh: ..., start_points: list[tuple[float, float, float]], num_fieldlines: int = 100, length: float = 0.5, max_points: float = 500, thickness: float = 0.0015, tolerance: float = 0.0005, direction: int = 0) -> dict:
        ...
    @typing.overload
