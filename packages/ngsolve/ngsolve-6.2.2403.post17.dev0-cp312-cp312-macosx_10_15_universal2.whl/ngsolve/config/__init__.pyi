...
NGSOLVE_COMPILE_OPTIONS: str = '$<$<COMPILE_LANGUAGE:CXX>:-std=c++17>;$<$<COMPILE_LANGUAGE:CXX>:-Wno-undefined-var-template>;-DMAX_SYS_DIM=3'
...
NGSOLVE_VERSION: str = '6.2.2403-17-gd7c99a4d0'
NGSOLVE_VERSION_GIT: str = 'v6.2.2403-17-gd7c99a4d0'
NGSOLVE_VERSION_HASH: str = 'gd7c99a4d0'
NGSOLVE_VERSION_MAJOR: str = '6'
NGSOLVE_VERSION_MINOR: str = '2'
NGSOLVE_VERSION_PATCH: str = '2403'
NGSOLVE_VERSION_PYTHON: str = '6.2.2403.post17.dev'
NGSOLVE_VERSION_TWEAK: str = '17'
...
version: str = 'v6.2.2403-17-gd7c99a4d0'
