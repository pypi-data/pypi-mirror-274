...
class NewtonSolver:
    ...
    def _UpdateInverse(self):
        ...
    def __init__(self, a, u, rhs = None, freedofs = None, inverse = 'umfpack', solver = None):
        ...
def Newton(a, u, freedofs = None, maxit = 100, maxerr = 1e-11, inverse = 'umfpack', dirichletvalues = None, dampfactor = 1, printing = True, callback = None):
    """
