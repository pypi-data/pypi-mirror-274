...
class TestConvert(unittest.TestCase):
    ...
    def test_to_protobuf_value__list(self):
        self.assertEqual(
            Value(
                list_value=ListValue(values=[Value(string_value="foo"), Value(string_value="bar")])
            ),
            to_protobuf_value(["foo", "bar"]),
        )
    ...
    def test_to_protobuf_value__unsupported_type(self):
        ...
        self.assertEqual("Unsupported type: <class 'function'>", str(context.exception))
    ...
    def test_from_protobuf_value__unknown_type(self, _):
        ...
        self.assertEqual("Unknown type of value: unknown_kind", str(context.exception))

    def test_mock_(self):
        self.assertEqual(Mock(), Mock_())
        ...
        kwargs = {
            ...
            "return": Mock.Return(dynamic="dynamic"),
        }
        ...
        self.assertEqual(Mock(**kwargs), Mock_(**mock__kwargs))
