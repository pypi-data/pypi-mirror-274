...
from pyrogram.errors import (
    ...
    BadRequest, ListenerCanceled
)
from pyrogram.handlers.handler import Handler
from pyrogram.methods import Methods
from pyrogram.session import Auth, Session
from pyrogram.storage import FileStorage, MemoryStorage, MongoDB
...
class Client(Methods):
    ...
    Parameters:
        ...
        mongo_name (``str``, *optional*):
            The *mongo_name* part of the Database Project MongoDb Name, as string.
            E.g.: "AyiinUserbot".

        mongo_url (``str``, *optional*):
            The *mongo_url* part of the Database Project MongoDb Url, as string.
            E.g.: "mongodb+srv://Database:<password>@unknown.hu0kkix.mongodb.net/?retryWrites=true&w=majority".
    ...
    def __init__(
        ...
        if self.mongo_url:
            self.mDb = MongoDB(self.mongo_url, self.mongo_name)
        ...
        self._prefixSudo: Optional[str] = None
        self._sudo: list = []
        self._fsub: list = []
        self._admins: list = []
        self._expired: Union[str] = None
        self._owner: Union[int, str] = None
        self._logChat: Union[int, str] = None
        self._permit: bool = False
    ...
    def setAttribute(self, prefix: str = None, sudo: list = None):
        if prefix:
            self._prefix = prefix
        if sudo:
            if len(sudo) == 0:
                        ...
                        while True:
                            ...
                            if progress:
                                func = functools.partial(
                                    progress,
                                    min(offset_bytes,
                                        file_size) if file_size != 0 else offset_bytes,
                                    file_size,
                                    *progress_args
                                )
