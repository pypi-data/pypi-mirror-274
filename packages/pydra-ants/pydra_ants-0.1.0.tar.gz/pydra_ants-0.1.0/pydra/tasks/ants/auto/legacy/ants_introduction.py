...
antsIntroduction_input_spec = specs.SpecInfo(
...
antsIntroduction_output_spec = specs.SpecInfo(
    name="Output", fields=output_fields, bases=(specs.ShellOutSpec,)
)


class antsIntroduction(ShellCommandTask):
    """
    Examples
    -------
    ...
    >>> task.inputs.reference_image = "Template_6.nii"
    ...
    input_spec = antsIntroduction_input_spec
    output_spec = antsIntroduction_output_spec
