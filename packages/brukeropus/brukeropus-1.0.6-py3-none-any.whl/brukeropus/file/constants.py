...
STRUCT_3D_INFO_BLOCK = [
    {'key': 'nss', 'fmt': 'l', 'dtype': np.int32},
    {'key': 'nsr', 'fmt': 'l', 'dtype': np.int32},
    {'key': 'nsn', 'fmt': 'l', 'dtype': np.int32},
    {'key': 'npt', 'fmt': 'l', 'dtype': np.int32},
    {'key': 'gfw', 'fmt': 'l', 'dtype': np.int32},
    {'key': 'gbw', 'fmt': 'l', 'dtype': np.int32},
    {'key': 'bfw', 'fmt': 'l', 'dtype': np.int32},
    {'key': 'bbw', 'fmt': 'l', 'dtype': np.int32},
    {'key': 'hfl', 'fmt': 'd', 'dtype': np.float64},
    {'key': 'lfl', 'fmt': 'd', 'dtype': np.float64},
    {'key': 'hff', 'fmt': 'd', 'dtype': np.float64},
    {'key': 'lff', 'fmt': 'd', 'dtype': np.float64},
    {'key': 'filter_size', 'fmt': 'l', 'dtype': np.int32},
    {'key': 'filter_type', 'fmt': 'l', 'dtype': np.int32},
