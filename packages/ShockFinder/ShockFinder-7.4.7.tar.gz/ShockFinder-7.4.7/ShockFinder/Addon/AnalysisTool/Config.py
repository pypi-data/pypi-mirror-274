...
try:
	try:
		import ShockFinder.Addon.AnalysisTool.BlackHoleMassFlux as BlackHoleMassFlux
	except Exception as err:
		print("BlackHoleMassFluxin ShockFinder dir importing error, reimporting in current dir")
		import BlackHoleMassFlux
	AnalysisTool["BlackHoleMassFlux"]=BlackHoleMassFlux
except Exception as err:
	print("Module: BlackHoleMassFlux import failure:",err)
...
try:
	try:
		...
		print("BruntVaisalaFrequencyin ShockFinder dir importing error, reimporting in current dir")
...
try:
	try:
		...
		print("ScalingSlopein ShockFinder dir importing error, reimporting in current dir")
		import ScalingSlope
