...
import os
try:
	from ShockFinder.Addon.GUI.XUIlib.XUIConfig import Pages as Pages #those folders/packages path modified by yourself
except:
	pass
...
def CollectPages():
	...
	try:
		...
		vaild_pages=tuple(set([FileNamePreProcess(i)[0] for i in GetFiles(os.path.join("XUIlib","pages"),"py")])-set(pages_except))
