...
def get(Dataobj,args={},vargs={}):
	...
	if INTRMAX==None:
		...
		try:
			try:
				Index=Mean.GetMeanRegionIndex(Dataobj,(0,),((0,Dataobj.quantities[INTRMAX]),))[0][1]
			except:
				Index=Mean.GetMeanRegionIndex(Dataobj,(0,),((0,Dataobj.grid[INTRMAX]),))[0][1]
	...
	if Dataobj.quantities["Bremsstrahlung"].ndim==3:#3d
		quantities={"Total_Bremsstrahlung":intfun(nc,INTRMAX,Dataobj.grid["x2"],Dataobj.grid["x3"])}
