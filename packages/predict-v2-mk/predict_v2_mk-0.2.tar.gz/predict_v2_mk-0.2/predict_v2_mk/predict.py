...
def predict_new_data(model_path='modelv111.h5', new_file='new_data1.txt'):
...
def main():
    if len(sys.argv) > 1:
        ...
        new_data_file = 'new_data1.txt'

    model_path = 'modelv111.h5'

    predictions = predict_new_data(model_path, new_data_file)
