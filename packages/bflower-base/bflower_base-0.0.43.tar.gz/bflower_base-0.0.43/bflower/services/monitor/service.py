...
from bflower.services.monitor.schema import MessageModel, TransactionModel, VertexBuildModel
from bflower.services.monitor.utils import add_row_to_table, drop_and_create_table_if_schema_mismatch

if TYPE_CHECKING:
    from bflower.services.settings.manager import SettingsService
...
class MonitorService(Service):
    ...
    def __init__(self, settings_service: "SettingsService"):
        ...
        self.base_cache_dir = Path(user_cache_dir("bflower"))
