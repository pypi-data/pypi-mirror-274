...
from bflower.services.task.backends.anyio import AnyIOBackend
from bflower.services.task.backends.base import TaskBackend
from bflower.services.task.utils import get_celery_worker_status
...
def check_celery_availability():
    try:
        from bflower.worker import celery_app
...
class TaskService(Service):
    ...
    def get_backend(self) -> TaskBackend:
        if self.use_celery:
            from bflower.services.task.backends.celery import CeleryBackend
