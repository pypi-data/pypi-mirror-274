...
from bflower.api.utils import update_frontend_node_with_template_values
from bflower.api.v1.schemas import (
...
from bflower.interface.custom.utils import build_custom_component_template
from bflower.processing.process import process_tweaks, run_graph_internal
from bflower.schema.graph import Tweaks
from bflower.services.auth.utils import api_key_security, get_current_active_user
from bflower.services.cache.utils import save_uploaded_file
from bflower.services.database.models.flow import Flow
from bflower.services.database.models.user.model import User
from bflower.services.deps import get_session, get_session_service, get_settings_service, get_task_service
...
def get_all(
    ...
    from bflower.interface.types import get_all_types_dict
...
# get endpoint to return version of bflower
@router.get("/version")
def get_version():
    try:
        ...
        version = metadata.version("bflower-base")
