...
from bflower.interface.importing.utils import import_class
...
from bflower.template.frontend_node.prompts import PromptFrontendNode
...
class PromptCreator(LangChainTypeCreator):
    ...
    def type_to_loader_dict(self) -> Dict:
        ...
        if self.type_dict is None:
            ...
            from bflower.interface.prompts.custom import CUSTOM_PROMPTS
