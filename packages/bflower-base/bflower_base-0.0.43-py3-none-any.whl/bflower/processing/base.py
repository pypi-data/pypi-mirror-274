...
from bflower.processing.process import fix_memory_inputs, format_actions
from bflower.services.deps import get_plugins_service
...
def get_langfuse_callback(trace_id):
    ...
    if langfuse := get_plugins_service().get("langfuse"):
        ...
        try:
            trace = langfuse.trace(name="bflower-" + trace_id, id=trace_id)
