...
from bflower.services.schema import ServiceType

if TYPE_CHECKING:
    from sqlmodel import Session

    from bflower.services.cache.service import CacheService
    from bflower.services.chat.service import ChatService
    from bflower.services.database.service import DatabaseService
    from bflower.services.monitor.service import MonitorService
    from bflower.services.plugins.service import PluginService
    from bflower.services.session.service import SessionService
    from bflower.services.settings.service import SettingsService
    from bflower.services.socket.service import SocketIOService
    from bflower.services.state.service import StateService
    from bflower.services.storage.service import StorageService
    from bflower.services.store.service import StoreService
    from bflower.services.task.service import TaskService
...
def get_service(service_type: ServiceType, default=None):
    ...
    """
    from bflower.services.manager import service_manager
...
def get_state_service() -> "StateService":
    ...
    """
    from bflower.services.state.factory import StateServiceFactory
...
def get_storage_service() -> "StorageService":
    ...
    """
    from bflower.services.storage.factory import StorageServiceFactory
...
def get_variable_service() -> "VariableService":
    ...
    """
    from bflower.services.variable.factory import VariableServiceFactory
...
def get_settings_service() -> "SettingsService":
    ...
    """
    from bflower.services.settings.factory import SettingsServiceFactory
...
def get_db_service() -> "DatabaseService":
    ...
    """
    from bflower.services.database.factory import DatabaseServiceFactory
...
def get_cache_service() -> "CacheService":
    ...
    """
    from bflower.services.cache.factory import CacheServiceFactory
...
def get_session_service() -> "SessionService":
    ...
    """
    from bflower.services.session.factory import SessionServiceFactory
...
def get_monitor_service() -> "MonitorService":
    ...
    """
    from bflower.services.monitor.factory import MonitorServiceFactory
...
def get_task_service() -> "TaskService":
    ...
    """
    from bflower.services.task.factory import TaskServiceFactory
