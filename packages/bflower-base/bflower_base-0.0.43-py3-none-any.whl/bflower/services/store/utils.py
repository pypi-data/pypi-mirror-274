...
if TYPE_CHECKING:
    from bflower.services.store.schema import ListComponentResponse
...
# Get the latest released version of bflower (https://pypi.org/project/bflower/)
def get_lf_version_from_pypi():
    try:
        response = httpx.get("https://pypi.org/pypi/bflower/json")
