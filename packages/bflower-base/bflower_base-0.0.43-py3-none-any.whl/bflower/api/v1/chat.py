...
from bflower.services.deps import get_chat_service, get_session, get_session_service
from bflower.services.monitor.utils import log_vertex_build

if TYPE_CHECKING:
    from bflower.graph.vertex.types import ChatVertex
...
async def try_running_celery_task(vertex, user_id):
    ...
    try:
        from bflower.worker import build_vertex
