...
from bflower.field_typing.constants import CUSTOM_COMPONENT_SUPPORTED_TYPES
...
def create_class(code, class_name):
    ...
    # Replace from bflower import CustomComponent with from bflower.custom import CustomComponent
    code = code.replace("from bflower import CustomComponent", "from bflower.custom import CustomComponent")
...
def get_default_imports(code_string):
    ...
    langflow_module = importlib.import_module("bflower.field_typing")
