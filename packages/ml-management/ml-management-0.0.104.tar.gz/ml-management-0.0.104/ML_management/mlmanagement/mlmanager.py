...
def request_log_model(function_name: str, kwargs: dict, extra_attrs: list, module_name: str):
    ...
    from ML_management.dataset_loader_template.dataset_loader_pattern_to_methods_map import (
    ...
    with TemporaryDirectory() as temp_dir:
        ...
        with open(model_filename, "rb") as file:
            return request("log_model", kwargs, extra_attrs, file, module_name=module_name)
