...
class AnalyzerTests(unittest.TestCase):
    ...
    def test_get_return_report_draw_graph_when_graph_filename_exist(
        ...
        self.assertEqual(mock_addplot.call_args_list[0][0][0].iloc[0], 5000)
        self.assertEqual(mock_addplot.call_args_list[0][0][0].iloc[1], 5000)
        self.assertEqual(mock_addplot.call_args_list[1][0][0].iloc[1], 6000.0)
        self.assertEqual(mock_addplot.call_args_list[2][0][0].iloc[0], 500)
        self.assertEqual(mock_addplot.call_args_list[2][0][0].iloc[1], 600)
        self.assertEqual(mock_addplot.call_args_list[3][0][0].iloc[0], -65.248)
        self.assertEqual(mock_addplot.call_args_list[3][0][0].iloc[1], -75.067)
        self.assertEqual(mock_addplot.call_args_list[4][0][0].iloc[0], 5900)
        self.assertEqual(mock_addplot.call_args_list[4][0][0].iloc[1], 9999)
        self.assertEqual(mock_addplot.call_args_list[4][0][0].iloc[2], 8888)
