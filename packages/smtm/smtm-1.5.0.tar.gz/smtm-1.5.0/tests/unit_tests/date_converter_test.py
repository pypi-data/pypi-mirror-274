...
class DateConverterToEndMinTests(unittest.TestCase):
    def test_to_end_min_return_correct_tuple(self):
        ...
        result = DateConverter.to_end_min(
            "200220.120000-200320.235500", max_count=50000
        )
        expect = ("2020-02-20T12:00:00", "2020-03-20T23:55:00", 42475)
        self.assertEqual(result[0], expect)

        result = DateConverter.to_end_min(
            "201220.170000-201220.180000", max_count=50000
        )
    ...
    def test_to_end_min_return_correct_tuple_list(self):
        ...
        self.assertEqual(
            result[10], ("2020-02-21T09:20:00", "2020-02-21T12:40:00", 200)
        )
        self.assertEqual(
            result[11], ("2020-02-21T12:40:00", "2020-02-21T16:00:00", 200)
        )
        self.assertEqual(
            result[12], ("2020-02-21T16:00:00", "2020-02-21T19:20:00", 200)
        )
        self.assertEqual(
            result[13], ("2020-02-21T19:20:00", "2020-02-21T22:40:00", 200)
        )
        self.assertEqual(
            result[14], ("2020-02-21T22:40:00", "2020-02-22T02:00:00", 200)
        )
        self.assertEqual(
            result[15], ("2020-02-22T02:00:00", "2020-02-22T05:20:00", 200)
        )
        self.assertEqual(
            result[16], ("2020-02-22T05:20:00", "2020-02-22T08:40:00", 200)
        )
        self.assertEqual(
            result[17], ("2020-02-22T08:40:00", "2020-02-22T12:00:00", 200)
        )
        self.assertEqual(
            result[18], ("2020-02-22T12:00:00", "2020-02-22T15:20:00", 200)
        )
        self.assertEqual(
            result[19], ("2020-02-22T15:20:00", "2020-02-22T18:40:00", 200)
        )
        self.assertEqual(
            result[20], ("2020-02-22T18:40:00", "2020-02-22T22:00:00", 200)
        )
        self.assertEqual(
            result[21], ("2020-02-22T22:00:00", "2020-02-23T00:00:00", 120)
        )
    ...
    def test_to_end_min_return_correct_tuple_when_3_interval(self):
        result = DateConverter.to_end_min(
            "200220-200320", max_count=50000, interval_min=3
        )
        expect = ("2020-02-20T00:00:00", "2020-03-20T00:00:00", 13920)
        self.assertEqual(result[0], expect)

        result = DateConverter.to_end_min(
            "200220.120000-200320", max_count=50000, interval_min=3
        )
        expect = ("2020-02-20T12:00:00", "2020-03-20T00:00:00", 13680)
        self.assertEqual(result[0], expect)

        result = DateConverter.to_end_min(
            "200220-200320.120000", max_count=50000, interval_min=3
        )
        ...
        result = DateConverter.to_end_min(
            "200520-200320", max_count=50000, interval_min=3
        )
        self.assertEqual(result, None)

    def test_to_end_min_return_correct_tuple_list_when_3_interval(self):
        result = DateConverter.to_end_min(
            "200220-200223", max_count=5000, interval_min=3
        )
        expect = ("2020-02-20T00:00:00", "2020-02-23T00:00:00", 1440)
        self.assertEqual(result[0], expect)

        result = DateConverter.to_end_min(
            "200220-200223", max_count=200, interval_min=3
        )
    ...
    def test_to_end_min_raise_user_warning_when_invalid_duration_and_3_interval(self):
        with self.assertRaises(UserWarning):
            DateConverter.to_end_min(
                "200220.120015-200320.235510", max_count=50000, interval_min=3
            )
...
class DateConverterTests(unittest.TestCase):
    ...
    def test_floor_min_should_return_correct_datetime_string(self):
        self.assertEqual(
            DateConverter.floor_min("2020-02-20T12:01:15", 3), "2020-02-20T12:00:15"
        )
        self.assertEqual(
            DateConverter.floor_min("2020-02-20T12:02:15", 3), "2020-02-20T12:00:15"
        )
        self.assertEqual(
            DateConverter.floor_min("2020-02-20T12:03:15", 3), "2020-02-20T12:03:15"
        )
        self.assertEqual(
            DateConverter.floor_min("2020-02-20T12:04:15", 3), "2020-02-20T12:03:15"
        )
        self.assertEqual(
            DateConverter.floor_min("2020-02-20T12:04:15", 5), "2020-02-20T12:00:15"
        )
        self.assertEqual(
            DateConverter.floor_min("2020-02-20T12:05:15", 5), "2020-02-20T12:05:15"
        )
