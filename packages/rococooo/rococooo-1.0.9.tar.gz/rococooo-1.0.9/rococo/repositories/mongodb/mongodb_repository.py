...
class MongoDbRepository(BaseRepository):
    ...
    def update(self, data: Dict, collection_name: str, updated_by=None):
        with self.client.start_session() as session:
            with session.start_transaction():
                if data:
                    ...
                    model.prepare_for_save(changed_by_id=updated_by)
                    model.as_dict(convert_datetime_to_iso_string=True, convert_uuids=True)
