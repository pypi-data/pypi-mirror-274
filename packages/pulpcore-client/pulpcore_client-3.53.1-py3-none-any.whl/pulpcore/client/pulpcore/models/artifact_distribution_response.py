...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, name=None, base_url=None, content_guard=None, hidden=False, pulp_labels=None, pulp_created=None, base_path=None, pulp_href=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
