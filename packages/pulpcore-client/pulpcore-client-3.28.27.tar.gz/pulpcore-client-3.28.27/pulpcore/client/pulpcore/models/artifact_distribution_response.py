...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, name=None, pulp_labels=None, base_url=None, hidden=False, pulp_href=None, pulp_created=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
