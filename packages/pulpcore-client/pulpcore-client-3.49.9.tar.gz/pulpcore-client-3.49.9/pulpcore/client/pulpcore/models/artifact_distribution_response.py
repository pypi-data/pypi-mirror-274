...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, base_url=None, hidden=False, pulp_created=None, pulp_labels=None, pulp_href=None, pulp_last_updated=None, name=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
