...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, base_path=None, pulp_labels=None, base_url=None, hidden=False, name=None, pulp_href=None, pulp_created=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
