...
def add_common(
    ctx: typer.Context,
    config_file_path: Annotated[Path, typer.Option("-f", "--config-file-path", envvar="CNC_CONFIG_PATH", help="CNC config file path")] = Path("cnc.yml"),
    environments_file_path: Annotated[Path, typer.Option("-e", "--environments-file-path", envvar="CNC_ENVIRONMENTS_PATH", help="Environments data file path")] = Path("environments.yml"),
):
