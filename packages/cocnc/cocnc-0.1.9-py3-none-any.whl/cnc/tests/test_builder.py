...
class BuildTagsPerServiceTestCase(CNCBaseTestCase):
    ...
    def test_template_config_tags(self):
        ...
        self.assertIn(
            "us-east1-docker.pkg.dev/foo-bar-123/my-backend-test-app/my-backend-t-app:tag1",
            app_build_functions,
        )
        self.assertIn(
            "us-east1-docker.pkg.dev/foo-bar-123/my-backend-test-app/my-backend-t-api:tag2",
            api_build_functions,
        )
