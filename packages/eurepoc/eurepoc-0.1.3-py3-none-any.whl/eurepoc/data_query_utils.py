...
BASE_URL = "https://strapi.eurepoc.eu/api/incidents"
HEADERS = {
...
def build_filters(
    ...
    if initiator_country:
        filters.append(f"filters[$and][][get_attributions][get_initiators][countries][name][$contains]={initiator_country}")
...
def build_query(
    ...
    nested_query = NestedQueryString.encode({
        ...
        "populate": [
            ...
            "get_attributions",
            "get_attributions.articles",
            "get_attributions.get_initiators.countries",
            "get_attributions.get_initiators.category.code",
            "get_attributions.get_initiators.category.subcode",
            "get_attributions.countries_of_origin",
            "get_attributions.attribution_basis.code",
            "get_attributions.attribution_basis.subcode",
            "get_attributions.attribution_type.code",
            "get_attributions.attribution_type.subcode",
            "get_attributions.temporal_attribution_sequence.code",
            "get_attributions.temporal_attribution_sequence.subcode",
            "get_attributions.attribution_date",
            "get_attributions.attributing_actors",
            "get_attributions.attributing_country",
            "get_attributions.it_companies",
            "get_attributions.legal_attribution_references.code",
            "get_attributions.legal_attribution_references.subcode",
            ...
            "get_inclusion_criteria.code",
            "get_inclusion_criteria.subcode",
            ...
            "get_mitre_impact.code",
            "get_mitre_impact.subcode",

            "get_mitre_initial_access.code",
            "get_mitre_initial_access.subcode",
...
def get_paginated_data(query, token):
    data = []
    initial_response = fetch_data(query, token)
    ...
    for page in range(2, nb_pages + 1):
        ...
        response = fetch_data(paginated_query, token)
...
def query_database(
    ...
    raw_data = get_paginated_data(query, token)
