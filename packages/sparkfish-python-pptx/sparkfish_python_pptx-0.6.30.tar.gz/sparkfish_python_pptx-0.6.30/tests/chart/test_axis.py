...
class Describe_BaseAxis(object):
    ...
    def it_can_change_whether_it_has_major_gridlines(self, major_gridlines_set_fixture):
    ...
    def it_knows_whether_it_has_minor_gridlines(self, minor_gridlines_get_fixture):
        base_axis, expected_value = minor_gridlines_get_fixture
        assert base_axis.has_minor_gridlines is expected_value

    def it_can_change_whether_it_has_minor_gridlines(self, minor_gridlines_set_fixture):
    ...
    @pytest.fixture(
        params=[
            ("c:catAx", XL_TICK_MARK.INSIDE, "c:catAx/c:majorTickMark{val=in}"),
            (
                "c:catAx/c:majorTickMark{val=in}",
                XL_TICK_MARK.OUTSIDE,
                "c:catAx/c:majorTickMark{val=out}",
            ),
            ("c:catAx/c:majorTickMark{val=out}", XL_TICK_MARK.CROSS, "c:catAx"),
            ("c:catAx", XL_TICK_MARK.CROSS, "c:catAx"),
            ("c:catAx/c:majorTickMark{val=cross}", XL_TICK_MARK.CROSS, "c:catAx"),
            ("c:dateAx", XL_TICK_MARK.INSIDE, "c:dateAx/c:majorTickMark{val=in}"),
            (
                "c:dateAx/c:majorTickMark{val=in}",
                XL_TICK_MARK.OUTSIDE,
                "c:dateAx/c:majorTickMark{val=out}",
            ),
            ("c:dateAx/c:majorTickMark{val=out}", XL_TICK_MARK.CROSS, "c:dateAx"),
            ("c:dateAx", XL_TICK_MARK.CROSS, "c:dateAx"),
            ("c:dateAx/c:majorTickMark{val=cross}", XL_TICK_MARK.CROSS, "c:dateAx"),
            ("c:valAx", XL_TICK_MARK.INSIDE, "c:valAx/c:majorTickMark{val=in}"),
            (
                "c:valAx/c:majorTickMark{val=in}",
                XL_TICK_MARK.OUTSIDE,
                "c:valAx/c:majorTickMark{val=out}",
            ),
            ("c:valAx/c:majorTickMark{val=out}", XL_TICK_MARK.CROSS, "c:valAx"),
            ("c:valAx", XL_TICK_MARK.CROSS, "c:valAx"),
            ("c:valAx/c:majorTickMark{val=cross}", XL_TICK_MARK.CROSS, "c:valAx"),
        ]
    )
    ...
    @pytest.fixture(
        params=[
            ...
            (
                "c:catAx/c:scaling/c:max{val=34.56}",
                42.42,
            ...
            (
                "c:dateAx/c:scaling/c:max{val=45.67}",
                42.42,
            ...
            (
                "c:valAx/c:scaling/c:max{val=56.78}",
                42.42,
    ...
    @pytest.fixture(
        params=[
            ...
            (
                "c:catAx/c:scaling/c:min{val=34.56}",
                42.42,
            ...
            (
                "c:dateAx/c:scaling/c:min{val=45.67}",
                42.42,
            ...
            (
                "c:valAx/c:scaling/c:min{val=56.78}",
                42.42,
    ...
    @pytest.fixture(
        params=[
            ("c:catAx", XL_TICK_MARK.INSIDE, "c:catAx/c:minorTickMark{val=in}"),
            (
                "c:catAx/c:minorTickMark{val=in}",
                XL_TICK_MARK.OUTSIDE,
                "c:catAx/c:minorTickMark{val=out}",
            ),
            ("c:catAx/c:minorTickMark{val=out}", XL_TICK_MARK.CROSS, "c:catAx"),
            ("c:catAx", XL_TICK_MARK.CROSS, "c:catAx"),
            ("c:catAx/c:minorTickMark{val=cross}", XL_TICK_MARK.CROSS, "c:catAx"),
            ("c:dateAx", XL_TICK_MARK.INSIDE, "c:dateAx/c:minorTickMark{val=in}"),
            (
                "c:dateAx/c:minorTickMark{val=in}",
                XL_TICK_MARK.OUTSIDE,
                "c:dateAx/c:minorTickMark{val=out}",
            ),
            ("c:dateAx/c:minorTickMark{val=out}", XL_TICK_MARK.CROSS, "c:dateAx"),
            ("c:dateAx", XL_TICK_MARK.CROSS, "c:dateAx"),
            ("c:dateAx/c:minorTickMark{val=cross}", XL_TICK_MARK.CROSS, "c:dateAx"),
            ("c:valAx", XL_TICK_MARK.INSIDE, "c:valAx/c:minorTickMark{val=in}"),
            (
                "c:valAx/c:minorTickMark{val=in}",
                XL_TICK_MARK.OUTSIDE,
                "c:valAx/c:minorTickMark{val=out}",
            ),
            ("c:valAx/c:minorTickMark{val=out}", XL_TICK_MARK.CROSS, "c:valAx"),
            ("c:valAx", XL_TICK_MARK.CROSS, "c:valAx"),
            ("c:valAx/c:minorTickMark{val=cross}", XL_TICK_MARK.CROSS, "c:valAx"),
        ]
    )
    ...
    @pytest.fixture(
        params=[
            ("c:catAx", XL_TICK_LBL_POS.HIGH, "c:catAx/c:tickLblPos{val=high}"),
            (
                "c:catAx/c:tickLblPos{val=high}",
                XL_TICK_LBL_POS.LOW,
                "c:catAx/c:tickLblPos{val=low}",
            ),
            ("c:catAx/c:tickLblPos{val=low}", None, "c:catAx/c:tickLblPos"),
            ("c:catAx", None, "c:catAx/c:tickLblPos"),
            (
                "c:dateAx",
                XL_TICK_LBL_POS.NEXT_TO_AXIS,
                "c:dateAx/c:tickLblPos{val=nextTo}",
            ),
            (
                "c:dateAx/c:tickLblPos{val=nextTo}",
                XL_TICK_LBL_POS.NONE,
                "c:dateAx/c:tickLblPos{val=none}",
            ),
            ("c:dateAx/c:tickLblPos{val=none}", None, "c:dateAx/c:tickLblPos"),
            ("c:valAx", XL_TICK_LBL_POS.HIGH, "c:valAx/c:tickLblPos{val=high}"),
            (
                "c:valAx/c:tickLblPos{val=high}",
                XL_TICK_LBL_POS.LOW,
                "c:valAx/c:tickLblPos{val=low}",
            ),
            ("c:valAx/c:tickLblPos{val=low}", None, "c:valAx/c:tickLblPos"),
        ]
    )
...
class DescribeAxisTitle(object):
    ...
    def it_provides_access_to_its_text_frame(self, text_frame_fixture):
        ...
        TextFrame_.assert_called_once_with(axis_title._element.tx.rich, axis_title)
...
class DescribeTickLabels(object):
    ...
    def it_can_change_whether_its_number_format_is_linked(
        ...
        tick_labels, new_value, expected_xml = number_format_is_linked_set_fixture
    ...
    @pytest.fixture(
        params=[
            ...
            (
                "c:valAx/c:numFmt{formatCode=General}",
                "00.00",
    ...
    def Font_(self, request, font_):
        return class_mock(request, "pptx.chart.axis.Font", return_value=font_)
...
class DescribeValueAxis(object):
    ...
    def it_can_change_the_other_axis_crossing_value(self, crosses_at_set_fixture):
    ...
    @pytest.fixture(
        params=[
            ("c:plotArea/(c:valAx/c:axId{val=42},c:valAx/c:crossAx{val=42})", None),
            (
    ...
    @pytest.fixture(
        params=[
            ("c:plotArea/(c:valAx/c:axId{val=42},c:valAx/c:crossAx{val=42})", "CUSTOM"),
            (
    ...
    @pytest.fixture(
        params=[
            ("c:valAx", 42, "c:valAx/c:majorUnit{val=42.0}"),
            ("c:valAx", None, "c:valAx"),
            ("c:valAx/c:majorUnit{val=42.0}", 24.0, "c:valAx/c:majorUnit{val=24.0}"),
            ("c:valAx/c:majorUnit{val=42.0}", None, "c:valAx"),
        ]
    )
    ...
    @pytest.fixture(params=[("c:valAx", None), ("c:valAx/c:minorUnit{val=2.4}", 2.4)])
    ...
    @pytest.fixture(
        params=[
            ("c:valAx", 36, "c:valAx/c:minorUnit{val=36.0}"),
            ("c:valAx", None, "c:valAx"),
            ("c:valAx/c:minorUnit{val=36.0}", 12.6, "c:valAx/c:minorUnit{val=12.6}"),
            ("c:valAx/c:minorUnit{val=36.0}", None, "c:valAx"),
        ]
    )
