from nomad_media_pip.admin.live_channel.get_live_channel_schedule_events import _get_live_channel_schedule_events

def _get_live_channel_inputs_ids(AUTH_TOKEN, URL, CHANNEL_ID, DEBUG):
    # Declare empty array for the IDs
    INPUT_IDS = []

    # Get all the schedule events for the channel
    CHANNEL_EVENTS = _get_live_channel_schedule_events(AUTH_TOKEN, URL, CHANNEL_ID, DEBUG)
