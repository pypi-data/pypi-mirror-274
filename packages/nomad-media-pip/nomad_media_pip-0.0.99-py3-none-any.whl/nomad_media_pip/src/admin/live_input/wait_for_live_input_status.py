from nomad_media_pip.admin.live_input.get_live_input_status import _get_live_input_status
from nomad_media_pip.admin.live_input.get_live_input_status_message import _get_live_input_status_message

import time

def _wait_for_live_input_status(AUTH_TOKEN, URL, INPUT_ID, STATUS_TO_WAIT_FOR, TIMEOUT = 30, POLL_INTERVAL = 2, DEBUG = False):
    ...
    while (ELAPSED_TIME < TIMEOUT):
        ...
        INPUT_STATUS = _get_live_input_status(AUTH_TOKEN, URL, INPUT_ID, DEBUG)
        ...
        if (INPUT_STATUS == "Error"):
            ...
            INPUT_STATUS_MESSAGE = _get_live_input_status_message(AUTH_TOKEN, URL, INPUT_ID)
