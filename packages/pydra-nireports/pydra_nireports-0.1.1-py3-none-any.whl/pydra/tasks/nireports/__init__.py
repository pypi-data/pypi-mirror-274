...
try:
    ...
    raise RuntimeError(
        "pydra-nireports has not been properly installed, please run "
...
if "post" not in __version__:
    try:
        ...
        warn(
            ...
            "to generated the converted Nipype interfaces in pydra.tasks.nireports"
        )
    else:
