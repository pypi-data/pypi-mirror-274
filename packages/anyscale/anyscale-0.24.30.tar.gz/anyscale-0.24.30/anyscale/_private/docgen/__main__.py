...
from anyscale.commands import job_commands, service_commands
...
ALL_MODULES = [
    Module(
        ...
        models=[JobConfig, JobState, JobStatus],
    ),
    Module(
        title="Service",
    ...
    Module(
        ...
        models=[ComputeConfig, HeadNodeConfig, WorkerNodeGroupConfig, MarketType],
    ),
]
