...
class AuthApi:
    ...
    def api_v1_auth_post(
        ...
        This endpoint authenticates the user and returns configuration details to continue using the system.
        ...
        _param = self._api_v1_auth_post_serialize(
    ...
    @validate_call
    def api_v1_auth_post_with_http_info(
        self,
        auth_request: AuthRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v1_auth_post_without_preload_content(
        self,
        auth_request: AuthRequest,
        _request_timeout: Union[
            None,
    ...
    def _api_v1_auth_post_serialize(
        self,
        auth_request,
        _request_auth,
        _content_type,
