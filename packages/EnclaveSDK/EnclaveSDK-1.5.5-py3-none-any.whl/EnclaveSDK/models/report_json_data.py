...
class ReportJsonData(BaseModel):
    ...
    report: Dict[str, Any] = Field(description="Report object")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReportJsonData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReportJsonData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"report": obj.get("report")})
        return _obj
