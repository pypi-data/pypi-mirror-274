...
def cmaplist(index):
    ...
    if type(index) == list:
        ...
        #print(f'\033[44m[pymeili Info]\033[0m Detected colormap code index: {index}; theme is {theme}.')
        str(index)
        if index in ['-28','28','-27','-26','-25','-24','-23','-22','22','23','24','25','26','27','12','13','14','15','-12','-13','-14','-15','33','34','35','36','37','38','39','-33','-34','-35','-36','-37','-38','-39','43','44','45','46','47','48','49','-43','-44','-45','-46','-47','-48','-49','59','58','57','-57','-58','-59','-69','69','-79','79','-89','89','-99','99','-109','109','-119','119','-129','129', '-139', '139', '-149', '149', '-159', '159', '-169', '169', '-179', '179', '-189', '189', '-199', '199', '-209', '209','-219','219','-229','229']:
            try:
                if theme == 'light':
                    if index == '15':
                    ...
                    if index == '109':
                        return LinearSegmentedColormap.from_list('mycmap',['#400000','#7D0204','#4B0077','#A401E6','#0102FB','#014BAA','#016EFF','#72B2D6','#97DAF4','#BEFFE8','#F5F5F5','#EFFDCA','#FEE183','#FB9001','#EF5E03','#E40004','#BB022E','#8A0220','#7A021C','#7A021C','#75021C'])
                    if index == '-109':
                        return LinearSegmentedColormap.from_list('mycmap',['#75021C','#7A021C','#7A021C','#8A0220','#BB022E','#E40004','#EF5E03','#FB9001','#FEE183','#EFFDCA','#F5F5F5','#BEFFE8','#97DAF4','#72B2D6','#016EFF','#014BAA','#0102FB','#A401E6','#4B0077','#7D0204','#400000'])
                    ...
                    if index == '229':
                        return LinearSegmentedColormap.from_list('mycmap',["#64FCFF","#00D1CB","#0098A4","#0A4F4A"])
                    if index == '-229':
                        return LinearSegmentedColormap.from_list('mycmap',["#0A4F4A","#0098A4","#00D1CB","#64FCFF"])
