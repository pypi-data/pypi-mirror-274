...
setup(name='libTSCANAPI',  # 包名
      ...
      #   ('./libTSCANAPI/windows/x86', ['./libTSCANAPI/windows/x86/binlog.dll', './libTSCANAPI/windows/x86/libLog.dll','./libTSCANAPI/windows/x86/libTSCAN.dll','./libTSCANAPI/windows/x86/libTSH.dll']),
      #   ('./libTSCANAPI/windows/x64', ['./libTSCANAPI/windows/x64/binlog.dll', './libTSCANAPI/windows/x64/libLog.dll','./libTSCANAPI/windows/x64/libTSCAN.dll','./libTSCANAPI/windows/x64/libTSH.dll']),
