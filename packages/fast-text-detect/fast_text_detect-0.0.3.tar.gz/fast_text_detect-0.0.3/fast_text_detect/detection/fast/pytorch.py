...
from fast_text_detect.textnet import textnet_base, textnet_small, textnet_tiny
from fast_text_detect.layers import FASTConvLayer
from fast_text_detect.utils import _bf16_to_float32, load_pretrained_params
...
default_cfgs: Dict[str, Dict[str, Any]] = {
    "fast_tiny": {
        ...
        "url": "https://github.com/gnana70/models/raw/main/fast_text_detection/fast_tiny-1acac421.pt",
    },
    "fast_small": {
        "input_shape": (3, 1024, 1024),
        "mean": (0.798, 0.785, 0.772),
        "std": (0.264, 0.2749, 0.287),
        "url": "https://github.com/gnana70/models/raw/main/fast_text_detection/fast_small-10952cc1.pt",
    },
    "fast_base": {
        "input_shape": (3, 1024, 1024),
        "mean": (0.798, 0.785, 0.772),
        "std": (0.264, 0.2749, 0.287),
        "url":  "https://github.com/gnana70/models/raw/main/fast_text_detection/fast_base-688a8b34.pt",
    },
}
