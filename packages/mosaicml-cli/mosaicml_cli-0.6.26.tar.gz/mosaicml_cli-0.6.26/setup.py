...
### MCLI is the interface for interacting with the Databricks Mosaic AI Training Platform
...
setup(
    ...
    description='Interact with the Databricks Mosaic AI training platform from python or a command line interface',
