...
function Vn(n) {
  ...
  return {
    c() {
      e = ye("svg"), l = ye("g"), t = ye("path"), i = ye("path"), Z(t, "d", "M18,6L6.087,17.913"), Y(t, "fill", "none"), Y(t, "fill-rule", "nonzero"), Y(t, "stroke-width", "2px"), Z(l, "transform", "matrix(1.14096,-0.140958,-0.140958,1.14096,-0.0559523,0.0559523)"), Z(i, "d", "M4.364,4.364L19.636,19.636"), Y(i, "fill", "none"), Y(i, "fill-rule", "nonzero"), Y(i, "stroke-width", "2px"), Z(e, "width", "100%"), Z(e, "height", "100%"), Z(e, "viewBox", "0 0 24 24"), Z(e, "version", "1.1"), Z(e, "xmlns", "http://www.w3.org/2000/svg"), Z(e, "xmlns:xlink", "http://www.w3.org/1999/xlink"), Z(e, "xml:space", "preserve"), Z(e, "stroke", "currentColor"), Y(e, "fill-rule", "evenodd"), Y(e, "clip-rule", "evenodd"), Y(e, "stroke-linecap", "round"), Y(e, "stroke-linejoin", "round");
    },
    m(f, o) {
...
let ol = Al ? () => window.performance.now() : () => Date.now(), El = Al ? (n) => requestAnimationFrame(n) : Ve;
...
function al(n, e = {}) {
  const l = Hn(n), { stiffness: t = 0.15, damping: i = 0.8, precision: f = 0.01 } = e;
...
function An(n) {
  ...
  return {
    ...
    m(d, m) {
      Pn(d, e, m), j(e, l), j(l, t), j(t, i), j(t, f), j(t, o), j(t, a), j(l, s), j(s, _), j(s, r), j(s, u), j(s, c);
    },
    p(d, [m]) {
      m & /*$top*/
...
class Tn extends In {
  constructor(e) {
    super(), jn(this, e, En, An, Bn, { margin: 0 });
  }
}
const {
  SvelteComponent: Xn,
...
function xn(n) {
  ...
  return {
    ...
    p(u, c) {
      ...
      2) && f !== (f = /*i18n*/
      u[1]("common.error") + "") && O(o, f), r && r.p && (!s || c[0] & /*$$scope*/
      536870912) && Ul(
        r,
        _,
        u,
...
function Li(n, e, l) {
  ...
  return n.$$set = (m) => {
    ...
    n.$$.dirty & /*value*/
    1 && console.log(i), n.$$.dirty & /*onlySelectLabelOnce, value*/
    3 && t && (console.log("OnlySelectLabelOnce"), l(8, u = new Set(i.map((m) => m.label))));
  }, [
    i,
    t,
    f,
...
const Ti = !0;
function Xi(n, e, l) {
  let { label: t = "Dropdown" } = e, { elem_id: i = "" } = e, { elem_classes: f = [] } = e, { visible: o = !0 } = e, { value: a } = e, { label_choices: s } = e, { text_column_width: _ } = e, { allow_duplicate_labels: r } = e, { unlabelled_value_display: u } = e, { text_column_header: c } = e, { label_column_header: d } = e, { show_label: m } = e, { scale: w = null } = e, { min_width: C = void 0 } = e, { loading_status: S } = e, { gradio: b } = e, { interactive: h } = e;
  function q() {
    b.dispatch("change");
  }
