...
class SimultaneousLoginV4(Operation):
    ...
    _url: str = "/iam/v4/oauth/simultaneousLogin"
    _path: str = "/iam/v4/oauth/simultaneousLogin"
    _base_path: str = ""
    _method: str = "POST"
    ...
    def with_simultaneous_platform(self, value: str) -> SimultaneousLoginV4:
        self.simultaneous_platform = value
        return self

    def with_simultaneous_ticket(self, value: str) -> SimultaneousLoginV4:
    ...
    def with_native_platform_ticket(self, value: str) -> SimultaneousLoginV4:
        self.native_platform_ticket = value
        return self

    def with_code_challenge(self, value: str) -> SimultaneousLoginV4:
