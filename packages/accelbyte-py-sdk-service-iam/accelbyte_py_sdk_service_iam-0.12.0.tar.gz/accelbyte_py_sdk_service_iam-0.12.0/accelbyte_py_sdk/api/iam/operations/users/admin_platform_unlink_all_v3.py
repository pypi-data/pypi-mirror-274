...
class AdminPlatformUnlinkAllV3(Operation):
    ...
    def with_namespace(self, value: str) -> AdminPlatformUnlinkAllV3:
        self.namespace = value
        return self

    def with_platform_id(self, value: str) -> AdminPlatformUnlinkAllV3:
        self.platform_id = value
        return self

    def with_user_id(self, value: str) -> AdminPlatformUnlinkAllV3:
        self.user_id = value
        return self
