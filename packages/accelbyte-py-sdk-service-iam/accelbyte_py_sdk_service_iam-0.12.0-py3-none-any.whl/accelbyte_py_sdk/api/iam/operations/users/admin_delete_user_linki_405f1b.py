...
class AdminDeleteUserLinkingHistoryByPlatformIDV3(Operation):
    ...
    def with_namespace(self, value: str) -> AdminDeleteUserLinkingHistoryByPlatformIDV3:
    ...
    def with_user_id(self, value: str) -> AdminDeleteUserLinkingHistoryByPlatformIDV3:
        self.user_id = value
        return self
