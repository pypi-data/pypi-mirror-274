...
class TestRunsStepsQuery(unittest.TestCase):
    """
    测试创建消息
    """
    def setUp(self):
    ...
    def test_runs_steps_query_must_params_right(self):
        """
        grade: p0
        description: must params right
        """
        runs_steps_query = appbuilder.assistant.threads.runs.steps.query(
            thread_id=self.thread_id,
            run_id=self.run_id,
            step_id="step-1"
        )
        self.assertEqual(runs_steps_query.thread_id, self.thread_id)
        self.assertEqual(runs_steps_query.run_id, self.run_id)
        self.assertEqual(runs_steps_query.id, "step-1")

    def test_runs_steps_query_step_id_err_id(self):
        """
        grade: p2
        description: step_id err step_id
        """
        runs_steps_query = appbuilder.assistant.threads.runs.steps.query(
            thread_id=self.thread_id,
            run_id=self.run_id,
        ...
        self.assertEqual(runs_steps_query.id, None)

    def test_runs_steps_query_thread_id_del(self):
        """
        grade: p2
        ...
        try:
            ...
            raise Exception("测试失败，thread_id del 查询run的指定step成功\n", print(runs_steps_query))

    def test_runs_steps_query_thread_id_None(self):
        """
        grade: p2
        ...
        try:
            ...
            raise Exception("测试失败，thread_id None 查询run的指定step成功\n", print(runs_steps_query))

    def test_runs_steps_query_thread_id_int_type(self):
        """
        grade: p2
        ...
        try:
            ...
            raise Exception("测试失败，thread_id int type 查询run的指定step成功\n", print(runs_steps_query))

    def test_runs_steps_query_thread_id_err_id(self):
        """
        grade: p2
        ...
        try:
            ...
            raise Exception("测试失败，thread_id err thread_id 查询run的指定step成功\n", print(runs_steps_query))

    def test_runs_steps_query_run_id_del(self):
        """
        grade: p2
        ...
        try:
            ...
            raise Exception("测试失败，run_id del 查询run的指定step成功\n", print(runs_steps_query))

    def test_runs_steps_query_run_id_None(self):
        """
        grade: p2
        ...
        try:
            ...
            raise Exception("测试失败，run_id None 查询run的指定step成功\n", print(runs_steps_query))

    def test_runs_steps_query_run_id_int_type(self):
        """
        grade: p2
        ...
        try:
            ...
            raise Exception("测试失败，run_id int type 查询run的指定step成功\n", print(runs_steps_query))

    def test_runs_steps_query_run_id_err_id(self):
        """
        grade: p2
        description: run_id err run_id
        """
        try:
            runs_steps_query = appbuilder.assistant.threads.runs.steps.query(
                thread_id=self.thread_id,
            ...
            raise Exception("测试失败，run_id err run_id 查询run的指定step成功\n", print(runs_steps_query))

    def test_runs_steps_query_step_id_del(self):
        """
        grade: p2
        description: step_id del
        """
        try:
            runs_steps_query = appbuilder.assistant.threads.runs.steps.query(
                thread_id=self.thread_id,
            ...
            self.assertIn("missing 1 required positional argument: 'step_id'", str(e))
        else:
            raise Exception("测试失败，step_id del 查询run的指定step成功\n", print(runs_steps_query))

    def test_runs_steps_query_step_id_None(self):
        """
        grade: p2
        description: step_id None
        """
        try:
            runs_steps_query = appbuilder.assistant.threads.runs.steps.query(
                thread_id=self.thread_id,
            ...
            raise Exception("测试失败，step_id None 查询run的指定step成功\n", print(runs_steps_query))

    def test_runs_steps_query_step_id_int_type(self):
        """
        grade: p2
        description: step_id int type
        """
        try:
            runs_steps_query = appbuilder.assistant.threads.runs.steps.query(
                thread_id=self.thread_id,
            ...
            raise Exception("测试失败，step_id int type 查询run的指定step成功\n", print(runs_steps_query))
