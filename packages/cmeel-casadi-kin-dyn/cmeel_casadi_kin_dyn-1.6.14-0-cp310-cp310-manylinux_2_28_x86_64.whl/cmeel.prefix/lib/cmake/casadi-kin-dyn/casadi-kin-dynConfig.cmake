...
if(NOT casadi-kin-dyn_FOUND)
  set(skip_this_file FALSE)
endif()
if(skip_this_file)
  foreach(component ${casadi-kin-dyn_FIND_COMPONENTS})
    if(NOT "casadi-kin-dyn_${component}_FOUND")
      set(skip_this_file FALSE)
    endif()
  endforeach()
endif()
...
set("casadi-kin-dyn_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("CASADI_KIN_DYN_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("casadi-kin-dyn_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/casadi-kin-dyn/doxygen-html")
set("CASADI_KIN_DYN_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/casadi-kin-dyn/doxygen-html")
set("casadi-kin-dyn_DEPENDENCIES" "")
set("casadi-kin-dyn_PKG_CONFIG_DEPENDENCIES" "")
...
set("_casadi-kin-dyn_PKG_CONFIG_LIBDIR" "${pcfiledir}/../../lib")
set("_casadi-kin-dyn_PKG_CONFIG_LIBS_LIST" "")
if(_casadi-kin-dyn_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_casadi-kin-dyn_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _casadi-kin-dyn_PKG_CONFIG_LIBS_LIST "${_casadi-kin-dyn_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_casadi-kin-dyn_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _casadi-kin-dyn_PKG_CONFIG_LIBS_LIST "${_casadi-kin-dyn_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_casadi-kin-dyn_PKG_CONFIG_LIBDIR})
  foreach(component ${_casadi-kin-dyn_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_casadi-kin-dyn_PKG_CONFIG_LIBS_LIST)

set("casadi-kin-dyn_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("CASADI_KIN_DYN_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${casadi-kin-dyn_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/casadi-kin-dynTargets.cmake")
...
foreach(component ${casadi-kin-dyn_FIND_COMPONENTS})
  ...
  if(EXISTS ${comp_file})
    ...
    set(casadi-kin-dyn_${component}_FOUND FALSE)
  endif()
  if(casadi-kin-dyn_${component}_FOUND)
    message(STATUS "casadi-kin-dyn: ${component} found.")
  else()
    if(casadi-kin-dyn_FIND_REQUIRED_${component})
      message(FATAL_ERROR "casadi-kin-dyn: ${component} not found.")
    else()
      message(STATUS "casadi-kin-dyn: ${component} not found.")
    endif()
  endif()
endforeach()
check_required_components("casadi-kin-dyn")
