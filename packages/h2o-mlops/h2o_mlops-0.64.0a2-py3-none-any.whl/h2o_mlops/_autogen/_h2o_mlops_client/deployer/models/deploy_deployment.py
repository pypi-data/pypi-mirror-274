...
class DeployDeployment(object):
    ...
    attribute_map = {
        ...
        'user_info': 'userInfo',
        'monitor_disable': 'monitorDisable'
    }

    def __init__(self, id=None, project_id=None, deployment_environment_id=None, created_time=None, last_modified_time=None, single_deployment=None, shadow_deployment=None, split_deployment=None, security=None, display_name=None, description=None, revision_id=None, revision_create_time=None, user_info=None, monitor_disable=None, local_vars_configuration=None):  # noqa: E501
        ...
        if monitor_disable is not None:
            self.monitor_disable = monitor_disable
    ...
    def monitor_disable(self):
        """Gets the monitor_disable of this DeployDeployment.  # noqa: E501

        Disable monitor proxy or not. If not set, default is false.  # noqa: E501

        :return: The monitor_disable of this DeployDeployment.  # noqa: E501
        :rtype: bool
        """
        return self._monitor_disable

    @monitor_disable.setter
    def monitor_disable(self, monitor_disable):
        """Sets the monitor_disable of this DeployDeployment.

        Disable monitor proxy or not. If not set, default is false.  # noqa: E501

        :param monitor_disable: The monitor_disable of this DeployDeployment.  # noqa: E501
        :type monitor_disable: bool
        """

        self._monitor_disable = monitor_disable
