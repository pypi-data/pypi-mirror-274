...
"""
    ...
    The version of the OpenAPI document: 0.19.135
...
class AppApp(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cloud_platform", "created_at", "created_by", "created_by_id", "description", "id", "input_config", "name", "org_id", "runner_config", "sandbox_config", "status", "status_description", "updated_at"]
