...
"""
    ...
    The version of the OpenAPI document: 0.19.137
...
class AppInstallerMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["community_url", "copyright_markdown", "created_at", "created_by", "created_by_id", "demo_url", "description", "documentation_url", "favicon_url", "footer_markdown", "formatted_demo_url", "github_url", "homepage_url", "id", "installer_id", "logo_url", "name", "post_install_markdown", "updated_at"]
