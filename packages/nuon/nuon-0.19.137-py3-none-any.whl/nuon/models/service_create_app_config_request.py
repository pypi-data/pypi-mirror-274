...
class ServiceCreateAppConfigRequest(BaseModel):
    ...
    generated_terraform_json: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["content", "generated_terraform_json"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "generated_terraform_json": obj.get("generated_terraform_json")
        })
        return _obj
