...
def create_app():
    ...
    try:
        with tracer.start_as_current_span("create_app"):
            ...
            client_secret = obj_key_vault_interactive.get_secret(az_sub_client_secret_key)
            ...
            if not client_secret:
                raise ValueError(f"client_secret:{az_sub_client_secret_key} is empty or has a length of 0")
