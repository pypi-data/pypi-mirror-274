...
from trainerbase.memory import POINTER_SIZE, Address, allocate, pm
...
class ASMArrayManager(Sequence):
    ...
    def __getitem__(self, index: int) -> Address:  # type: ignore TODO: Support slices
    ...
    def generate_asm_append_code(self, from_register: str) -> str:
        ...
        # But it was decided that using a new register would make the code even less clea
