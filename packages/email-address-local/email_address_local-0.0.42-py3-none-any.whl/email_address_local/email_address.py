...
class EmailAddressesLocal(GenericMapping, metaclass=MetaLogger, object=object1):
    ...
    def insert(self, email_address: str, lang_code: LangCode, name: str) -> int or None:
        ...
        data_dict = {EMAIL_ADDRESS_COLUMN_NAME: email_address}
    ...
    def update_email_address(self, email_address_id: int, new_email: str) -> None:
        self.update_by_column_and_value(column_value=email_address_id, data_dict={EMAIL_ADDRESS_COLUMN_NAME: new_email})
    ...
    def get_email_address_id_by_email_address(self, email_address: str) -> int:
        ...
        email_address_id = self.select_one_value_by_column_and_value(
            column_name=EMAIL_ADDRESS_COLUMN_NAME, column_value=email_address,
    ...
    def process_email(self, contact_id: int, email_address: str) -> int or dict:
        """
        ...
        email_address_id = self.get_email_address_id_by_email_address(email_address=email_address)
        if email_address_id:  # email is in the system
            ...
            if contact_email_address_mapping_result:  # email is mapped to contact
                ...
                self.update_by_column_and_value(
                    ...
                    column_value=email_address, data_dict=data_dict)
