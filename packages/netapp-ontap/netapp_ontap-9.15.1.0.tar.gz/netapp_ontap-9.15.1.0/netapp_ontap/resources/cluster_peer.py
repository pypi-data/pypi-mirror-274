...
* [`DOC /cluster/peers`](#docs-cluster-cluster_peers)"""
    ...
    if RECLINE_INSTALLED:
        ...
        def cluster_peer_show(
            fields: List[Choices.define(["ip_address", "name", "peer_applications", "uuid", "*"])]=None,
        ) -> ResourceTable:
            """Fetch a list of ClusterPeer resources

            Args:
                ip_address: A local intercluster IP address that a remote cluster can use, together with the passphrase, to create a cluster peer relationship with the local cluster.
                name: Optional name for the cluster peer relationship. By default, it is the name of the remote cluster, or a temporary name might be autogenerated for anonymous cluster peer offers.
...
* [`DOC /cluster/peers`](#docs-cluster-cluster_peers)"""
    ...
    if RECLINE_INSTALLED:
        ...
        async def cluster_peer_modify(
            ...
            Args:
                ip_address: A local intercluster IP address that a remote cluster can use, together with the passphrase, to create a cluster peer relationship with the local cluster.
                query_ip_address: A local intercluster IP address that a remote cluster can use, together with the passphrase, to create a cluster peer relationship with the local cluster.
                name: Optional name for the cluster peer relationship. By default, it is the name of the remote cluster, or a temporary name might be autogenerated for anonymous cluster peer offers.
                query_name: Optional name for the cluster peer relationship. By default, it is the name of the remote cluster, or a temporary name might be autogenerated for anonymous cluster peer offers.
                peer_applications: Peering applications against which allowed SVMs are configured.
            ...
            kwargs = {}
            changes = {}
            if query_ip_address is not None:
                kwargs["ip_address"] = query_ip_address
