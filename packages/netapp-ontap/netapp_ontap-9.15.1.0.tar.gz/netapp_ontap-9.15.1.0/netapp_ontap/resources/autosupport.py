...
* https"""
    ...
    """contact_support,enabled,from_,is_minimal,issues,mail_hosts,partner_addresses,proxy_url,smtp_encryption,to,transport,"""
    ...
    """contact_support,enabled,from_,is_minimal,mail_hosts,partner_addresses,proxy_url,smtp_encryption,to,transport,"""
    ...
    if RECLINE_INSTALLED:
        ...
        def autosupport_show(
            ...
            Args:
                ...
                smtp_encryption: The encryption protocol used to deliver AutoSupport messages via SMTP to the configured mail_hosts. 
            ...
            if smtp_encryption is not None:
                kwargs["smtp_encryption"] = smtp_encryption
            if to is not None:
                kwargs["to"] = to
    ...
    if RECLINE_INSTALLED:
        ...
        async def autosupport_modify(
            ...
            Args:
                ...
                smtp_encryption: The encryption protocol used to deliver AutoSupport messages via SMTP to the configured mail_hosts. 
                query_smtp_encryption: The encryption protocol used to deliver AutoSupport messages via SMTP to the configured mail_hosts. 
                to: The e-mail addresses to which the AutoSupport messages are sent.
            ...
            if query_smtp_encryption is not None:
                kwargs["smtp_encryption"] = query_smtp_encryption
            ...
            if smtp_encryption is not None:
                changes["smtp_encryption"] = smtp_encryption
            if to is not None:
                changes["to"] = to
            if transport is not None:
