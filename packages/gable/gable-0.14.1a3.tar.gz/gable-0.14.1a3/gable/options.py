...
def typescript_project_options(
    ...
    def decorator(func):
        ...
        @optgroup.option(
            "--event-name-key",
            help="Name of the event property that contains the event name. Either this option, or the --event-name-parameter option must be provided when using --emitter-function.",
            type=str,
        )
        @functools.wraps(func)
        def wrapper(*args, **kwargs):
...
def s3_project_options(
    ...
    def decorator(func):
        ...
        @optgroup.option(
            ...
            type=int,
            default=0,
            help="""number of days to look back from the latest day in the list of paths. For example
        ...
        @optgroup.option(
            "--history",
            help="This optional parameter allows you to do a historical analysis of between 2 dates.",
            type=bool,
            is_flag=True,
            default=False,
        )
