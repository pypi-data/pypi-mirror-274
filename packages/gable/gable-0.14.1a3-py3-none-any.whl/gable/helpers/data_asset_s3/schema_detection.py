...
class S3DetectionResult:
    schema: dict
    data_profile_map: Optional[DataProfileFieldsMapping]
...
def check_compliance_s3_data_assets(
    ...
    pattern_to_result = detect_s3_data_assets(bucket, lookback_days, include)
...
def get_merged_def_from_s3_files(
    bucket: str, event_name: str, s3_urls: set[str]
