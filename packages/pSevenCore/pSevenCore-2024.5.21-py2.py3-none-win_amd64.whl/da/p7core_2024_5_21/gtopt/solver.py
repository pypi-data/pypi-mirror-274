...
class Solver(object):
  ...
  def _run_solver(self, problem, mode, **kwargs):
    ...
    try:
      ...
      self._test_categorical_only_problem(problem, doe_mode)
  ...
  def _read_categorical_combinations(self, problem):
  ...
  def _test_categorical_only_problem(self, problem, doe_mode):
    n_combinations, n_infinite = 1, _numpy.iinfo(int).max
