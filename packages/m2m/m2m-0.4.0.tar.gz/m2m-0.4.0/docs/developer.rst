...
.. warning::
   ...
   `m2m` package. If you just want to write code that uses it
...
In your terminal, change to the directory where you cloned `m2m`, and type::

    conda env create -f environment.yml

This will create a conda virtual environment called `m2m-dev` with all
the M2M Daemons dependencies and a few useful packages for development and
interaction.
...
* On Windows, in your Anaconda Prompt, run ``activate m2m-dev``
* On MacOSX and Linux, in your Terminal, run ``source activate m2m-dev``
...
type::
    ...
    conda list -n m2m-dev

If later you want to leave the `m2m-dev` virtual environment:
...
then on, all the M2M Daemons binaries and the library itself will be
...
.. _available on GitHub: https://gitlab.com/jdhp/sensors-m2m-daemons
...
.. _TODO.md: https://gitlab.com/jdhp/sensors-m2m-daemons/blob/master/TODO.md
