...
class CartpoleTeacher(CoordinatedGoal):
    def __init__(self):
        pole_goal = MaintainGoal("pole_theta", "Maintain pole to upright", target=0, stop_distance=0.418)
        cart_goal = MaintainGoal("cart_pos", "Maintain cart to center", target=0, stop_distance=2.4)
