...
class MetadataServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Health = channel.unary_unary(
                '/api.v1.MetadataService/Health',
                request_serializer=api_dot_v1_dot_service__pb2.HealthRequest.SerializeToString,
...
def add_MetadataServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Health': grpc.unary_unary_rpc_method_handler(
                    servicer.Health,
                    request_deserializer=api_dot_v1_dot_service__pb2.HealthRequest.FromString,
                    response_serializer=common_dot_v1_dot_health__pb2.HealthResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'api.v1.MetadataService', rpc_method_handlers)
...
class MetadataService(object):
    ...
    def Health(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/api.v1.MetadataService/Health',
            api_dot_v1_dot_service__pb2.HealthRequest.SerializeToString,
...
class DeprecatedServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.Workflow = channel.unary_unary(
                '/api.v1.DeprecatedService/Workflow',
                request_serializer=api_dot_v1_dot_service__pb2.ExecuteRequest.SerializeToString,
                response_deserializer=api_dot_v1_dot_service__pb2.WorkflowResponse.FromString,
                _registered_method=True)
...
def add_DeprecatedServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Workflow': grpc.unary_unary_rpc_method_handler(
                    servicer.Workflow,
                    request_deserializer=api_dot_v1_dot_service__pb2.ExecuteRequest.FromString,
                    response_serializer=api_dot_v1_dot_service__pb2.WorkflowResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'api.v1.DeprecatedService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class DeprecatedService(object):
    ...
    def Workflow(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            api_dot_v1_dot_service__pb2.WorkflowResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
