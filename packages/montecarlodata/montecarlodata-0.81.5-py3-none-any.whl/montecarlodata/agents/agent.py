        ...
        events = [
            {
                ...
                "commands": event.payload.get("commands") if event.payload else {},
                "operation_name": event.payload.get("operation_name")
                if event.payload
                else None,
                "trace_id": event.payload.get("trace_id") if event.payload else None,
            }
