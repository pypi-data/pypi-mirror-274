...
class Multiple:
    ...
    def __init__(self, data: pd.DataFrame, additional_ops: dict = {}, lang = 'eng'):
        ...
        while i < len(self.data):
            ...
            try:
                rules = self.rules if lang == 'eng' else self.reglas if lang == 'esp' else ''
            except Exception:
                rules = {}
            ...
            fi_instance = FixedIncome(settlement_date = self.settlementDate if lang == 'eng' else self.fechaLiquidacion if lang == 'esp' else '', 
                                      ...
                                      face_value = self.facialValue if lang == 'eng' else self.monto if lang == 'esp' else '', 
