...
def interactive_add(
    ...
    execution_context: str | int | None = None,
    undo: bool | None = None,
    primitive_type: str | int | None = "CUBE",
    plane_origin_base: str | int | None = "EDGE",
    plane_origin_depth: str | int | None = "EDGE",
    plane_aspect_base: str | int | None = "FREE",
    plane_aspect_depth: str | int | None = "FREE",
    wait_for_input: bool | typing.Any | None = True,
):
    """Interactively add an object
        ...
        :type primitive_type: str | int | None
    ...
    Center -- Start placing the center position.
        :type plane_origin_base: str | int | None
    ...
    CENTER
    Center -- Start placing the center position.
        :type plane_origin_depth: str | int | None
    ...
    Fixed -- Use a fixed 1:1 aspect.
        :type plane_aspect_base: str | int | None
    ...
    FIXED
    Fixed -- Use a fixed 1:1 aspect.
        :type plane_aspect_depth: str | int | None
        :param wait_for_input: Wait for Input
        :type wait_for_input: bool | typing.Any | None
    """
...
def transform_gizmo_set(
    ...
    :type extend: bool | typing.Any | None
    :param type: Type
    :type type: set[str] | set[int] | None
    """
