...
def align(
    ...
    align_mode: typing.Any | None = "OPT_2",
    relative_to: typing.Any | None = "OPT_4",
    align_axis: typing.Any | None = {},
):
    """Align objects
        ...
        :type align_mode: typing.Any | None
    ...
    Active -- Use the active object as the position for the selected objects to align to.
        :type relative_to: typing.Any | None
        :param align_axis: Align, Align to axis
        :type align_axis: typing.Any | None
    """
...
def gpencil_add(
    ...
    stroke_depth_order: typing.Any | None = "3D",
):
    ...
    3D Location -- Display strokes using real 3D position in 3D space.
        :type stroke_depth_order: typing.Any | None
    """
...
def hook_assign(
    ...
    execution_context: str | int | None = None,
    undo: bool | None = None,
    modifier: str | int | typing.Any | None = "",
):
    ...
    :type modifier: str | int | typing.Any | None
    """
...
def light_linking_blockers_link(
    ...
    execution_context: str | int | None = None,
    undo: bool | None = None,
    link_state: typing.Any | None = "INCLUDE",
):
    ...
    Exclude -- Exclude selected blockers from casting shadows from the active emitter.
        :type link_state: typing.Any | None
    """
...
def lightprobe_cache_free(
    ...
    execution_context: str | int | None = None,
    undo: bool | None = None,
    subset: typing.Any | None = "SELECTED",
):
...
def make_local(
    ...
    execution_context: str | int | None = None,
    undo: bool | None = None,
    type: typing.Any | None = "SELECT_OBJECT",
):
...
def make_single_user(
    ...
    execution_context: str | int | None = None,
    undo: bool | None = None,
    type: typing.Any | None = "SELECTED_OBJECTS",
...
def multires_subdivide(
    ...
    undo: bool | None = None,
    modifier: str | typing.Any = "",
    mode: typing.Any | None = "CATMULL_CLARK",
):
...
def origin_set(
    ...
    execution_context: str | int | None = None,
    undo: bool | None = None,
    type: typing.Any | None = "GEOMETRY_ORIGIN",
    center: typing.Any | None = "MEDIAN",
):
...
def quick_fur(
    ...
    execution_context: str | int | None = None,
    undo: bool | None = None,
    density: typing.Any | None = "MEDIUM",
...
def select_grouped(
    ...
    undo: bool | None = None,
    extend: bool | typing.Any | None = False,
    type: typing.Any | None = "CHILDREN_RECURSIVE",
):
...
def track_set(
    ...
    execution_context: str | int | None = None,
    undo: bool | None = None,
    type: typing.Any | None = "DAMPTRACK",
):
...
def vertex_group_clean(
    ...
    execution_context: str | int | None = None,
    undo: bool | None = None,
    group_select_mode: str | int | typing.Any | None = "",
    ...
    :type group_select_mode: str | int | typing.Any | None
...
def vertex_group_set_active(
    ...
    :type group: str | int | typing.Any | None
    """
...
def vertex_group_sort(
    ...
    execution_context: str | int | None = None,
    undo: bool | None = None,
    sort_type: typing.Any | None = "NAME",
):
    """Sort vertex groups
    ...
    :type sort_type: typing.Any | None
    """
