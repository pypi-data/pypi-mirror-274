...
T = TypeVar("T", bound="GetAssetAdministrationShellDescriptorByIdAasIdentifier")


@_attrs_define
class GetAssetAdministrationShellDescriptorByIdAasIdentifier:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_asset_administration_shell_descriptor_by_id_aas_identifier = cls(
            short=short,
            char=char,
            int_=int_,
            long=long,
        ...
        get_asset_administration_shell_descriptor_by_id_aas_identifier.additional_properties = d
        return get_asset_administration_shell_descriptor_by_id_aas_identifier
