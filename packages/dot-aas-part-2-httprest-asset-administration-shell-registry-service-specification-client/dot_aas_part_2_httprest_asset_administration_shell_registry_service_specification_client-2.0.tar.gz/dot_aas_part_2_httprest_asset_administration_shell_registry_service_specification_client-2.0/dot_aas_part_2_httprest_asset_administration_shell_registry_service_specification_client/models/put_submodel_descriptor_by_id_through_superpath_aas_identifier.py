...
T = TypeVar("T", bound="PutSubmodelDescriptorByIdThroughSuperpathAasIdentifier")


@_attrs_define
class PutSubmodelDescriptorByIdThroughSuperpathAasIdentifier:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_submodel_descriptor_by_id_through_superpath_aas_identifier = cls(
            short=short,
            char=char,
            int_=int_,
            long=long,
        ...
        put_submodel_descriptor_by_id_through_superpath_aas_identifier.additional_properties = d
        return put_submodel_descriptor_by_id_through_superpath_aas_identifier
