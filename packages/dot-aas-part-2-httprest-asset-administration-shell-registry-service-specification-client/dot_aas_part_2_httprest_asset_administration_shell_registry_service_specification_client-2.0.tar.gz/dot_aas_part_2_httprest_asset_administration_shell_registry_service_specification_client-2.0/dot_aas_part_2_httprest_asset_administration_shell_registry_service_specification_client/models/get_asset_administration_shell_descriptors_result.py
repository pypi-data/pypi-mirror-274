...
T = TypeVar("T", bound="GetAssetAdministrationShellDescriptorsResult")


@_attrs_define
class GetAssetAdministrationShellDescriptorsResult:
    """
    Attributes:
        paging_metadata (Union[Unset, PagedResultPagingMetadata]):
        result (Union[Unset, List['AssetAdministrationShellDescriptor']]):
    """

    paging_metadata: Union[Unset, "PagedResultPagingMetadata"] = UNSET
    result: Union[Unset, List["AssetAdministrationShellDescriptor"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for result_item_data in _result or []:
            result_item = AssetAdministrationShellDescriptor.from_dict(result_item_data)

            result.append(result_item)

        get_asset_administration_shell_descriptors_result = cls(
            paging_metadata=paging_metadata,
            result=result,
        )

        get_asset_administration_shell_descriptors_result.additional_properties = d
        return get_asset_administration_shell_descriptors_result
