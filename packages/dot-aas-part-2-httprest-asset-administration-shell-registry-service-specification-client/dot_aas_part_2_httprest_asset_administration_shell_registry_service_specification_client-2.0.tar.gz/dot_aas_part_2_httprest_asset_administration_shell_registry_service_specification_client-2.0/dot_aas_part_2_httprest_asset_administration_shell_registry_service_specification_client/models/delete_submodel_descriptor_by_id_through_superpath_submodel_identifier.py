...
T = TypeVar("T", bound="DeleteSubmodelDescriptorByIdThroughSuperpathSubmodelIdentifier")


@_attrs_define
class DeleteSubmodelDescriptorByIdThroughSuperpathSubmodelIdentifier:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_submodel_descriptor_by_id_through_superpath_submodel_identifier = cls(
            short=short,
            char=char,
            int_=int_,
            long=long,
        ...
        delete_submodel_descriptor_by_id_through_superpath_submodel_identifier.additional_properties = d
        return delete_submodel_descriptor_by_id_through_superpath_submodel_identifier
