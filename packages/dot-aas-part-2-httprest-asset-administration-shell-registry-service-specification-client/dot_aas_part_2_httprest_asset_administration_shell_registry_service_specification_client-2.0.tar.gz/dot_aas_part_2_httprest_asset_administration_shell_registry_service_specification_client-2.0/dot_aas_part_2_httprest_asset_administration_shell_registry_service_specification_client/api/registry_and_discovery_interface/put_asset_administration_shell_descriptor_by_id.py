...
from ...models.put_asset_administration_shell_descriptor_by_id_aas_identifier import (
...
def _get_kwargs(
    aas_identifier: "PutAssetAdministrationShellDescriptorByIdAasIdentifier",
    *,
