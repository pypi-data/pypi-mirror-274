...
T = TypeVar("T", bound="GetAllSubmodelDescriptorsThroughSuperpathAasIdentifier")


@_attrs_define
class GetAllSubmodelDescriptorsThroughSuperpathAasIdentifier:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_all_submodel_descriptors_through_superpath_aas_identifier = cls(
            short=short,
            char=char,
            int_=int_,
            long=long,
        ...
        get_all_submodel_descriptors_through_superpath_aas_identifier.additional_properties = d
        return get_all_submodel_descriptors_through_superpath_aas_identifier
