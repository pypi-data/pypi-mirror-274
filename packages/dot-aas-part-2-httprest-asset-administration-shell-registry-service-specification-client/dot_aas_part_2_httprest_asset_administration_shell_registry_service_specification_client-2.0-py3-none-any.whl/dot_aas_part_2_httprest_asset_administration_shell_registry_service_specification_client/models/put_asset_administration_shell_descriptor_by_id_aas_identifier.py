...
T = TypeVar("T", bound="PutAssetAdministrationShellDescriptorByIdAasIdentifier")


@_attrs_define
class PutAssetAdministrationShellDescriptorByIdAasIdentifier:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_asset_administration_shell_descriptor_by_id_aas_identifier = cls(
            short=short,
            char=char,
            int_=int_,
            long=long,
        ...
        put_asset_administration_shell_descriptor_by_id_aas_identifier.additional_properties = d
        return put_asset_administration_shell_descriptor_by_id_aas_identifier
