...
T = TypeVar("T", bound="PostSubmodelDescriptorThroughSuperpathAasIdentifier")


@_attrs_define
class PostSubmodelDescriptorThroughSuperpathAasIdentifier:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_submodel_descriptor_through_superpath_aas_identifier = cls(
            short=short,
            char=char,
            int_=int_,
            long=long,
        ...
        post_submodel_descriptor_through_superpath_aas_identifier.additional_properties = d
        return post_submodel_descriptor_through_superpath_aas_identifier
