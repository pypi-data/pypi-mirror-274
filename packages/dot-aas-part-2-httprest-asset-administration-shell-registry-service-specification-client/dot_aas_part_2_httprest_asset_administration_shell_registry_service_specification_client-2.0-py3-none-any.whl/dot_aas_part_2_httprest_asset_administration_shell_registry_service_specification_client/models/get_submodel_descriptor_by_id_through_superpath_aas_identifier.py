...
T = TypeVar("T", bound="GetSubmodelDescriptorByIdThroughSuperpathAasIdentifier")


@_attrs_define
class GetSubmodelDescriptorByIdThroughSuperpathAasIdentifier:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_submodel_descriptor_by_id_through_superpath_aas_identifier = cls(
            short=short,
            char=char,
            int_=int_,
            long=long,
        ...
        get_submodel_descriptor_by_id_through_superpath_aas_identifier.additional_properties = d
        return get_submodel_descriptor_by_id_through_superpath_aas_identifier
