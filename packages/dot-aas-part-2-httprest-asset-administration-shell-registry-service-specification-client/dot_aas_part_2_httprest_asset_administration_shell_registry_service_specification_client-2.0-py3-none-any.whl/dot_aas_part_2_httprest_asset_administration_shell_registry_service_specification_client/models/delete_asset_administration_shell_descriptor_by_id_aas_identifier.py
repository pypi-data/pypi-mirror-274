...
T = TypeVar("T", bound="DeleteAssetAdministrationShellDescriptorByIdAasIdentifier")


@_attrs_define
class DeleteAssetAdministrationShellDescriptorByIdAasIdentifier:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_asset_administration_shell_descriptor_by_id_aas_identifier = cls(
            short=short,
            char=char,
            int_=int_,
            long=long,
        ...
        delete_asset_administration_shell_descriptor_by_id_aas_identifier.additional_properties = d
        return delete_asset_administration_shell_descriptor_by_id_aas_identifier
