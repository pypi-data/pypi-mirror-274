...
from ...models.delete_submodel_descriptor_by_id_through_superpath_aas_identifier import (
    DeleteSubmodelDescriptorByIdThroughSuperpathAasIdentifier,
)
from ...models.delete_submodel_descriptor_by_id_through_superpath_submodel_identifier import (
...
def _get_kwargs(
    aas_identifier: "DeleteSubmodelDescriptorByIdThroughSuperpathAasIdentifier",
    submodel_identifier: "DeleteSubmodelDescriptorByIdThroughSuperpathSubmodelIdentifier",
) -> Dict[str, Any]:
