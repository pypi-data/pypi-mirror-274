...
class tree_set:
    ...
    def plot_2D(
        ...
        if method == "pcoa":
            if name_plot == None:
                name_plot = f"./{os.path.splitext(os.path.basename(self.file))[0]}_PCOA_2D"
            ...
            if name_plot == None:
                name_plot = f"./{os.path.splitext(os.path.basename(self.file))[0]}_TSNE_2D"
            ...
            if name_plot == None:
                name_plot = f"./{os.path.splitext(os.path.basename(self.file))[0]}_ISOMAP_2D"
    ...
    def plot_3D(
        ...
        if method == "pcoa":
            if name_plot == None:
                name_plot = f"./{os.path.splitext(os.path.basename(self.file))[0]}_PCOA_3D"
            ...
            if name_plot == None:
                name_plot = f"./{os.path.splitext(os.path.basename(self.file))[0]}_TSNE_3D"
            ...
            if name_plot == None:
                name_plot = f"./{os.path.splitext(os.path.basename(self.file))[0]}_ISOMAP_3D"
...
class set_collection(tree_set):
    ...
    def calculate_distances(self, method):
        ...
        if method in ("hashrf_RF", "hashrf_wRF", "smart_RF", "tqdist_quartet", "tqdist_triplet"):
            with open(self.file, "w") as trees:
                for set in self.collection:
