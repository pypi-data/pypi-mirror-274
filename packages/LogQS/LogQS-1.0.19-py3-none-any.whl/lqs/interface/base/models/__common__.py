...
def big_int_wrap(v: Any, nxt: SerializerFunctionWrapHandler) -> Union[str, int]:
    # add custom logic once this feature-request is implemented https://github.com/pydantic/pydantic/issues/7143
    return nxt(v)
