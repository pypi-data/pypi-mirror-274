...
class PrintUtils:
    ...
    INSTALL_WELCOME_MESSAGE = (
        Style.BRIGHT
        + Fore.LIGHTBLUE_EX
        + "\n*~ Welcome to cherrygpt installation wizard ~*\n"
        + Style.RESET_ALL
        + """
Please note that you need to have an OpenAI account and an API key to use cherrygpt.
...
"""
        ...
        + Fore.LIGHTBLUE_EX
        + """
Let's install the OpenAI API key, so you can use cherrygpt.
"""
    )
...
"""
    ...
    INSTALL_SUCCESS_MESSAGE = (
        ...
        + Fore.GREEN
        + f"""
Great news! You're all set up to use cherrygpt!

Your cherrygpt files are all saved at {config.BASE_PATH}.
To start chatting with me, just type '{config.APP_NAME}' into your terminal and let the fun begin!

Thanks for choosing cherrygpt - the coolest personal assistant on the block.
Let's get our programming on!"""
    ...
    INSTALL_SMALL_PRINTS = (
        """
Just a reminder that cherrygpt is a free and open source project.
So if you ever feel like contributing or checking out the inner workings of the program,
feel free to head on over to https://github.com/adamyodinsky/cherrygpt
