...
class ens_calculator:
    ...
    def area(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_agradofvelmag(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_cfedge(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], viscosity: Union['ENS_VAR', str, int, 'float'], ymax: float, flow_dir_comp: int = 0, opt_for_a_gradient_of_velo_mag: Optional[Union['ENS_VAR', str, int]] = None, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_cfwall(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], viscosity: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_velocity_mag: Union['ENS_VAR', str, int, 'float'], opt_for_a_gradient_of_velo_mag: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_cfwallcmp(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], viscosity: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_velocity_mag: Union['ENS_VAR', str, int, 'float'], ymax: float, tangent_flow_comp: int = 1, opt_for_a_gradient_of_velo_mag: Optional[Union['ENS_VAR', str, int]] = None, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_cfwalltau(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], viscosity: Union['ENS_VAR', str, int, 'float'], ymax: float, wall_shear_stress_opt: int = 0, opt_for_a_gradient_of_velo_mag: Optional[Union['ENS_VAR', str, int]] = None, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_dispthick(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], ymax: float, flow_dir_comp: int, opt_for_a_gradient_of_velo_mag: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_disttovalue(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar: Union['ENS_VAR', str, int], scalar_value: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_momethick(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], ymax: float, flow_dir_i_comp: int, flow_dir_j_comp: int, opt_for_a_gradient_of_velo_mag: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_scalar(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], scalar: Union['ENS_VAR', str, int], ymax: float, opt_for_a_gradient_of_velo_mag: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_recoverythick(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], total_pressure: Union['ENS_VAR', str, int], ymax: float, opt_for_a_gradient_of_velo_mag: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_thick(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], ymax: float, opt_for_a_gradient_of_velo_mag: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_velocityatedge(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], ymax: float, edge_vector_option: int = 0, opt_for_a_gradient_of_velo_mag: Optional[Union['ENS_VAR', str, int]] = None, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_y1plus(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], viscosity: Union['ENS_VAR', str, int, 'float'], gradient_option: int = 0, vector_variable: Optional[Union['ENS_VAR', str, int]] = None, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def bl_y1plusdist(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def casemap(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], case_number_to_map_from: int, variable: Union['ENS_VAR', str, int], parts_to_map_from: int = 0, search_option: int = 0, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def casemapdiff(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], case_number_to_map_from: int, variable: Union['ENS_VAR', str, int], parts_to_map_from: int = 0, search_option: int = 0, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def coeff(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar: Union['ENS_VAR', str, int], component: str = '[X]', result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def cmplx(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar_or_vector: Union['ENS_VAR', str, int], frequency: float, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def cmplxarg(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar_or_vector: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def cmplxconj(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar_or_vector: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def cmplximag(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar_or_vector: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def cmplxmodu(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar_or_vector: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def cmplxreal(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar_or_vector: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def cmplxtransresp(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar_or_vector: Union['ENS_VAR', str, int], phi: float, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def constantperpart(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], constant: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def curl(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], vector: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def defect_bulkvolume(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def defect_count(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], Defect_scalar_per_element: Union['ENS_VAR', str, int], min_constant: Union['ENS_VAR', str, int, 'float'], max_constant: Union['ENS_VAR', str, int, 'float'], result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def defect_largestlinearextent(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def defect_netvolume(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar_per_element_variable: Union['ENS_VAR', str, int, 'float'], scale_factor: float, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def defect_shapefactor(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def defect_surfacearea(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def density(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], pressure: Union['ENS_VAR', str, int], temperature: Union['ENS_VAR', str, int], gas_constant: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def densitylognorm(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def densitynorm(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def densitynormstag(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], free_velocity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def densitystag(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def dist2nodes(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], number: int, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def dist2part(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], origin_part_number: int, optional_origin_part_normal: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def dist2partelem(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], origin_part_number: int, optional_origin_part_normal: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def div(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], vector: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def elemetric(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], metric_function: int = 0, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def elemtonode(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], elemental_scalar_or_vector: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def elemtonodeweighted(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], elemental_scalar_or_vector: Union['ENS_VAR', str, int], elemental_scalar: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def elesize(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def energyt(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], pressure: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def enthalpy(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def enthalpynorm(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def enthalpynormstag(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], free_velocity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def enthalpystag(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def entropy(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], gas: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def flow(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def flowrate(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def fluidshear(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity_magnitude_gradient: Union['ENS_VAR', str, int], viscosity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def fluidshearmax(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], turb_kinetic_energy: Union['ENS_VAR', str, int], turb_dissipation: Union['ENS_VAR', str, int], laminar_viscosity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def force(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], pressure: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def force1d(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], pressure: Union['ENS_VAR', str, int], surface_normal: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def grad(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar_or_vector: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def gradtensor(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], vector: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def helicitydensity(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def helicityrelative(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def helicityrelfilter(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], free_velocity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def iblankingvalues(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def ijkvalues(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def integralline(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], variable: Union['ENS_VAR', str, int], component: str = '[X]', result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def integralsurface(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], variable: Union['ENS_VAR', str, int], component: str = '[X]', result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def integralvolume(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], variable: Union['ENS_VAR', str, int], component: str = '[X]', result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def kinen(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def length(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def linevectors(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def mach(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def makescalelem(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], constant: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def makescalelemid(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def makescalnode(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], constant: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def makescalnodeid(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def makevect(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def massfluxavg(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def matspecies(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar_per_elem: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def mattoscalar(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def max(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], variable: Union['ENS_VAR', str, int], component: str = '[X]', result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def min(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], variable: Union['ENS_VAR', str, int], component: str = '[X]', result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def moment(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], vector: Union['ENS_VAR', str, int], component: str = '[X]', result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def momentum(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def momentvector(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], force: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def nodecount(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def nodetoelem(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], nodal_scalar_or_vector: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def normal(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def normvect(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], vector: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def normc(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], pressure: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], viscosity: Union['ENS_VAR', str, int, 'float'], result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def offsetfield(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def offsetvar(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar_or_vector: Union['ENS_VAR', str, int], offset: float, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def partnumber(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def pres(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def prescoef(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], free_velocity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def presdynam(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], velocity: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def preslognorm(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def presnorm(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def presnormstag(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], free_velocity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def prespitot(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def prespitotratio(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def presstag(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def presstagcoef(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], free_velocity: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def prest(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], pressure: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def radiograph_grid(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], dir_X: float, dir_Y: float, dir_Z: float, num_points: int, variable: Union['ENS_VAR', str, int], component: str = '[X]', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def radiograph_mesh(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], dir_X: float, dir_Y: float, dir_Z: float, variable: Union['ENS_VAR', str, int], component: str = '[X]', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def recttocyl(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], vector: Union['ENS_VAR', str, int], frame_number: int, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def servernumber(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def shockplot3d(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def smoothmesh(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], number_of_passes: int, smoothing_weight: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def sonicspeed(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def spamean(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], variable: Union['ENS_VAR', str, int], component: str = '[X]', result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def spameanweighted(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], variable: Union['ENS_VAR', str, int], component: str = '[X]', weight: Optional[Union['ENS_VAR', str, int]] = None, result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def speed(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def statmoment(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], opt_variable: Union['ENS_VAR', str, int, 'float'], which: int = 0, result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def statregspa(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], y: Union['ENS_VAR', str, int, 'float'], x0: Union['ENS_VAR', str, int, 'float'], x1: Union['ENS_VAR', str, int, 'float'], x2: Union['ENS_VAR', str, int, 'float'], x3: Union['ENS_VAR', str, int, 'float'], x4: Union['ENS_VAR', str, int, 'float'], weight: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def statregval1(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], regression_var: Union['ENS_VAR', str, int, 'float'], which_stat: int = 0, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def statregval2(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], regression_var: Union['ENS_VAR', str, int, 'float'], which_stat: int = 0, var_select: Optional[int] = None, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def swirl(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], velocity: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def temperature(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], gas: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def temperlognorm(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], gas: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tempernorm(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], gas: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tempernormstag(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], free_density: Union['ENS_VAR', str, int, 'float'], free_speed_of_sound: Union['ENS_VAR', str, int, 'float'], free_velocity: Union['ENS_VAR', str, int, 'float'], gas: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def temperstag(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], density: Union['ENS_VAR', str, int, 'float'], total_energy: Union['ENS_VAR', str, int], velocity: Union['ENS_VAR', str, int], ratio: Union['ENS_VAR', str, int, 'float'], gas: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tempmean(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], variable: Union['ENS_VAR', str, int], t1: int, t2: int, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tempminmaxfield(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], variable: Union['ENS_VAR', str, int], t1: int, t2: int, flag: int, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tensorcomponent(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], tensor: Union['ENS_VAR', str, int], row1_3: int = 1, col1_3: int = 1, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tensordeterminant(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], T11: Union['ENS_VAR', str, int], T22: Union['ENS_VAR', str, int], T33: Union['ENS_VAR', str, int], T12: Union['ENS_VAR', str, int], T13: Union['ENS_VAR', str, int], T23: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tensoreigenvalue(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], tensor: Union['ENS_VAR', str, int], num1_3: int = 1, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tensoreigenvector(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], tensor: Union['ENS_VAR', str, int], num1_3: int = 1, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tensormake(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tensormakeasym(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], scalar: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tensortresca(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], T11: Union['ENS_VAR', str, int], T22: Union['ENS_VAR', str, int], T33: Union['ENS_VAR', str, int], T12: Union['ENS_VAR', str, int], T13: Union['ENS_VAR', str, int], T23: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def tensorvonmises(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], T11: Union['ENS_VAR', str, int], T22: Union['ENS_VAR', str, int], T33: Union['ENS_VAR', str, int], T12: Union['ENS_VAR', str, int], T13: Union['ENS_VAR', str, int], T23: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def vector1dprojection(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], vector_to_project: Union['ENS_VAR', str, int], which_direction: int = 0, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def vectorcylprojection(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], vector_to_project: Union['ENS_VAR', str, int], frame_number: int, which_axis: int = 0, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def vectorrectprojection(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], vector_to_project: Union['ENS_VAR', str, int], frame_number: int, which_axis: int = 0, output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def velo(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], momentum: Union['ENS_VAR', str, int], density: Union['ENS_VAR', str, int, 'float'], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def vol(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], result_type: str = 'Compute_Per_case', output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def vort(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], output_varname: Optional[str] = None) -> 'ENS_VAR':
    ...
    def vortgamma(self, source_parts: Union[List['ENS_PART'], List[int], List[str]], velocity: Union['ENS_VAR', str, int], gammafunc: int = 1, proximity_radius: Optional[Union['ENS_VAR', str, int, 'float']] = None, proximity_option: int = 0, output_varname: Optional[str] = None) -> 'ENS_VAR':
