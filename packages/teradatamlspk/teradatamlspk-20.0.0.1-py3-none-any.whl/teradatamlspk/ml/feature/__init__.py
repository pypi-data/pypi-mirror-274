...
from teradatamlspk.ml.util import _FeatureMethods, _StandardScalarMethods, _ImputerMethods, _MaxAbsScalerMethods, \
    ...
    _SQLTransformerMethods, _UnivariateFeatureSelector
...
IDFModel = type("IDFModel", (_FeatureMethods, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item)})

PCA = type("PCA", (Params, _PCAMethods, ), {})
PCAModel = type("PCAModel", (_PCAMethods, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item)})

Imputer = type("Imputer", (Params, _ImputerMethods, ), {})
ImputerModel = type("ImputerModel", (_ImputerMethods, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item)})

MaxAbsScaler = type("MaxAbsScaler", (Params, _MaxAbsScalerMethods, ), {})
MaxAbsScalerModel = type("MaxAbsScalerModel", (_MaxAbsScalerMethods, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item)})

MinHashLSH = type("MinHashLSH", (Params, _FeatureMethods, ), {})
MinHashLSHModel = type("MinHashLSHModel", (_FeatureMethods, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item)})

MinMaxScaler = type("MinMaxScaler", (Params, _MinMaxScalerMethods, ), {})
MinMaxScalerModel = type("MinMaxScalerModel", (_MinMaxScalerMethods, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item)})

OneHotEncoder = type("OneHotEncoder", (Params, _OneHotEncoder, ), {})
OneHotEncoderModel = type("OneHotEncoderModel", (_OneHotEncoder, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item)})

RobustScaler = type("RobustScaler", (Params, _FeatureMethods, ), {})
RobustScalerModel = type("RobustScalerModel", (_FeatureMethods, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item)})

StandardScaler = type("StandardScaler", (Params, _StandardScalarMethods, ), {})
StandardScalerModel = type("StandardScalerModel", (_StandardScalarMethods, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item)})

VarianceThresholdSelector = type("VarianceThresholdSelector", (Params, _VarianceThresholdMethods, ), {})
VarianceThresholdSelectorModel = type("VarianceThresholdSelectorModel", (_VarianceThresholdMethods, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item)})
...
UnivariateFeatureSelectorModel = type("UnivariateFeatureSelectorModel", (_UnivariateFeatureSelector, ), {"__getattr__": lambda self, item: getattr(self._spark_model_obj, item)})
