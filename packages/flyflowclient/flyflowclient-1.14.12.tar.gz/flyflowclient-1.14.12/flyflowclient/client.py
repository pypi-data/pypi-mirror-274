...
class Flyflow:
    ...
    def create_agent(self, name=None, system_prompt=None, initial_message=None, voice_id=None, llm_model=None, webhook=None, tools=None, filler_words=None, filler_words_whitelist=None, area_code=None, actions=None, voicemail_number=None):
        payload = {
            'name': name,
    ...
    def update_agent(self, agent_id, name=None, system_prompt=None, initial_message=None, voice_id=None, llm_model=None, webhook=None, tools=None, filler_words=None, filler_words_whitelist=None, actions=None, voicemail_number=None):
        payload = {
            'id': agent_id,
            'name': name,
            'system_prompt': system_prompt,
