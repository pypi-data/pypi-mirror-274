...
ACCOUNT_ID = Schema(
    ...
    traits=[
        Trait(id=ShapeID("smithy.api#pattern"), value="^[A-Za-z0-9-._]{1,36}$"),
    ],
)
...
DATA_SUBJECT_ID = Schema(
    id=ShapeID("borneo#DataSubjectId"),
    type=ShapeType.STRING,
    traits=[
        Trait(
            id=ShapeID("smithy.api#pattern"),
...
DATA_SUBJECT = Schema.collection(
    id=ShapeID("borneo#DataSubject"),
    members={
        "id": {
            "target": DATA_SUBJECT_ID,
            "traits": [
                Trait(id=ShapeID("smithy.api#required")),
            ],
        },
...
SCAN_RESULTS_EXPORT_INPUT = Schema.collection(
    id=ShapeID("borneo#ScanResultsExportInput"),
    traits=[
        Trait(id=ShapeID("smithy.api#input")),
    ],
    members={
...
SCAN_RESULTS_EXPORT_OUTPUT = Schema.collection(
    id=ShapeID("borneo#ScanResultsExportOutput"),
    traits=[
        Trait(id=ShapeID("smithy.api#output")),
    ],
    members={
