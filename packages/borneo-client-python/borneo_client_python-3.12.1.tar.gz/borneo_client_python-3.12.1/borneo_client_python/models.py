...
@dataclass(kw_only=True)
class DataSubject:
    """Represents a Data Subject, who is affected by a processing activity

    :param id: Identifier of the data subject. Can be an UUID if it's a custom data
    subject or a key
    of one of the data subjects that we offer
...
class CreateProcessingActivityInput:
    ...
    data_subjects: list[DataSubject] | None = None
...
class ProcessingActivityRecipientMember:
    ...
    :param category: The category of the recipient. It can be one of several
    options.
...
class ScheduleType(StrEnum):
    ...
    it is created. A schedule type of "cron" creates
    a
    recurring scan that will be executed at the
    specified cron schedule.
    """
...
class CreateScanInput:
    ...
    it is created. A schedule type of "cron"
    creates a recurring scan that will be executed at the
    specified cron schedule.
