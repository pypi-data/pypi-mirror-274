...
class OrganizationProto(_message.Message):
    __slots__ = ("id", "owner", "name", "description", "image_url", "state", "default_org")
    ...
    default_org: bool
    def __init__(self, id: _Optional[str] = ..., owner: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., image_url: _Optional[str] = ..., state: _Optional[_Union[OrganizationStateProto, str]] = ..., default_org: bool = ...) -> None: ...
