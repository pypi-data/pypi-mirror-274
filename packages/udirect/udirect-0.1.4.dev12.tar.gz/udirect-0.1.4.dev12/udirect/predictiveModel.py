...
class predictiveModel:
    def __init__(self):
        self.model_path = str(files(__udirect__).joinpath("directivity_model/"))
        self.model = load_model(self.model_path, compile=False)
        self.xmin_file = str(files(__udirect__).joinpath("directivity_model/xmin.npy"))
        self.xmax_file = str(files(__udirect__).joinpath("directivity_model/xmax.npy"))
