...
if( ${MLHP_ENABLE_OMP} )
    ...
    if( OPENMP_FOUND )
        ...
        message( STATUS "Did not find OpenMP - disabling option." )
        set( MLHP_ENABLE_OMP OFF CACHE BOOL "Compile with shared memory parallelism." FORCE )
    endif( OPENMP_FOUND )
