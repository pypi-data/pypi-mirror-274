...
struct Compute : Units
{
    static void compute( )
    {
        ...
        auto baseMeshTicks = createBaseMeshTicks<D>( buildChamber, trefinement, telementsize, layerHeight, 0.64 );
        ...
        auto thermal = ThermalProblem<D>
        {
            ...
            .degree = 1,
            .timeStep = timestep,
            .source = laser::volumeSource<D>( laserTrack, laserD4Sigma, laserAbsorptivity, laserDepthScaling ),
