...
/*
* This benchmark is taken from Kollmannsberger et al. "A hierarchical computational model for moving thermal loads
and phase changes with applications to selective laser melting", Computers and Mathematics with Applications 75 (2018) 1483 - 1479
The analytical solution is described in H. Weber, Die Partiellen Differentialgleichungen Der Mathematischen Physik, 1912.
*/
