...
TEST_CASE( "linearInterpolation_test" )
{
    ...
    auto interpolation0 = interpolation::makeLinearInterpolation( positions, values, false );
    auto interpolation1 = interpolation::makeLinearInterpolation( positions, values, true );
