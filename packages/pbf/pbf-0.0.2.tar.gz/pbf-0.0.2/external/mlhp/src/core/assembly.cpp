                        ...
                        const DofIndicesValuesPair& boundaryDofs )
{
    ...
    #pragma omp parallel
    {
        ...
        for( std::int64_t ii = 0; ii < static_cast<std::int64_t>( basis.nelements( ) ); ++ii )
        {
                        ...
                        const DofIndicesValuesPair& boundaryDofs )
{
    ...
    #pragma omp parallel
    {
        ...
        #pragma omp for schedule( dynamic )
        for( std::int64_t iiElement = 0; iiElement < static_cast<std::int64_t>( basis1.nelements( ) ); ++iiElement )
        {
