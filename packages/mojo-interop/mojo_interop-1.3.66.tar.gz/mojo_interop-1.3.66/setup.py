...
['mojo-config>=1.3.19,<1.4.0',
 ...
 'mojo-errors>=1.3.7,<1.4.0',
 'mojo-landscaping>=1.3.6,<1.4.0',
 'mojo-networking>=1.3.5,<1.4.0',
 'mojo-results>=1.3.14,<1.4.0',
 'mojo-runtime>=1.3.20,<1.4.0',
 'mojo-testplus>=1.3.31,<1.4.0',
