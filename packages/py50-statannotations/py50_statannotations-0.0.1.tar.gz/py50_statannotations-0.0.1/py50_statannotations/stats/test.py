...
from py50_statannotations.stats.ComparisonsCorrection import \
    ComparisonsCorrection, get_validated_comparisons_correction
from py50_statannotations.stats.StatResult import StatResult
from py50_statannotations.stats.StatTest import StatTest
