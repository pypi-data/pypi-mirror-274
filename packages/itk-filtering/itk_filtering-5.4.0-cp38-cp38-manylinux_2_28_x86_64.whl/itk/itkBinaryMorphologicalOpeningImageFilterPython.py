...
def binary_morphological_opening_image_filter(*args: itkt.ImageLike,  foreground_value: float=..., background_value: float=..., kernel: itkt.FlatStructuringElement=..., radius: Union[Sequence[int], int, int, Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
