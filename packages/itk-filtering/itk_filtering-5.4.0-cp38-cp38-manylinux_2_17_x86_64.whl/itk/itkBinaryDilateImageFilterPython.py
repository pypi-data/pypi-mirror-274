...
def binary_morphology_image_filter(*args: itkt.ImageLike,  foreground_value: float=..., background_value: float=..., boundary_to_foreground: bool=..., kernel: Union[itkt.FlatStructuringElement, itkt.FlatStructuringElement]=..., radius: Union[int, int, Sequence[int], Sequence[int]]=...,**kwargs)-> itkt.ImageSourceReturn:
