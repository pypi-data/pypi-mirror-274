...
def binary_morphological_opening_image_filter(*args: itkt.ImageLike,  foreground_value: float=..., background_value: float=..., kernel: itkt.FlatStructuringElement=..., radius: Union[Sequence[int], Sequence[int], int, int]=...,**kwargs)-> itkt.ImageSourceReturn:
