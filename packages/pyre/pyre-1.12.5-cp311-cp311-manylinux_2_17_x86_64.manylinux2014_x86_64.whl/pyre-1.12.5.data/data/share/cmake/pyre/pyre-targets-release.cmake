...
set_target_properties(pyre::journal PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libjournal.so"
  IMPORTED_SONAME_RELEASE "libjournal.so"
  )

list(APPEND _cmake_import_check_targets pyre::journal )
list(APPEND _cmake_import_check_files_for_pyre::journal "${_IMPORT_PREFIX}/lib64/libjournal.so" )
...
set_target_properties(pyre::pyre PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libpyre.so"
  IMPORTED_SONAME_RELEASE "libpyre.so"
  )

list(APPEND _cmake_import_check_targets pyre::pyre )
list(APPEND _cmake_import_check_files_for_pyre::pyre "${_IMPORT_PREFIX}/lib64/libpyre.so" )
