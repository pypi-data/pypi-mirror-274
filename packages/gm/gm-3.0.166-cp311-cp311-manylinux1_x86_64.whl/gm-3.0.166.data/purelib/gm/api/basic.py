...
from gm.csdk.c_sdk import (
    py_gmi_current, py_gmi_schedule, py_gmi_set_data_callback, py_gmi_set_strategy_id,
    ...
    py_gmi_set_backtest_threadnum, py_gmi_get_stop_error_code,
)
...
def set_option(max_wait_time=3600000, backtest_thread_num=1):
    # type: (int, int) -> None
    """
    设置策略运行系统选项
