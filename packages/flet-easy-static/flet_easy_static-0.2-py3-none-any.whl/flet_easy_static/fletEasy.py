...
from flet_easy_static.auto_route import automatic_routing
from flet_easy_static.datasy import Datasy
from flet_easy_static.extrasJwt import SecretKey
from flet_easy_static.inheritance import Viewsy
from flet_easy_static.pagesy import AddPagesy, Middleware, Pagesy
from flet_easy_static.route import FletEasyX
    ...
    def run(
        ...
        try:
            return app(
                ...
                # export_asgi_app=export_asgi_app,  # FOR STATIC PACKAGING FOR WEBSITE
            )
        except RuntimeError:
            raise Exception(
