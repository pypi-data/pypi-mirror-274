...
class FletEasy:
    ...
    * `path_views` : Configuration of the folder where are the .py files of the pages, you use the `Path` class to configure it.
    ...
    def __init__(
        ...
        print("Initializing FletEasy instance...")
        ...
        if path_views is not None:
            print(f"Adding pages from directory: {path_views}")
    ...
    def run(
        ...
        print("Running FletEasy instance...")
    ...
    def __decorator(self, value: str, data: Dict[str, Any] = None):
        def decorator(func: Callable):
            ...
            if data:
                print(f"Adding route: {data.get('route')}")
                route = (
                    (
                        self.__route_prefix
                        if data.get("route") == "/"
            ...
            if value == "page_404":
                ...
                print(f"Value == page_404 __decorator: {self.__page_404}")
            elif value == "page":
                self.__pages.add(
                    Pagesy(
                        route=route,
                ...
                print(f"Value == page __decorator: {self.__pages}")
            return wrapper
    ...
    def add_pages(self, group_pages: List[AddPagesy]):
        ...
        * In the list you enter objects of class `AddPagesy` from other .py files.
        ...
        """
        try:
            print("Adding pages from other files... add_pages()")
            ...
            print(f"Error in add_pages() function, error: {e}")
            raise e
    ...
    def add_routes(self, add_views: List[Pagesy]):
        ...
        print("Adding routes without the use of decorators...")
        for page in add_views:
            print(f"Adding route: {page.route}")
            if self.__route_prefix:
                page.route = self.__route_prefix + page.route

            self.__pages.add(page)
            print(f"Route added: {page.route}")
