...
from pydantic_base_aiogram.types import FileType, OptionalAlbum, OptionalFile, Album, SingleBatchOptionalAlbum
from pydantic_base_aiogram.controller.optional_file import OptionalFileController, SOptionalFileController
...
class ControllerFactory(FieldFactory, ABC):
    CONVERT_DIALECTS = {
        ...
        SingleBatchOptionalAlbum: SOptionalFileController,
    }
