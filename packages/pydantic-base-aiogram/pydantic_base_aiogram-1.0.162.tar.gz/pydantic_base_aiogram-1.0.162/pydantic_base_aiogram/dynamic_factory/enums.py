...
from pydantic_base_aiogram.types import FileType, Album, OptionalFile, OptionalAlbum, SingleBatchOptionalAlbum
...
class InputFormTypesEnum(DescriptiveEnum):
    ...
    SingleOptionalAlbum = (SingleBatchOptionalAlbum.__name__, 'SingleBatchOptionalAlbum')
