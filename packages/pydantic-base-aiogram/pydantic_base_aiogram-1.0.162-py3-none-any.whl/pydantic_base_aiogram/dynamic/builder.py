...
from pydantic_base_aiogram.types import FileType, OptionalFile, Album, OptionalAlbum, SingleBatchOptionalAlbum
...
class DynamicHandlersGroupBuilder:
    ...
    _DEFAULT_EXTRA_TYPES = {
        ...
        SingleBatchOptionalAlbum.__name__: SingleBatchOptionalAlbum,
    }
