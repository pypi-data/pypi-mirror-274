...
class TissueDonor(BaseModel):
    """
    Contains generic information about a tissue donor.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["label", "description", "link"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TissueDonor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TissueDonor from a dict"""
        if obj is None:
            return None
