...
class OntologyTree(BaseModel):
    ...
    An ontology tree.
    """ # noqa: E501
    root: StrictStr = Field(description="Reference to the root node.")
    nodes: Dict[str, OntologyTreeNode] = Field(description="A mapping of identifiers to each node object.")
    __properties: ClassVar[List[str]] = ["root", "nodes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OntologyTree from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OntologyTree from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "root": obj.get("root"),
            "nodes": dict(
                (_k, OntologyTreeNode.from_dict(_v))
