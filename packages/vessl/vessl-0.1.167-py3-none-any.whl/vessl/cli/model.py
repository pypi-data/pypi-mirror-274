...
from vessl.internal.vessl_model import VesslModel
from vessl.kernel_image import (
    get_recent_framework_and_matchin_cuda_versions,
    list_framework_supported_cuda_version_for_vessl_managed,
)
...
def register(
    ...
    **kwargs,
    ...
    if repository_name is None:
        repositories = list_model_repositories()
