...
from PIL import Image  # noqa: E402  # noqa: E402
from PIL import ImageChops  # noqa: E402  # noqa: E402
...
def get_img_base64(single_image_path):
    with open(single_image_path, 'rb') as fp:  # noqa: PTH123
...
class Captcha:
    def __init__(
        ...
        if import_onnx_path != '':
            ...
            with open(charsets_path, encoding='utf-8') as f:  # noqa: PTH123
        ...
        if det:
            ocr = False
            self.__graph_path = os.path.join(  # noqa: PTH118
                os.path.dirname(__file__), 'common_det.onnx'  # noqa: PTH120
            )
            self.__charset = []
        if ocr:
            if not beta:
                self.__graph_path = os.path.join(  # noqa: PTH118
                    os.path.dirname(__file__), 'common_old.onnx'  # noqa: PTH120
                )
                self.__charset = [
                    '',
                    '掀',
                ...
                self.__graph_path = os.path.join(  # noqa: PTH118
                    os.path.dirname(__file__), 'common.onnx'  # noqa: PTH120
                )
                self.__charset = [
                    '',
                    '笤',
    ...
    def classification(self, img):
        ...
        if isinstance(img, bytes):
            ...
            assert isinstance(img, pathlib.PurePath)  # nosec B101:assert_used
