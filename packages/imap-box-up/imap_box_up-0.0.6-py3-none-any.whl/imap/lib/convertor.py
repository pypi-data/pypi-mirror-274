...
class Opendrive2Apollo(Convertor):
  ...
  def convert_proj_txt(self, proj_txt, relative):
    if proj_txt is None:
    ...
    if relative == True:
      self.origin_x, self.origin_y, zone_id=0,0,0

  def convert_header(self, relative):
    ...
    self.convert_proj_txt(proj_txt, relative)
  ...
  def construct_junction_polygon(self, xodr_junction, type="box"):
