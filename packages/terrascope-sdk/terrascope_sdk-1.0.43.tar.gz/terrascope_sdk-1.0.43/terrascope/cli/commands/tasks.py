...
def tasks_initialize(
    ...
    if not dry_run:
        ...
        data_source = input_manifest['inputs'][0].get('data_source_name', None)
...
def tasks_update(
    ...
    analysis_version = algorithm_version  # default
...
def tasks_idtrace(
    ...
    for analysis_id, name, author in analysis_ids:
        ...
        for analysis_version in analysis_versions:
            ...
            analysis_version_detail = asyncio.run(wf.get_analysis_versions(analysis_version_id=analysis_version_id))[0]
