...
def generate_creds_from_env(
    client_env_key, token_env_key="GDOC_TOKEN", scope: List[str] = None, env_path=None
):
    ...
    token_obj = {**str_to_obj(os.environ.get(token_env_key))}

    creds = None
    if token_obj:

        # print({"stage" : "if_token",
        #        "type" : isinstance(token_obj, dict),
        #         "token_obj" : token_obj})
    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            # print(type(client_obj), client_obj, )
