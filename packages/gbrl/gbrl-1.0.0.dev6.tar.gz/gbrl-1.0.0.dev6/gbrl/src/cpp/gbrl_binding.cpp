...
PYBIND11_MODULE(gbrl_cpp, m) {
    ...
    gbrl.def("step", [](GBRL &self, py::object &obs, py::object &categorical_obs, py::array_t<float> &grads) {
        ...
        py::gil_scoped_release release; 
        self.step(obs_ptr, cat_obs_ptr, grads_ptr, n_samples, n_num_features, n_cat_features); 
    },  py::arg("obs"),
