...
from .types.unstable_finetune_create_request_training_config_value import (
    UnstableFinetuneCreateRequestTrainingConfigValue,
)
...
class OpenPipeApi:
    ...
    def unstable_finetune_create(
        ...
        *,
        ...
        training_config: typing.Optional[typing.Dict[str, UnstableFinetuneCreateRequestTrainingConfigValue]] = OMIT,
        ...
        Parameters:
            ...
            - training_config: typing.Optional[typing.Dict[str, UnstableFinetuneCreateRequestTrainingConfigValue]].
        """
        _request: typing.Dict[str, typing.Any] = {"datasetId": dataset_id, "slug": slug, "baseModel": base_model}
        if training_config is not OMIT:
            _request["trainingConfig"] = training_config
        _response = self._client_wrapper.httpx_client.request(
            "POST",
