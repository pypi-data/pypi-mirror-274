...
class MigrationConfig:
    ...
    runtime_actions: Optional[List[Tuple[str, MigrationAction]]]

@dataclass
class ArtifactResolutionConfig:
    dir: Optional[str]
    prefix: Optional[str]
    disable_artifact_resolution: Optional[bool]
...
class Core:
    ...
    def init_typegraph(self, caller: wasmtime.Store, params: TypegraphInitParams) -> Result[None, Error]:
        ...
        return expected
    def finalize_typegraph(self, caller: wasmtime.Store, config: Optional[ArtifactResolutionConfig]) -> Result[Tuple[str, List[Artifact]], Error]:
        ptr = self.component._realloc0(caller, 0, 0, 4, 60)
        assert(isinstance(ptr, int))
        if config is None:
            ...
            record = payload0
            field = record.dir
            field1 = record.prefix
            field2 = record.disable_artifact_resolution
            field3 = record.prisma_migration
            field4 = record.codegen
            if field is None:
                ...
                _store(ctypes.c_uint32, self.component._core_memory0, caller, ptr, 12, len8)
                _store(ctypes.c_uint32, self.component._core_memory0, caller, ptr, 8, ptr7)
            if field1 is None:
                ...
                _store(ctypes.c_uint32, self.component._core_memory0, caller, ptr, 24, len12)
                _store(ctypes.c_uint32, self.component._core_memory0, caller, ptr, 20, ptr11)
            if field2 is None:
                ...
                _store(ctypes.c_uint8, self.component._core_memory0, caller, ptr, 29, int(payload14))
            record15 = field3
            field16 = record15.migration_dir
            field17 = record15.global_action
            field18 = record15.runtime_actions
            ptr19, len20 = _encode_utf8(field16, self.component._realloc0, self.component._core_memory0, caller)
            _store(ctypes.c_uint32, self.component._core_memory0, caller, ptr, 36, len20)
            _store(ctypes.c_uint32, self.component._core_memory0, caller, ptr, 32, ptr19)
            record21 = field17
            field22 = record21.create
            field23 = record21.reset
            _store(ctypes.c_uint8, self.component._core_memory0, caller, ptr, 40, int(field22))
            _store(ctypes.c_uint8, self.component._core_memory0, caller, ptr, 41, int(field23))
            if field18 is None:
                ...
                vec = payload25
                len33 = len(vec)
                result = self.component._realloc0(caller, 0, 0, 4, len33 * 12)
                assert(isinstance(result, int))
                for i34 in range(0, len33):
                    e = vec[i34]
                    base26 = result + i34 * 12
                    (tuplei,tuplei27,) = e
                    ptr28, len29 = _encode_utf8(tuplei, self.component._realloc0, self.component._core_memory0, caller)
                    _store(ctypes.c_uint32, self.component._core_memory0, caller, base26, 4, len29)
                    _store(ctypes.c_uint32, self.component._core_memory0, caller, base26, 0, ptr28)
                    record30 = tuplei27
                    field31 = record30.create
                    field32 = record30.reset
                    _store(ctypes.c_uint8, self.component._core_memory0, caller, base26, 8, int(field31))
                    _store(ctypes.c_uint8, self.component._core_memory0, caller, base26, 9, int(field32))
                _store(ctypes.c_uint32, self.component._core_memory0, caller, ptr, 52, len33)
            ...
            if field4 is None:
                ...
                _store(ctypes.c_uint8, self.component._core_memory0, caller, ptr, 57, int(payload36))
        ret = self.component.lift_callee1(caller, ptr)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        ...
        if load == 0:
            ...
            load41 = _load(ctypes.c_int32, self.component._core_memory0, caller, ret, 12)
            load42 = _load(ctypes.c_int32, self.component._core_memory0, caller, ret, 16)
            ptr55 = load41
            len56 = load42
            result57: List[Artifact] = []
            for i58 in range(0, len56):
                base43 = ptr55 + i58 * 20
                load44 = _load(ctypes.c_int32, self.component._core_memory0, caller, base43, 0)
                load45 = _load(ctypes.c_int32, self.component._core_memory0, caller, base43, 4)
                ptr46 = load44
                len47 = load45
                list48 = _decode_utf8(self.component._core_memory0, caller, ptr46, len47)
                load49 = _load(ctypes.c_int32, self.component._core_memory0, caller, base43, 8)
                load50 = _load(ctypes.c_int32, self.component._core_memory0, caller, base43, 12)
                ptr51 = load49
                len52 = load50
                list53 = _decode_utf8(self.component._core_memory0, caller, ptr51, len52)
                load54 = _load(ctypes.c_int32, self.component._core_memory0, caller, base43, 16)
                result57.append(Artifact(list48, list53, load54 & 0xffffffff))
            expected = Ok((list, result57,))
        elif load == 1:
            load59 = _load(ctypes.c_int32, self.component._core_memory0, caller, ret, 4)
            load60 = _load(ctypes.c_int32, self.component._core_memory0, caller, ret, 8)
            ptr67 = load59
            len68 = load60
            result69: List[str] = []
            for i70 in range(0, len68):
                base61 = ptr67 + i70 * 8
                load62 = _load(ctypes.c_int32, self.component._core_memory0, caller, base61, 0)
                load63 = _load(ctypes.c_int32, self.component._core_memory0, caller, base61, 4)
                ptr64 = load62
                len65 = load63
                list66 = _decode_utf8(self.component._core_memory0, caller, ptr64, len65)
                result69.append(list66)
            expected = Err(Error(result69))
        else:
            raise TypeError("invalid variant discriminant for expected")
    ...
    def with_injection(self, caller: wasmtime.Store, type_id: TypeId, injection: str) -> Result[TypeId, Error]:
        ...
        self.component._post_return0(caller, ret)
        return expected
    def refb(self, caller: wasmtime.Store, name: str, attributes: List[Tuple[str, str]]) -> Result[TypeId, Error]:
        ptr, len0 = _encode_utf8(name, self.component._realloc0, self.component._core_memory0, caller)
        vec = attributes
        len7 = len(vec)
        result = self.component._realloc0(caller, 0, 0, 4, len7 * 16)
        assert(isinstance(result, int))
        for i8 in range(0, len7):
            e = vec[i8]
            base1 = result + i8 * 16
            (tuplei,tuplei2,) = e
            ptr3, len4 = _encode_utf8(tuplei, self.component._realloc0, self.component._core_memory0, caller)
            _store(ctypes.c_uint32, self.component._core_memory0, caller, base1, 4, len4)
            _store(ctypes.c_uint32, self.component._core_memory0, caller, base1, 0, ptr3)
            ptr5, len6 = _encode_utf8(tuplei2, self.component._realloc0, self.component._core_memory0, caller)
            _store(ctypes.c_uint32, self.component._core_memory0, caller, base1, 12, len6)
            _store(ctypes.c_uint32, self.component._core_memory0, caller, base1, 8, ptr5)
        ret = self.component.lift_callee3(caller, ptr, len0, result, len7)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[TypeId, Error]
        if load == 0:
    ...
    def integerb(self, caller: wasmtime.Store, data: TypeInteger, base: TypeBase) -> Result[TypeId, Error]:
        ...
        if load == 0:
            ...
            len45 = load38
            result46: List[str] = []
            for i47 in range(0, len45):
                base39 = ptr44 + i47 * 8
                load40 = _load(ctypes.c_int32, self.component._core_memory0, caller, base39, 0)
                load41 = _load(ctypes.c_int32, self.component._core_memory0, caller, base39, 4)
                ptr42 = load40
                len43 = load41
                list = _decode_utf8(self.component._core_memory0, caller, ptr42, len43)
                result46.append(list)
            expected = Err(Error(result46))
        else:
            raise TypeError("invalid variant discriminant for expected")
        self.component._post_return0(caller, ret)
        return expected
    ...
    def stringb(self, caller: wasmtime.Store, data: TypeString, base: TypeBase) -> Result[TypeId, Error]:
        ...
        if load == 0:
            ...
            len52 = load45
            result53: List[str] = []
            for i54 in range(0, len52):
                base46 = ptr51 + i54 * 8
                load47 = _load(ctypes.c_int32, self.component._core_memory0, caller, base46, 0)
                load48 = _load(ctypes.c_int32, self.component._core_memory0, caller, base46, 4)
                ptr49 = load47
                len50 = load48
                list = _decode_utf8(self.component._core_memory0, caller, ptr49, len50)
                result53.append(list)
            expected = Err(Error(result53))
        else:
            raise TypeError("invalid variant discriminant for expected")
        self.component._post_return0(caller, ret)
        return expected
    def fileb(self, caller: wasmtime.Store, data: TypeFile, base: TypeBase) -> Result[TypeId, Error]:
        ...
        if load == 0:
            ...
            len53 = load46
            result54: List[str] = []
            for i55 in range(0, len53):
                base47 = ptr52 + i55 * 8
                load48 = _load(ctypes.c_int32, self.component._core_memory0, caller, base47, 0)
                load49 = _load(ctypes.c_int32, self.component._core_memory0, caller, base47, 4)
                ptr50 = load48
                len51 = load49
                list = _decode_utf8(self.component._core_memory0, caller, ptr50, len51)
                result54.append(list)
            expected = Err(Error(result54))
        else:
            raise TypeError("invalid variant discriminant for expected")
        self.component._post_return0(caller, ret)
        return expected
    def listb(self, caller: wasmtime.Store, data: TypeList, base: TypeBase) -> Result[TypeId, Error]:
        record = data
        field = record.of
        field0 = record.min
        field1 = record.max
    ...
    def optionalb(self, caller: wasmtime.Store, data: TypeOptional, base: TypeBase) -> Result[TypeId, Error]:
        ...
        if load == 0:
            ...
            for i40 in range(0, len38):
                ...
                result39.append(list)
            expected = Err(Error(result39))
        else:
            raise TypeError("invalid variant discriminant for expected")
        self.component._post_return0(caller, ret)
        return expected
    ...
    def structb(self, caller: wasmtime.Store, data: TypeStruct, base: TypeBase) -> Result[TypeId, Error]:
        ...
        if load == 0:
            ...
            for i56 in range(0, len54):
                ...
                ptr51 = load49
                len52 = load50
                list = _decode_utf8(self.component._core_memory0, caller, ptr51, len52)
                result55.append(list)
            expected = Err(Error(result55))
        else:
            raise TypeError("invalid variant discriminant for expected")
        self.component._post_return0(caller, ret)
        return expected
    def extend_struct(self, caller: wasmtime.Store, tpe: TypeId, props: List[Tuple[str, TypeId]]) -> Result[TypeId, Error]:
        ...
        ret = self.component.lift_callee14(caller, _clamp(tpe, 0, 4294967295), result, len3)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[TypeId, Error]
        if load == 0:
    ...
    def get_type_repr(self, caller: wasmtime.Store, id: TypeId) -> Result[str, Error]:
        ret = self.component.lift_callee15(caller, _clamp(id, 0, 4294967295))
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
    ...
    def funcb(self, caller: wasmtime.Store, data: TypeFunc) -> Result[TypeId, Error]:
        ...
        ret = self.component.lift_callee16(caller, _clamp(field, 0, 4294967295), variant, variant10, variant11, variant12, _clamp(field1, 0, 4294967295), _clamp(field2, 0, 4294967295), int(field3), variant15, variant16)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[TypeId, Error]
        if load == 0:
    ...
    def get_transform_data(self, caller: wasmtime.Store, resolver_input: TypeId, transform_tree: str) -> Result[TransformData, Error]:
        ...
        ret = self.component.lift_callee17(caller, _clamp(resolver_input, 0, 4294967295), ptr, len0)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
    ...
    def register_policy(self, caller: wasmtime.Store, pol: Policy) -> Result[PolicyId, Error]:
        ...
        ret = self.component.lift_callee18(caller, ptr, len1, _clamp(field0, 0, 4294967295))
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
    ...
    def with_policy(self, caller: wasmtime.Store, type_id: TypeId, policy_chain: List[PolicySpec]) -> Result[TypeId, Error]:
        ...
        ret = self.component.lift_callee19(caller, _clamp(type_id, 0, 4294967295), result, len13)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[TypeId, Error]
        if load == 0:
    ...
    def get_public_policy(self, caller: wasmtime.Store) -> Result[Tuple[PolicyId, str], Error]:
        ret = self.component.lift_callee20(caller)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
    ...
    def register_context_policy(self, caller: wasmtime.Store, key: str, check: ContextCheck) -> Result[Tuple[PolicyId, str], Error]:
        ...
        ret = self.component.lift_callee22(caller, ptr, len0, variant, variant7, variant8)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[Tuple[PolicyId, str], Error]
        if load == 0:
    ...
    def rename_type(self, caller: wasmtime.Store, tpe: TypeId, new_name: str) -> Result[TypeId, Error]:
        ...
        ret = self.component.lift_callee23(caller, _clamp(tpe, 0, 4294967295), ptr, len0)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[TypeId, Error]
        if load == 0:
    ...
    def expose(self, caller: wasmtime.Store, fns: List[Tuple[str, TypeId]], default_policy: Optional[List[PolicySpec]]) -> Result[None, Error]:
        ...
        if default_policy is None:
            ...
            variant25 = result22
            variant26 = len23
        ret = self.component.lift_callee24(caller, result, len3, variant, variant25, variant26)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[None, Error]
        if load == 0:
    ...
    def set_seed(self, caller: wasmtime.Store, seed: Optional[int]) -> Result[None, Error]:
        ...
        ret = self.component.lift_callee25(caller, variant, variant1)
        assert(isinstance(ret, int))
        load = _load(ctypes.c_uint8, self.component._core_memory0, caller, ret, 0)
        expected: Result[None, Error]
        if load == 0:
