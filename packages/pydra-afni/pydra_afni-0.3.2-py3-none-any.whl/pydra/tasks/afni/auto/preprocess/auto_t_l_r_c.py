...
auto_t_l_r_c_input_spec = specs.SpecInfo(
    name="Input", fields=input_fields, bases=(specs.ShellSpec,)
)

output_fields = [("out_file", File, {"help_string": "output file"})]
auto_t_l_r_c_output_spec = specs.SpecInfo(
    name="Output", fields=output_fields, bases=(specs.ShellOutSpec,)
)


class auto_t_l_r_c(ShellCommandTask):
    """
    Examples
    -------
    ...
    input_spec = auto_t_l_r_c_input_spec
    output_spec = auto_t_l_r_c_output_spec
