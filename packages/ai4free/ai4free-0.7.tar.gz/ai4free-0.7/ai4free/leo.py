...
if __name__ == "__main__":
    leo = LEO(is_conversation=True, filepath="conversation_history.txt")  # Keep conversation history

    while True:
        prompt = input("You: ")
        print("Leo:", end="", flush=True)
        for response in leo.chat(prompt, stream=True, conversationally=True):  # Use optimizer with conversation history
