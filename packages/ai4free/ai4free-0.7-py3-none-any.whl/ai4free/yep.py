...
if __name__ == "__main__":
    yepchat = YEPCHAT(is_conversation=True, filepath="conversation_history.txt")  # Keep conversation history

    while True:
        prompt = input("You: ")
        print("YepChat :", end="", flush=True)
        for response in yepchat.chat(
            prompt, stream=True, optimizer="code", conversationally=True
        ):  # Use optimizer with conversation history
            print(response, end="")