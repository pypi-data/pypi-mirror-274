...
class GlobusMixin:
    ...
    def globus_transfer_client(self) -> TransferClient:
        ...
        confidential_client = ConfidentialAppAuthClient(
            client_id=service_configuration.globus_client_id,
            client_secret=service_configuration.globus_client_secret,
            transport_params=service_configuration.globus_transport_params,
        )
    ...
    def globus_transfer_scratch_to_object_store(
        ...
        self.globus_transfer(
            source_endpoint=service_configuration.scratch_endpoint,
            destination_endpoint=service_configuration.object_store_endpoint,
    ...
    def globus_transfer_object_store_to_scratch(
        ...
        self.globus_transfer(
            source_endpoint=service_configuration.object_store_endpoint,
            destination_endpoint=service_configuration.scratch_endpoint,
            transfer_items=transfer_items,
            label=label,
            sync_level=sync_level,
            verify_checksum=verify_checksum,
