...
class ObjectStoreMixin:
    ...
    def object_store_client(self) -> ObjectClerk:
        ...
        """
        return ObjectClerk(
            host=service_configuration.object_store_api_mesh_service.host,
            port=service_configuration.object_store_api_mesh_service.port,
            access_key=service_configuration.object_store_access_key,
            secret_key=service_configuration.object_store_secret_key,
            ...
            use_ssl=service_configuration.object_store_use_ssl,
        )
