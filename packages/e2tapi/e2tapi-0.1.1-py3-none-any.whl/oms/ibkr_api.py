...
import IBKR_OMS_Messages_pb2 as pb
...
class E2T_OMS:
    ...
    def _send_limit_order(self, side, symbol, quantity, price):
    ...
    def _send_limit_replace(self, order_id, quantity, price):
    ...
    def _send_limit_cancel(self, order_id):
