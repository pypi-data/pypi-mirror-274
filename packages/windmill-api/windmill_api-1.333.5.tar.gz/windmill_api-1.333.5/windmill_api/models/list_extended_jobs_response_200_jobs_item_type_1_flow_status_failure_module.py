...
from ..models.list_extended_jobs_response_200_jobs_item_type_1_flow_status_failure_module_type import (
    ListExtendedJobsResponse200JobsItemType1FlowStatusFailureModuleType,
)
...
if TYPE_CHECKING:
    ...
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_flow_status_failure_module_branch_chosen import (
        ListExtendedJobsResponse200JobsItemType1FlowStatusFailureModuleBranchChosen,
    )
...
T = TypeVar("T", bound="ListExtendedJobsResponse200JobsItemType1FlowStatusFailureModule")


@_attrs_define
class ListExtendedJobsResponse200JobsItemType1FlowStatusFailureModule:
    """
    Attributes:
        type (ListExtendedJobsResponse200JobsItemType1FlowStatusFailureModuleType):
        id (Union[Unset, str]):
        job (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = ListExtendedJobsResponse200JobsItemType1FlowStatusFailureModuleType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = ListExtendedJobsResponse200JobsItemType1FlowStatusFailureModuleIterator.from_dict(_iterator)
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = ListExtendedJobsResponse200JobsItemType1FlowStatusFailureModuleBranchChosen.from_dict(
                _branch_chosen
            )
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = ListExtendedJobsResponse200JobsItemType1FlowStatusFailureModuleBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = ListExtendedJobsResponse200JobsItemType1FlowStatusFailureModuleApproversItem.from_dict(
                approvers_item_data
            )
        ...
        list_extended_jobs_response_200_jobs_item_type_1_flow_status_failure_module.additional_properties = d
        return list_extended_jobs_response_200_jobs_item_type_1_flow_status_failure_module
