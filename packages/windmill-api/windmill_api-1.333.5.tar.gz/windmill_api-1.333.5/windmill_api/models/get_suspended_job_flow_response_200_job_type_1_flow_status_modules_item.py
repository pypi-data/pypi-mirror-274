...
from ..models.get_suspended_job_flow_response_200_job_type_1_flow_status_modules_item_type import (
    GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_suspended_job_flow_response_200_job_type_1_flow_status_modules_item_approvers_item import (
        GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemApproversItem,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_1_flow_status_modules_item_branch_chosen import (
        GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemBranchChosen,
    )
...
T = TypeVar("T", bound="GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItem")


@_attrs_define
class GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemIterator.from_dict(_iterator)
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemBranchChosen.from_dict(
                _branch_chosen
            )
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemApproversItem.from_dict(
                approvers_item_data
            )
        ...
        return get_suspended_job_flow_response_200_job_type_1_flow_status_modules_item
