...
from ..models.get_suspended_job_flow_response_200_job_type_0_flow_status_failure_module_type import (
    GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_suspended_job_flow_response_200_job_type_0_flow_status_failure_module_approvers_item import (
        GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleApproversItem,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_0_flow_status_failure_module_branch_chosen import (
        GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleBranchChosen,
    )
...
T = TypeVar("T", bound="GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModule")


@_attrs_define
class GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModule:
    """
    Attributes:
        type (GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleType):
        id (Union[Unset, str]):
        job (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleIterator.from_dict(_iterator)
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleBranchChosen.from_dict(
                _branch_chosen
            )
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleApproversItem.from_dict(
                approvers_item_data
            )
        ...
        get_suspended_job_flow_response_200_job_type_0_flow_status_failure_module.additional_properties = d
        return get_suspended_job_flow_response_200_job_type_0_flow_status_failure_module
