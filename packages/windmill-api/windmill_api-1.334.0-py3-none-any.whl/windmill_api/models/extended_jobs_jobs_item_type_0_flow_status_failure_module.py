...
from ..models.extended_jobs_jobs_item_type_0_flow_status_failure_module_type import (
    ExtendedJobsJobsItemType0FlowStatusFailureModuleType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.extended_jobs_jobs_item_type_0_flow_status_failure_module_approvers_item import (
        ExtendedJobsJobsItemType0FlowStatusFailureModuleApproversItem,
    )
    from ..models.extended_jobs_jobs_item_type_0_flow_status_failure_module_branch_chosen import (
        ExtendedJobsJobsItemType0FlowStatusFailureModuleBranchChosen,
    )
...
T = TypeVar("T", bound="ExtendedJobsJobsItemType0FlowStatusFailureModule")


@_attrs_define
class ExtendedJobsJobsItemType0FlowStatusFailureModule:
    """
    Attributes:
        type (ExtendedJobsJobsItemType0FlowStatusFailureModuleType):
        id (Union[Unset, str]):
        job (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = ExtendedJobsJobsItemType0FlowStatusFailureModuleType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = ExtendedJobsJobsItemType0FlowStatusFailureModuleIterator.from_dict(_iterator)
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = ExtendedJobsJobsItemType0FlowStatusFailureModuleBranchChosen.from_dict(_branch_chosen)
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = ExtendedJobsJobsItemType0FlowStatusFailureModuleBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = ExtendedJobsJobsItemType0FlowStatusFailureModuleApproversItem.from_dict(
                approvers_item_data
            )
        ...
        extended_jobs_jobs_item_type_0_flow_status_failure_module = cls(
            type=type,
            id=id,
            job=job,
            count=count,
        ...
        extended_jobs_jobs_item_type_0_flow_status_failure_module.additional_properties = d
        return extended_jobs_jobs_item_type_0_flow_status_failure_module
