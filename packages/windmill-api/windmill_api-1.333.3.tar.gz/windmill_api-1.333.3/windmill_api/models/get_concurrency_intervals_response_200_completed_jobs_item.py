...
T = TypeVar("T", bound="GetConcurrencyIntervalsResponse200CompletedJobsItem")


@_attrs_define
class GetConcurrencyIntervalsResponse200CompletedJobsItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_concurrency_intervals_response_200_completed_jobs_item = cls(
            job_id=job_id,
        ...
        get_concurrency_intervals_response_200_completed_jobs_item.additional_properties = d
        return get_concurrency_intervals_response_200_completed_jobs_item
