...
T = TypeVar("T", bound="ConcurrencyIntervalsCompletedJobsItem")


@_attrs_define
class ConcurrencyIntervalsCompletedJobsItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        concurrency_intervals_completed_jobs_item = cls(
            job_id=job_id,
        ...
        concurrency_intervals_completed_jobs_item.additional_properties = d
        return concurrency_intervals_completed_jobs_item
