...
from ...models.get_concurrency_intervals_response_200 import GetConcurrencyIntervalsResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/w/{workspace}/concurrency_groups/intervals".format(
            workspace=workspace,
        ),
        "params": params,
    }
...
) -> Optional[GetConcurrencyIntervalsResponse200]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetConcurrencyIntervalsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[GetConcurrencyIntervalsResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        GetConcurrencyIntervalsResponse200
    """
