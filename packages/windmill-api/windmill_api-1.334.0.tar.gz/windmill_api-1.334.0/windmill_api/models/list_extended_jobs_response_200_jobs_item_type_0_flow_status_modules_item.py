...
from ..models.list_extended_jobs_response_200_jobs_item_type_0_flow_status_modules_item_type import (
    ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItemType,
)
...
if TYPE_CHECKING:
    ...
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_flow_status_modules_item_branch_chosen import (
        ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItemBranchChosen,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_flow_status_modules_item_branchall import (
        ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItemBranchall,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_flow_status_modules_item_iterator import (
        ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItemIterator,
    )


T = TypeVar("T", bound="ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItem")


@_attrs_define
class ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItemType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItemIterator.from_dict(_iterator)
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItemBranchChosen.from_dict(
                _branch_chosen
            )
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItemBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItemApproversItem.from_dict(
                approvers_item_data
            )
        ...
        return list_extended_jobs_response_200_jobs_item_type_0_flow_status_modules_item
