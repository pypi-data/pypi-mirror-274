...
class CustomModeConfig(_message.Message):
    __slots__ = ("id", "digital_button_mappings", "stick_direction_mappings", "analog_trigger_mappings", "modifiers", "stick_range")
...
class Config(_message.Message):
    __slots__ = ("game_mode_configs", "communication_backend_configs", "custom_modes", "keyboard_modes", "rgb_configs", "default_backend_config", "default_usb_backend_config", "rgb_brightness")
