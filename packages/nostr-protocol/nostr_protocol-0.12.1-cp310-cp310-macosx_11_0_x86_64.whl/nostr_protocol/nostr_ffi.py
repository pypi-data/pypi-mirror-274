...
def _uniffi_check_api_checksums(lib):
    if lib.uniffi_nostr_ffi_checksum_func_create_delegation_tag() != 39643:
    ...
    if lib.uniffi_nostr_ffi_checksum_func_extract_relay_list() != 51894:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_generate_shared_key() != 24701:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_get_leading_zero_bits() != 55983:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_get_nip05_profile() != 3212:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_func_gift_wrap() != 12272:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_gift_wrap_from_seal() != 39743:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_func_nip57_private_zap_request() != 31681:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_sign_delegation() != 28721:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_validate_delegation_tag() != 56480:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_verify_delegation_signature() != 1929:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_verify_nip05() != 21994:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_clientmessage_as_enum() != 33173:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_clientmessage_as_json() != 25711:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_encryptedsecretkey_version() != 27626:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_event_as_json() != 6443:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_event_verify_signature() != 63925:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_eventbuilder_add_tags() != 37368:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_filemetadata_size() != 25033:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_as_json() != 2504:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_kind_as_enum() != 37013:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_kind_as_u16() != 42491:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_kind_as_u64() != 51642:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_metadata_as_json() != 49741:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_nip21_to_nostr_uri() != 50917:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_nostrconnectmetadata_as_json() != 46001:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_publickey_to_nostr_uri() != 23126:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_rawevent_as_json() != 12712:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_relaymessage_as_enum() != 56517:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_relaymessage_as_json() != 2111:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_request_method() != 18547:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_request_params() != 61907:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_secretkey_encrypt() != 47103:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_singlelettertag_is_uppercase() != 50218:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_stalldata_as_json() != 14021:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_stalldata_shipping() != 57313:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_tag_as_standardized() != 40509:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_tag_as_vec() != 32049:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_tag_content() != 16124:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_tag_is_reply() != 11447:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_tag_kind() != 61495:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_tag_single_letter_tag() != 32689:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_unsignedevent_add_signature() != 65391:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_unsignedevent_as_json() != 44697:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_emojis() != 32679:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_encrypted_direct_msg() != 30966:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_pinned_notes() != 22014:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_private_msg_rumor() != 62698:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_reaction_extended() != 18337:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_relay_list() != 11684:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_constructor_kind_from_enum() != 24008:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_kind_new() != 42942:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_constructor_nip19event_from_nostr_uri() != 60241:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nip19event_new() != 29588:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_constructor_nip19profile_from_nostr_uri() != 33427:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nip19profile_new() != 43655:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_constructor_secretkey_from_hex() != 11652:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_secretkey_generate() != 51859:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_constructor_stalldata_new() != 34499:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_coordinate() != 27758:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_custom() != 40165:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_event() != 49250:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_event_report() != 39217:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_expiration() != 65320:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_from_standardized() != 42506:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_hashtag() != 42443:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_identifier() != 38639:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_parse() != 14656:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_pow() != 65247:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_public_key() != 422:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_public_key_report() != 36694:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_relay_metadata() != 53981:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_private_msg_rumor.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_private_msg_rumor.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_method_eventbuilder_add_tags.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_eventbuilder_add_tags.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_as_u16.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_as_u16.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_secretkey_generate.argtypes = (
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_secretkey_generate.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_coordinate.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_coordinate.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_custom.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_custom.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_event_report.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_event_report.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_expiration.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_expiration.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_from_standardized.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_from_standardized.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_hashtag.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_hashtag.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_identifier.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_identifier.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_pow.argtypes = (
    ctypes.c_uint64,
    ctypes.c_uint8,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_pow.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_public_key_report.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_public_key_report.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_relay_metadata.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_relay_metadata.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_as_standardized.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_as_standardized.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_content.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_content.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_single_letter_tag.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_single_letter_tag.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_nostr_ffi_fn_func_gift_wrap_from_seal.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_func_gift_wrap_from_seal.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_checksum_func_gift_wrap_from_seal.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_func_gift_wrap_from_seal.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_eventbuilder_add_tags.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_eventbuilder_add_tags.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_kind_as_u16.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_kind_as_u16.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_tag_as_standardized.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_tag_as_standardized.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_tag_content.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_tag_content.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_tag_single_letter_tag.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_tag_single_letter_tag.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_private_msg_rumor.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_private_msg_rumor.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_secretkey_generate.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_secretkey_generate.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_coordinate.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_coordinate.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_custom.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_custom.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_event_report.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_event_report.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_expiration.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_expiration.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_from_standardized.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_from_standardized.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_hashtag.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_hashtag.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_identifier.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_identifier.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_pow.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_pow.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_public_key_report.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_public_key_report.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_relay_metadata.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_tag_relay_metadata.restype = ctypes.c_uint16
...
class ClientMessage:
    ...
    def as_json(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_as_json,self._uniffi_clone_pointer(),)
        )
...
class Event:
    ...
    def as_json(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_event_as_json,self._uniffi_clone_pointer(),)
        )
...
class EventBuilder:
    ...
    @classmethod
    def private_msg_rumor(cls, receiver: "PublicKey",message: "str",reply_to: "typing.Union[object, typing.Optional[EventId]]" = _DEFAULT):
        """
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_private_msg_rumor,
    ...
    @classmethod
    def relay_list(cls, map: "dict[str, typing.Optional[RelayMetadata]]"):
        _UniffiConverterMapStringOptionalTypeRelayMetadata.check_lower(map)
        
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_relay_list,
        _UniffiConverterMapStringOptionalTypeRelayMetadata.lower(map))
        return cls._make_instance_(pointer)
    ...
    def add_tags(self, tags: "typing.List[Tag]") -> "EventBuilder":
        """
        Add tags
        """
        ...
        return _UniffiConverterTypeEventBuilder.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_eventbuilder_add_tags,self._uniffi_clone_pointer(),
        _UniffiConverterSequenceTypeTag.lower(tags))
        )
...
class Filter:
    ...
    def as_json(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_filter_as_json,self._uniffi_clone_pointer(),)
        )
...
class Kind:
    ...
    def as_u16(self, ) -> "int":
        ...
        return _UniffiConverterUInt16.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_kind_as_u16,self._uniffi_clone_pointer(),)
        )
...
class Metadata:
    ...
    def as_json(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_as_json,self._uniffi_clone_pointer(),)
        )
...
class Nip19Event:
    _pointer: ctypes.c_void_p
    def __init__(self, event_id: "EventId",author: "typing.Union[object, typing.Optional[PublicKey]]" = _DEFAULT,relays: "typing.Union[object, typing.List[str]]" = _DEFAULT):
        _UniffiConverterTypeEventId.check_lower(event_id)
...
class Nip19Profile:
    _pointer: ctypes.c_void_p
    def __init__(self, public_key: "PublicKey",relays: "typing.Union[object, typing.List[str]]" = _DEFAULT):
        """
        New NIP19 profile
        """
...
class NostrConnectMetadata:
    ...
    def as_json(self, ) -> "str":
        ...
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnectmetadata_as_json,self._uniffi_clone_pointer(),)
        )
...
class RawEvent:
    ...
    def as_json(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_as_json,self._uniffi_clone_pointer(),)
        )
...
class RelayMessage:
    ...
    def as_json(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_as_json,self._uniffi_clone_pointer(),)
        )
...
class SecretKey:
    ...
    def generate(cls, ):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_secretkey_generate,)
        return cls._make_instance_(pointer)
...
class StallData:
    ...
    def as_json(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_as_json,self._uniffi_clone_pointer(),)
        )
...
class Tag:
    ...
    @classmethod
    def coordinate(cls, coordinate: "Coordinate"):
        """
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_coordinate,
    ...
    def custom(cls, kind: "TagKind",values: "typing.List[str]"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_custom,
    ...
    def event_report(cls, event_id: "EventId",report: "Report"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_event_report,
        _UniffiConverterTypeEventId.lower(event_id),
    ...
    def expiration(cls, timestamp: "Timestamp"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_expiration,
        _UniffiConverterTypeTimestamp.lower(timestamp))
        return cls._make_instance_(pointer)
    ...
    def from_standardized(cls, standardized: "TagStandard"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_from_standardized,
    ...
    def hashtag(cls, hashtag: "str"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_hashtag,
        _UniffiConverterString.lower(hashtag))
        return cls._make_instance_(pointer)
    ...
    def identifier(cls, identifier: "str"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_identifier,
        _UniffiConverterString.lower(identifier))
        return cls._make_instance_(pointer)
    ...
    def pow(cls, nonce: "int",difficulty: "int"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_pow,
    ...
    def public_key_report(cls, public_key: "PublicKey",report: "Report"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_public_key_report,
        _UniffiConverterTypePublicKey.lower(public_key),
        _UniffiConverterTypeReport.lower(report))
        return cls._make_instance_(pointer)
    ...
    @classmethod
    def relay_metadata(cls, relay_url: "str",metadata: "typing.Optional[RelayMetadata]"):
        """
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_constructor_tag_relay_metadata,
        _UniffiConverterString.lower(relay_url),
    ...
    def as_standardized(self, ) -> "typing.Optional[TagStandard]":
        ...
        return _UniffiConverterOptionalTypeTagStandard.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_tag_as_standardized,self._uniffi_clone_pointer(),)
        )
    ...
    def content(self, ) -> "typing.Optional[str]":
        ...
        return _UniffiConverterOptionalString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_tag_content,self._uniffi_clone_pointer(),)
        )
    ...
    def single_letter_tag(self, ) -> "typing.Optional[SingleLetterTag]":
        ...
        return _UniffiConverterOptionalTypeSingleLetterTag.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_tag_single_letter_tag,self._uniffi_clone_pointer(),)
        )
...
class UnsignedEvent:
    ...
    def as_json(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_as_json,self._uniffi_clone_pointer(),)
        )
...
class _UniffiConverterTypeRawEventRecord(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return RawEventRecord(
            ...
            pubkey=_UniffiConverterString.read(buf),
            created_at=_UniffiConverterUInt64.read(buf),
            kind=_UniffiConverterUInt16.read(buf),
...
class KindEnum:
    ...
    class PRIVATE_DIRECT_MESSAGE:
        ...
        def __str__(self):
            return "KindEnum.PRIVATE_DIRECT_MESSAGE()".format()

        def __eq__(self, other):
            if not other.is_private_direct_message():
                return False
            return True
    ...
    def is_private_direct_message(self) -> bool:
        return isinstance(self, KindEnum.PRIVATE_DIRECT_MESSAGE)
...
KindEnum.PRIVATE_DIRECT_MESSAGE = type("KindEnum.PRIVATE_DIRECT_MESSAGE", (KindEnum.PRIVATE_DIRECT_MESSAGE, KindEnum,), {})  # type: ignore
...
class _UniffiConverterTypeKindEnum(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        ...
        if variant == 57:
            return KindEnum.PRIVATE_DIRECT_MESSAGE(
            )
        if variant == 58:
    ...
    def check_lower(value):
        ...
        if value.is_gift_wrap():
            return
        if value.is_private_direct_message():
            return
...
class TagStandard:
    ...
    class EVENT_TAG:
        ...
        def __str__(self):
            return "TagStandard.EVENT_TAG(event_id={}, relay_url={}, marker={})".format(self.event_id, self.relay_url, self.marker)
    ...
    class PUB_KEY_LIVE_EVENT:
        ...
        def __str__(self):
            return "TagStandard.PUB_KEY_LIVE_EVENT(public_key={}, relay_url={}, marker={}, proof={})".format(self.public_key, self.relay_url, self.marker, self.proof)
    ...
    class COORDINATE_TAG:
        ...
        def __str__(self):
            return "TagStandard.COORDINATE_TAG(coordinate={}, relay_url={})".format(self.coordinate, self.relay_url)
    ...
    class KIND:
        ...
        def __str__(self):
            return "TagStandard.KIND(kind={})".format(self.kind)
    ...
    class RELAY_URL:
        ...
        def __str__(self):
            return "TagStandard.RELAY_URL(relay_url={})".format(self.relay_url)
    ...
    class DELEGATION:
        ...
        def __str__(self):
            return "TagStandard.DELEGATION(delegator={}, conditions={}, sig={})".format(self.delegator, self.conditions, self.sig)
    ...
    class LABEL:
        ...
        def __str__(self):
            return "TagStandard.LABEL(label={})".format(self.label)
    ...
    def is_pub_key_live_event(self) -> bool:
        return isinstance(self, TagStandard.PUB_KEY_LIVE_EVENT)
    ...
    def is_kind(self) -> bool:
        return isinstance(self, TagStandard.KIND)
    def is_relay_url(self) -> bool:
        return isinstance(self, TagStandard.RELAY_URL)
    def is_pow(self) -> bool:
        return isinstance(self, TagStandard.POW)
    def is_delegation(self) -> bool:
        return isinstance(self, TagStandard.DELEGATION)
    def is_content_warning(self) -> bool:
...
TagStandard.PUB_KEY_LIVE_EVENT = type("TagStandard.PUB_KEY_LIVE_EVENT", (TagStandard.PUB_KEY_LIVE_EVENT, TagStandard,), {})  # type: ignore
...
TagStandard.KIND = type("TagStandard.KIND", (TagStandard.KIND, TagStandard,), {})  # type: ignore
TagStandard.RELAY_URL = type("TagStandard.RELAY_URL", (TagStandard.RELAY_URL, TagStandard,), {})  # type: ignore
TagStandard.POW = type("TagStandard.POW", (TagStandard.POW, TagStandard,), {})  # type: ignore
TagStandard.DELEGATION = type("TagStandard.DELEGATION", (TagStandard.DELEGATION, TagStandard,), {})  # type: ignore
...
class _UniffiConverterTypeTagStandard(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        ...
        if variant == 5:
            return TagStandard.PUB_KEY_LIVE_EVENT(
                _UniffiConverterTypePublicKey.read(buf),
                _UniffiConverterOptionalString.read(buf),
        ...
        if variant == 13:
            return TagStandard.KIND(
                _UniffiConverterTypeKindEnum.read(buf),
            )
        if variant == 14:
            return TagStandard.RELAY_URL(
                _UniffiConverterString.read(buf),
            )
        if variant == 15:
...
def get_nip05_profile(nip05: "str",proxy: "typing.Union[object, typing.Optional[str]]" = _DEFAULT) -> "Nip19Profile":
    _UniffiConverterString.check_lower(nip05)
...
def gift_wrap_from_seal(receiver: "PublicKey",seal: "Event",expiration: "typing.Optional[Timestamp]") -> "Event":
    """
    ...
    return _UniffiConverterTypeEvent.lift(_rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_func_gift_wrap_from_seal,
        _UniffiConverterTypePublicKey.lower(receiver),
...
def verify_nip05(public_key: "PublicKey",nip05: "str",proxy: "typing.Union[object, typing.Optional[str]]" = _DEFAULT) -> None:
    _UniffiConverterTypePublicKey.check_lower(public_key)
