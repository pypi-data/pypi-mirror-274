...
class ColumnRuleFormulaCreatorInputV1(object):
    ...
    def __init__(self, column_indexes=None, description=None, formula=None, identity_id=None, name=None, parameters=None, permission_string=None, scoped_to=None, security_string=None):
        """
    ...
    def security_string(self):
        """
        Gets the security_string of this ColumnRuleFormulaCreatorInputV1.
        Security string containing all identities and their permissions for the item. Cannot be used if permissionString is used.

        :return: The security_string of this ColumnRuleFormulaCreatorInputV1.
        :rtype: str
        """
    ...
    def security_string(self, security_string):
        """
        Sets the security_string of this ColumnRuleFormulaCreatorInputV1.
        Security string containing all identities and their permissions for the item. Cannot be used if permissionString is used.

        :param security_string: The security_string of this ColumnRuleFormulaCreatorInputV1.
        :type: str
        """
