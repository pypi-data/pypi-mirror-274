...
class _TensorPreprocessor(_CommonPreprocessor):
    ...
    def forward(self, data):
        ...
        """
        shape_list = []
        if self._model_params.InputShape_defined(self._model_input):
            shape_list = self._model_params.InputShape[self._model_input]
        else:
            if self._model_params.InputN_defined(self._model_input):
                shape_list.append(self._model_params.InputN[self._model_input])
            if self._model_params.InputH_defined(self._model_input):
                shape_list.append(self._model_params.InputH[self._model_input])
            if self._model_params.InputW_defined(self._model_input):
                shape_list.append(self._model_params.InputW[self._model_input])
            if self._model_params.InputC_defined(self._model_input):
