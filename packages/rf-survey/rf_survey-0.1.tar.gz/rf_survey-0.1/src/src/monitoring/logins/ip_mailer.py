#:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# Emails the IP on boot
# Improves remote management
#:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
# Account Information
to = 'raspberrypisurveyalert@gmail.com' # Email to send TO.
gmail_user = 'cuprfns@gmail.com' # Gmail to send FROM. (MUST BE GMAIL)
gmail_password = 'fjvjozeycvgbkwtu' # Password of gmail to send FROM.
...
msg['Subject'] = 'IP for %s on %s' % (hostID, today.strftime('%b %d %Y'))
msg['From'] = gmail_user
msg['To'] = to
