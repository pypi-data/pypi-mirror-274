...
class GalileoObserve:
    ...
    def log_node_start(
        ...
        constructor : Optional[str], optional
            A class constructor name for the node (e.g. OpenAIChat), by default None
    ...
    def log_node_error(
        self, node_id: str, error_message: str, status_code: Optional[int] = 500
    ) -> None:
