...
setup(
    ...
    description="A quantum programming integrated platform for fast learning of quantum computing concepts and development of quantum programs",
    long_description=long_description,
    long_description_content_type='text/markdown',
    url="https://github.com/voya-voja/dann5.3",
    license='GPLv3',
    classifiers=[
    ...
    project_urls={
        "Bug Tracker": "https://github.com/voya-voja/dann5.3/issues",
    },
    packages=['dann5'],
