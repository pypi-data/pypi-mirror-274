...
def pca(X: typing.Union[pandas.DataFrame, numpy.typing.NDArray],
    ...
    class PCAResults:
        ...
        def __str__(self) -> str:
            content = {'Eigenvalues': list(numpy.diag(self.eigenvalues)), 
    ...
    numpy.set_printoptions(suppress = True, precision = 2, threshold = numpy.inf)
    ...
    return(PCAResults(L, Q, PC, variance_explained))
