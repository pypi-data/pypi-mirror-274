from cyberonix.main.tools import banner, colors, template,information_gathering,WEB_Application_Analysis,Vulnerability_Analysis,Exploitation_Tools,Session_Management
import os
import requests
