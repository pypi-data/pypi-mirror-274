...
def hf_ds_to_disk(name="ag_news", subset=None, dirout="./ztmp/hf_online/", splits=None, 
    ...
    Args:
        ...
        subset (str): Subset of the dataset to load. Defaults to None.
        ...
        fmt (str): Format to save the dataset ('parquet' or 'csv'). Defaults to 'parquet'.
        ds_type (str): Dataset type for the directory structure. Defaults to 'raw'.
        show (int): If set to 1, print the path of the saved files. Defaults to 1.
