...
class Optimizer(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if kwargs:
            LOGGER.warning(logging_messages.OPTIMIZER_KWARGS_CONSTRUCTOR_DEPRECATED)
    ...
    def get_experiments(self, **kwargs):
        ...
        while True:
            ...
            try:
                ...
                LOGGER.error(
                    logging_messages.OPTIMIZER_FAILED_TO_RETRIVE_DATA, exc_info=True
                )
    ...
    def end(self, experiment):
        ...
        experiment._log_other("optimizer_version", version, include_context=False)
        experiment._log_other("optimizer_process", os.getpid(), include_context=False)
        experiment._log_other("optimizer_count", count, include_context=False)
        experiment._log_other("optimizer_objective", objective, include_context=False)
        experiment._log_other("optimizer_name", name, include_context=False)
    ...
    def _create_experiment(self, parameters, pid, trial, count, experiment_kwargs):
        ...
        exp._log_parameters(
            parameters, source=ParameterMessage.source_autologger, flatten_nested=False
        )
        # Log optimizer static information:
        exp._log_other("optimizer_id", self.id, include_context=False)
        exp._log_other("optimizer_pid", pid, include_context=False)
        exp._log_other("optimizer_trial", trial, include_context=False)
        return exp
