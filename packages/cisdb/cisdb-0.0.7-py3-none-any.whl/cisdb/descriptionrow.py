...
"""Class representing a row in the Descriptions table"""

from basedb.row import Row

__author__ = 'joseph areeda'
__email__ = 'joseph.areeda@ligo.org'
__myname__ = 'descriptionrow'
try:
...
class Description(Row):
    ...
    def get_col_def(self):
        ...
        desc_def = {'name': 'descriptions', 'type': list, 'length': 1024, 'indexKey': False, 'unique': False,
                    'comment': 'List of human entered explanation'}

        column_definitions = [id_def, name_def, desc_def]
        self.define_cols(column_definitions)
        self.set_eq_cols(['name', 'descriptions'])
        return self.cols
