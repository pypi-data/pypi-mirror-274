...
function addCellListeners(notebook: Notebook): void {
  notebook.widgets.forEach(cell => {
    ...
    // Add drop target for each cell
    // dropTargetForElements({
    //   element: cell.node,
    //   onDrop: (event) => {
    //     console.log('event', event)
    //     console.log('Element dropped on cell:', cell.model.toJSON());
    //     const { source } = event;
    //     const docId = source?.data.docId as string;
    //     console.log('docId', docId);

    //     // add code to this cell
    //     // TODO
    //     if (docId) {
    //       const codeToAdd = `# Code added from drop event\n# Document ID: ${docId}`;
    //       cell.model.sharedModel.setSource(cell.model.sharedModel.getSource() + '\n' + codeToAdd);
    //     } else {
    //       cell.model.sharedModel.setSource(cell.model.sharedModel.getSource() + '\n' + 'codeToAdd');
    //     }
    //   }
