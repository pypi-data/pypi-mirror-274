...
class Security(BaseModel):
    ...
    """ # noqa: E501
    authentication_required: Optional[StrictBool] = Field(default=None, description="When true, all interactions with the deployed serivce are required to be authenticated. The nececessary token can be obtained using the service REST interface. The default is false.", alias="authenticationRequired")
