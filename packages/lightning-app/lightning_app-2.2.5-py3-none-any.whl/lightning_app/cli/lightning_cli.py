...
from lightning_app.cli.lightning_cli_launch import launch
from lightning_app.cli.lightning_cli_list import get_list
from lightning_app.core.constants import ENABLE_APP_COMMENT_COMMAND_EXECUTION, get_lightning_cloud_url
...
if RequirementCache("lightning_fabric>=1.9.0") or RequirementCache("lightning>=1.9.0"):
    # note it is automatically replaced to `from lightning_fabric.cli` when building monolithic/mirror package
