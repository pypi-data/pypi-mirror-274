...
def usage():
    ...
    Run Command:
        python qualystbx_main.py --execute policy_merge --new_policy_id=[new_policy_id] --old_policy_id=[old_policy_id] --cid_list=[optional, comma-separated list of cids to move from old policy to new policy, all if excluded] [optional --log_to_console will log to console instead of file]
